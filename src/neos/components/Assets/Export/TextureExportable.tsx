...
Texture?: member<any>;
    ...
    export function TextureExportable(props: TextureExportableInput){
      const { id, persistentId, updateOrder, Enabled,
Texture, } = props;
    
      return (
        <Component type="FrooxEngine.TextureExportable" id={id} persistentId={persistentId} updateOrder={updateOrder}>
