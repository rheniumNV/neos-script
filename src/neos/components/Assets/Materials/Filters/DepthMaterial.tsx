...
<Member type={`FrooxEngine.Sync\`1[System.Single]`} name="Multiply" id={typeof Multiply === "object" && "id" in Multiply ? Multiply?.id : undefined} value={typeof Multiply === "object" && "value" in Multiply ? Multiply?.value : Multiply} /* default: 0 */  />
...
<Member type={`FrooxEngine.Sync\`1[System.Boolean]`} name="Clip" id={typeof Clip === "object" && "id" in Clip ? Clip?.id : undefined} value={typeof Clip === "object" && "value" in Clip ? Clip?.value : Clip} /* default: false */  />
<Member type={`FrooxEngine.Sync\`1[System.Single]`} name="ClipStart" id={typeof ClipStart === "object" && "id" in ClipStart ? ClipStart?.id : undefined} value={typeof ClipStart === "object" && "value" in ClipStart ? ClipStart?.value : ClipStart} /* default: 0 */  />
<Member type={`FrooxEngine.Sync\`1[System.Single]`} name="ClipEnd" id={typeof ClipEnd === "object" && "id" in ClipEnd ? ClipEnd?.id : undefined} value={typeof ClipEnd === "object" && "value" in ClipEnd ? ClipEnd?.value : ClipEnd} /* default: 0 */  />
