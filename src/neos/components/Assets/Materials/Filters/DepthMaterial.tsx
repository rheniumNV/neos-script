...
ZTest?: member<any>;
    ...
    export function DepthMaterial(props: DepthMaterialInput){
...
ZTest, } = props;
      ...
      return (
        <Component type="FrooxEngine.DepthMaterial" id={id} persistentId={persistentId} updateOrder={updateOrder}>
...
<Member type={`FrooxEngine.Sync\`1[System.Single]`} name="Multiply" id={typeof Multiply === "object" && "id" in Multiply ? Multiply?.id : undefined} value={typeof Multiply === "object" && "value" in Multiply ? Multiply?.value : Multiply} /* default: 0 */  isRaw={typeof Multiply === "object" && "isRaw" in Multiply && Multiply.isRaw ? true : undefined} />
...
<Member type={`FrooxEngine.Sync\`1[System.Boolean]`} name="Clip" id={typeof Clip === "object" && "id" in Clip ? Clip?.id : undefined} value={typeof Clip === "object" && "value" in Clip ? Clip?.value : Clip} /* default: false */  isRaw={typeof Clip === "object" && "isRaw" in Clip && Clip.isRaw ? true : undefined} />
<Member type={`FrooxEngine.Sync\`1[System.Single]`} name="ClipStart" id={typeof ClipStart === "object" && "id" in ClipStart ? ClipStart?.id : undefined} value={typeof ClipStart === "object" && "value" in ClipStart ? ClipStart?.value : ClipStart} /* default: 0 */  isRaw={typeof ClipStart === "object" && "isRaw" in ClipStart && ClipStart.isRaw ? true : undefined} />
<Member type={`FrooxEngine.Sync\`1[System.Single]`} name="ClipEnd" id={typeof ClipEnd === "object" && "id" in ClipEnd ? ClipEnd?.id : undefined} value={typeof ClipEnd === "object" && "value" in ClipEnd ? ClipEnd?.value : ClipEnd} /* default: 0 */  isRaw={typeof ClipEnd === "object" && "isRaw" in ClipEnd && ClipEnd.isRaw ? true : undefined} />
