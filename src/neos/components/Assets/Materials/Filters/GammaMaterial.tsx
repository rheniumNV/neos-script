...
ZTest?: member<any>;
    ...
    export function GammaMaterial(props: GammaMaterialInput){
...
ZTest, } = props;
      ...
      return (
        <Component type="FrooxEngine.GammaMaterial" id={id} persistentId={persistentId} updateOrder={updateOrder}>
