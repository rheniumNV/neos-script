...
ZTest?: member<any>;
    ...
    export function GrayscaleMaterial(props: GrayscaleMaterialInput){
...
ZTest, } = props;
      ...
      return (
        <Component type="FrooxEngine.GrayscaleMaterial" id={id} persistentId={persistentId} updateOrder={updateOrder}>
...
<Member type={`FrooxEngine.Sync\`1[System.Single]`} name="RatioRed" id={typeof RatioRed === "object" && "id" in RatioRed ? RatioRed?.id : undefined} value={typeof RatioRed === "object" && "value" in RatioRed ? RatioRed?.value : RatioRed} /* default: 0 */  isRaw={typeof RatioRed === "object" && "isRaw" in RatioRed && RatioRed.isRaw ? true : undefined} />
<Member type={`FrooxEngine.Sync\`1[System.Single]`} name="RatioGreen" id={typeof RatioGreen === "object" && "id" in RatioGreen ? RatioGreen?.id : undefined} value={typeof RatioGreen === "object" && "value" in RatioGreen ? RatioGreen?.value : RatioGreen} /* default: 0 */  isRaw={typeof RatioGreen === "object" && "isRaw" in RatioGreen && RatioGreen.isRaw ? true : undefined} />
<Member type={`FrooxEngine.Sync\`1[System.Single]`} name="RatioBlue" id={typeof RatioBlue === "object" && "id" in RatioBlue ? RatioBlue?.id : undefined} value={typeof RatioBlue === "object" && "value" in RatioBlue ? RatioBlue?.value : RatioBlue} /* default: 0 */  isRaw={typeof RatioBlue === "object" && "isRaw" in RatioBlue && RatioBlue.isRaw ? true : undefined} />
...
<Member type={`FrooxEngine.AssetRef\`1[FrooxEngine.ITexture2D]`} name="Gradient" id={typeof Gradient === "object" && "id" in Gradient ? Gradient?.id : undefined} value={typeof Gradient === "object" && "value" in Gradient ? Gradient?.value : Gradient} /* default: ID0 */  isRaw={typeof Gradient === "object" && "isRaw" in Gradient && Gradient.isRaw ? true : undefined} />
