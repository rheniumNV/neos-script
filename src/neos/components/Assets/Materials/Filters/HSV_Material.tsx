...
<Member type={`FrooxEngine.Sync\`1[BaseX.float3]`} name="HSV_Offset" id={typeof HSV_Offset === "object" && "id" in HSV_Offset ? HSV_Offset?.id : undefined} value={typeof HSV_Offset === "object" && "value" in HSV_Offset ? HSV_Offset?.value : HSV_Offset} /* default: [0; 0; 0] */  />
<Member type={`FrooxEngine.Sync\`1[BaseX.float3]`} name="HSV_Multiply" id={typeof HSV_Multiply === "object" && "id" in HSV_Multiply ? HSV_Multiply?.id : undefined} value={typeof HSV_Multiply === "object" && "value" in HSV_Multiply ? HSV_Multiply?.value : HSV_Multiply} /* default: [0; 0; 0] */  />
