...
ZTest?: member<any>;
    ...
    export function HSV_Material(props: HSV_MaterialInput){
...
ZTest, } = props;
      ...
      return (
        <Component type="FrooxEngine.HSV_Material" id={id} persistentId={persistentId} updateOrder={updateOrder}>
...
<Member type={`FrooxEngine.Sync\`1[BaseX.float3]`} name="HSV_Offset" id={typeof HSV_Offset === "object" && "id" in HSV_Offset ? HSV_Offset?.id : undefined} value={typeof HSV_Offset === "object" && "value" in HSV_Offset ? HSV_Offset?.value : HSV_Offset} /* default: [0; 0; 0] */  isRaw={typeof HSV_Offset === "object" && "isRaw" in HSV_Offset && HSV_Offset.isRaw ? true : undefined} />
<Member type={`FrooxEngine.Sync\`1[BaseX.float3]`} name="HSV_Multiply" id={typeof HSV_Multiply === "object" && "id" in HSV_Multiply ? HSV_Multiply?.id : undefined} value={typeof HSV_Multiply === "object" && "value" in HSV_Multiply ? HSV_Multiply?.value : HSV_Multiply} /* default: [0; 0; 0] */  isRaw={typeof HSV_Multiply === "object" && "isRaw" in HSV_Multiply && HSV_Multiply.isRaw ? true : undefined} />
