...
ZTest?: member<any>;
    ...
    export function InvertMaterial(props: InvertMaterialInput){
...
ZTest, } = props;
      ...
      return (
        <Component type="FrooxEngine.InvertMaterial" id={id} persistentId={persistentId} updateOrder={updateOrder}>
