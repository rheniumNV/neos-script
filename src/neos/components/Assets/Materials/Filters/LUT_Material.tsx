...
ZTest?: member<any>;
    ...
    export function LUT_Material(props: LUT_MaterialInput){
...
ZTest, } = props;
      ...
      return (
        <Component type="FrooxEngine.LUT_Material" id={id} persistentId={persistentId} updateOrder={updateOrder}>
...
<Member type={`FrooxEngine.AssetRef\`1[FrooxEngine.Texture3D]`} name="LUT" id={typeof LUT === "object" && "id" in LUT ? LUT?.id : undefined} value={typeof LUT === "object" && "value" in LUT ? LUT?.value : LUT} /* default: ID0 */  isRaw={typeof LUT === "object" && "isRaw" in LUT && LUT.isRaw ? true : undefined} />
<Member type={`FrooxEngine.AssetRef\`1[FrooxEngine.Texture3D]`} name="SecondaryLUT" id={typeof SecondaryLUT === "object" && "id" in SecondaryLUT ? SecondaryLUT?.id : undefined} value={typeof SecondaryLUT === "object" && "value" in SecondaryLUT ? SecondaryLUT?.value : SecondaryLUT} /* default: ID0 */  isRaw={typeof SecondaryLUT === "object" && "isRaw" in SecondaryLUT && SecondaryLUT.isRaw ? true : undefined} />
