...
ZTest?: member<any>;
    ...
    export function PosterizeMaterial(props: PosterizeMaterialInput){
...
ZTest, } = props;
      ...
      return (
        <Component type="FrooxEngine.PosterizeMaterial" id={id} persistentId={persistentId} updateOrder={updateOrder}>
...
<Member type={`FrooxEngine.Sync\`1[System.Single]`} name="Levels" id={typeof Levels === "object" && "id" in Levels ? Levels?.id : undefined} value={typeof Levels === "object" && "value" in Levels ? Levels?.value : Levels} /* default: 0 */  isRaw={typeof Levels === "object" && "isRaw" in Levels && Levels.isRaw ? true : undefined} />
