...
<Member type={`FrooxEngine.Sync\`1[System.Single]`} name="Levels" id={typeof Levels === "object" && "id" in Levels ? Levels?.id : undefined} value={typeof Levels === "object" && "value" in Levels ? Levels?.value : Levels} /* default: 0 */  />
