...
<Member type={`FrooxEngine.Sync\`1[System.Single]`} name="Threshold" id={typeof Threshold === "object" && "id" in Threshold ? Threshold?.id : undefined} value={typeof Threshold === "object" && "value" in Threshold ? Threshold?.value : Threshold} /* default: 0 */  />
<Member type={`FrooxEngine.Sync\`1[System.Single]`} name="Transition" id={typeof Transition === "object" && "id" in Transition ? Transition?.id : undefined} value={typeof Transition === "object" && "value" in Transition ? Transition?.value : Transition} /* default: 0 */  />
