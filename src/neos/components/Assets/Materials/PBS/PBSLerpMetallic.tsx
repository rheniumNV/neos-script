...
<Member type={`FrooxEngine.AssetRef\`1[FrooxEngine.ITexture2D]`} name="MetallicMap0" id={typeof MetallicMap0 === "object" && "id" in MetallicMap0 ? MetallicMap0?.id : undefined} value={typeof MetallicMap0 === "object" && "value" in MetallicMap0 ? MetallicMap0?.value : MetallicMap0} /* default: ID0 */  />
<Member type={`FrooxEngine.AssetRef\`1[FrooxEngine.ITexture2D]`} name="MetallicMap1" id={typeof MetallicMap1 === "object" && "id" in MetallicMap1 ? MetallicMap1?.id : undefined} value={typeof MetallicMap1 === "object" && "value" in MetallicMap1 ? MetallicMap1?.value : MetallicMap1} /* default: ID0 */  />
        </Component>
      );
    };
