...
_zwrite?: member<any>;
    ...
    export function PBS_ColorMaskSpecular(props: PBS_ColorMaskSpecularInput){
...
_zwrite, } = props;
      ...
      return (
        <Component type="FrooxEngine.PBS_ColorMaskSpecular" id={id} persistentId={persistentId} updateOrder={updateOrder}>
...
<Member type={`FrooxEngine.Sync\`1[System.Boolean]`} name="ForceZWrite" id={typeof ForceZWrite === "object" && "id" in ForceZWrite ? ForceZWrite?.id : undefined} value={typeof ForceZWrite === "object" && "value" in ForceZWrite ? ForceZWrite?.value : ForceZWrite} /* default: false */  />
...
<Member type={`FrooxEngine.AssetRef\`1[FrooxEngine.Shader]`} name="_zwrite-ID" id={typeof _zwrite === "object" && "id" in _zwrite ? _zwrite?.id : undefined} value={typeof _zwrite === "object" && "value" in _zwrite ? _zwrite?.value : _zwrite} /* default: ID0 */ idOnly />
        </Component>
      );
    };
