...
<Member type={`FrooxEngine.Sync\`1[System.Single]`} name="Metallic2" id={typeof Metallic2 === "object" && "id" in Metallic2 ? Metallic2?.id : undefined} value={typeof Metallic2 === "object" && "value" in Metallic2 ? Metallic2?.value : Metallic2} /* default: 0 */  isRaw={typeof Metallic2 === "object" && "isRaw" in Metallic2 && Metallic2.isRaw ? true : undefined} />
<Member type={`FrooxEngine.Sync\`1[System.Single]`} name="Metallic3" id={typeof Metallic3 === "object" && "id" in Metallic3 ? Metallic3?.id : undefined} value={typeof Metallic3 === "object" && "value" in Metallic3 ? Metallic3?.value : Metallic3} /* default: 0 */  isRaw={typeof Metallic3 === "object" && "isRaw" in Metallic3 && Metallic3.isRaw ? true : undefined} />
...
<Member type={`FrooxEngine.Sync\`1[System.Single]`} name="Smoothness2" id={typeof Smoothness2 === "object" && "id" in Smoothness2 ? Smoothness2?.id : undefined} value={typeof Smoothness2 === "object" && "value" in Smoothness2 ? Smoothness2?.value : Smoothness2} /* default: 0 */  isRaw={typeof Smoothness2 === "object" && "isRaw" in Smoothness2 && Smoothness2.isRaw ? true : undefined} />
<Member type={`FrooxEngine.Sync\`1[System.Single]`} name="Smoothness3" id={typeof Smoothness3 === "object" && "id" in Smoothness3 ? Smoothness3?.id : undefined} value={typeof Smoothness3 === "object" && "value" in Smoothness3 ? Smoothness3?.value : Smoothness3} /* default: 0 */  isRaw={typeof Smoothness3 === "object" && "isRaw" in Smoothness3 && Smoothness3.isRaw ? true : undefined} />
<Member type={`FrooxEngine.AssetRef\`1[FrooxEngine.ITexture2D]`} name="MetallicMap01" id={typeof MetallicMap01 === "object" && "id" in MetallicMap01 ? MetallicMap01?.id : undefined} value={typeof MetallicMap01 === "object" && "value" in MetallicMap01 ? MetallicMap01?.value : MetallicMap01} /* default: ID0 */  isRaw={typeof MetallicMap01 === "object" && "isRaw" in MetallicMap01 && MetallicMap01.isRaw ? true : undefined} />
<Member type={`FrooxEngine.AssetRef\`1[FrooxEngine.ITexture2D]`} name="MetallicMap23" id={typeof MetallicMap23 === "object" && "id" in MetallicMap23 ? MetallicMap23?.id : undefined} value={typeof MetallicMap23 === "object" && "value" in MetallicMap23 ? MetallicMap23?.value : MetallicMap23} /* default: ID0 */  isRaw={typeof MetallicMap23 === "object" && "isRaw" in MetallicMap23 && MetallicMap23.isRaw ? true : undefined} />
        </Component>
      );
    };
