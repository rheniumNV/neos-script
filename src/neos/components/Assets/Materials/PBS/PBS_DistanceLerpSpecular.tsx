...
_transparent?: member<any>;
    ...
    export function PBS_DistanceLerpSpecular(props: PBS_DistanceLerpSpecularInput){
...
_transparent, } = props;
      ...
      return (
        <Component type="FrooxEngine.PBS_DistanceLerpSpecular" id={id} persistentId={persistentId} updateOrder={updateOrder}>
...
<Member type={`FrooxEngine.Sync\`1[BaseX.float3]`} name="GridOffset" id={typeof GridOffset === "object" && "id" in GridOffset ? GridOffset?.id : undefined} value={typeof GridOffset === "object" && "value" in GridOffset ? GridOffset?.value : GridOffset} /* default: [0; 0; 0] */  isRaw={typeof GridOffset === "object" && "isRaw" in GridOffset && GridOffset.isRaw ? true : undefined} />
<Member type={`FrooxEngine.Sync\`1[System.Single]`} name="DisplaceFrom" id={typeof DisplaceFrom === "object" && "id" in DisplaceFrom ? DisplaceFrom?.id : undefined} value={typeof DisplaceFrom === "object" && "value" in DisplaceFrom ? DisplaceFrom?.value : DisplaceFrom} /* default: 0 */  isRaw={typeof DisplaceFrom === "object" && "isRaw" in DisplaceFrom && DisplaceFrom.isRaw ? true : undefined} />
<Member type={`FrooxEngine.Sync\`1[System.Single]`} name="DisplaceTo" id={typeof DisplaceTo === "object" && "id" in DisplaceTo ? DisplaceTo?.id : undefined} value={typeof DisplaceTo === "object" && "value" in DisplaceTo ? DisplaceTo?.value : DisplaceTo} /* default: 0 */  isRaw={typeof DisplaceTo === "object" && "isRaw" in DisplaceTo && DisplaceTo.isRaw ? true : undefined} />
<Member type={`FrooxEngine.Sync\`1[System.Single]`} name="DisplaceMagnitudeFrom" id={typeof DisplaceMagnitudeFrom === "object" && "id" in DisplaceMagnitudeFrom ? DisplaceMagnitudeFrom?.id : undefined} value={typeof DisplaceMagnitudeFrom === "object" && "value" in DisplaceMagnitudeFrom ? DisplaceMagnitudeFrom?.value : DisplaceMagnitudeFrom} /* default: 0 */  isRaw={typeof DisplaceMagnitudeFrom === "object" && "isRaw" in DisplaceMagnitudeFrom && DisplaceMagnitudeFrom.isRaw ? true : undefined} />
<Member type={`FrooxEngine.Sync\`1[System.Single]`} name="DisplaceMagnitudeTo" id={typeof DisplaceMagnitudeTo === "object" && "id" in DisplaceMagnitudeTo ? DisplaceMagnitudeTo?.id : undefined} value={typeof DisplaceMagnitudeTo === "object" && "value" in DisplaceMagnitudeTo ? DisplaceMagnitudeTo?.value : DisplaceMagnitudeTo} /* default: 0 */  isRaw={typeof DisplaceMagnitudeTo === "object" && "isRaw" in DisplaceMagnitudeTo && DisplaceMagnitudeTo.isRaw ? true : undefined} />
<Member type={`FrooxEngine.Sync\`1[System.Single]`} name="EmissionFrom" id={typeof EmissionFrom === "object" && "id" in EmissionFrom ? EmissionFrom?.id : undefined} value={typeof EmissionFrom === "object" && "value" in EmissionFrom ? EmissionFrom?.value : EmissionFrom} /* default: 0 */  isRaw={typeof EmissionFrom === "object" && "isRaw" in EmissionFrom && EmissionFrom.isRaw ? true : undefined} />
<Member type={`FrooxEngine.Sync\`1[System.Single]`} name="EmissionTo" id={typeof EmissionTo === "object" && "id" in EmissionTo ? EmissionTo?.id : undefined} value={typeof EmissionTo === "object" && "value" in EmissionTo ? EmissionTo?.value : EmissionTo} /* default: 0 */  isRaw={typeof EmissionTo === "object" && "isRaw" in EmissionTo && EmissionTo.isRaw ? true : undefined} />
<Member type={`FrooxEngine.Sync\`1[BaseX.color]`} name="EmissionColorFrom" id={typeof EmissionColorFrom === "object" && "id" in EmissionColorFrom ? EmissionColorFrom?.id : undefined} value={typeof EmissionColorFrom === "object" && "value" in EmissionColorFrom ? EmissionColorFrom?.value : EmissionColorFrom} /* default: [0; 0; 0; 0] */  isRaw={typeof EmissionColorFrom === "object" && "isRaw" in EmissionColorFrom && EmissionColorFrom.isRaw ? true : undefined} />
<Member type={`FrooxEngine.Sync\`1[BaseX.color]`} name="EmissionColorTo" id={typeof EmissionColorTo === "object" && "id" in EmissionColorTo ? EmissionColorTo?.id : undefined} value={typeof EmissionColorTo === "object" && "value" in EmissionColorTo ? EmissionColorTo?.value : EmissionColorTo} /* default: [0; 0; 0; 0] */  isRaw={typeof EmissionColorTo === "object" && "isRaw" in EmissionColorTo && EmissionColorTo.isRaw ? true : undefined} />
<Member type={`FrooxEngine.Sync\`1[System.Nullable\`1[BaseX.float3]]`} name="OverrideDisplacementDirection" id={typeof OverrideDisplacementDirection === "object" && "id" in OverrideDisplacementDirection ? OverrideDisplacementDirection?.id : undefined} value={typeof OverrideDisplacementDirection === "object" && "value" in OverrideDisplacementDirection ? OverrideDisplacementDirection?.value : OverrideDisplacementDirection} /* default: <i>null</i> */  isRaw={typeof OverrideDisplacementDirection === "object" && "isRaw" in OverrideDisplacementDirection && OverrideDisplacementDirection.isRaw ? true : undefined} />
...
<Member type={`FrooxEngine.SyncList\`1[FrooxEngine.PBS_DistanceLerpMaterial+Point]`} name="Points" id={typeof Points === "object" && "id" in Points ? Points?.id : undefined} value={typeof Points === "object" && "value" in Points ? Points?.value : Points} /* default: FrooxEngine.SyncList`1[FrooxEngine.PBS_DistanceLerpMaterial+Point] */  isRaw={typeof Points === "object" && "isRaw" in Points && Points.isRaw ? true : undefined} />
