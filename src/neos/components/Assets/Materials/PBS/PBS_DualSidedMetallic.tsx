...
_transparent?: member<any>;
    ...
    export function PBS_DualSidedMetallic(props: PBS_DualSidedMetallicInput){
...
_transparent, } = props;
      ...
      return (
        <Component type="FrooxEngine.PBS_DualSidedMetallic" id={id} persistentId={persistentId} updateOrder={updateOrder}>
