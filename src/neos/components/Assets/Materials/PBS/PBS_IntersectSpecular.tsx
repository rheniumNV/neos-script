...
SpecularMap?: member<any>;
    ...
    export function PBS_IntersectSpecular(props: PBS_IntersectSpecularInput){
...
SpecularMap, } = props;
      ...
      return (
        <Component type="FrooxEngine.PBS_IntersectSpecular" id={id} persistentId={persistentId} updateOrder={updateOrder}>
...
<Member type={`FrooxEngine.Sync\`1[System.Single]`} name="BeginTransitionStart" id={typeof BeginTransitionStart === "object" && "id" in BeginTransitionStart ? BeginTransitionStart?.id : undefined} value={typeof BeginTransitionStart === "object" && "value" in BeginTransitionStart ? BeginTransitionStart?.value : BeginTransitionStart} /* default: 0 */  />
<Member type={`FrooxEngine.Sync\`1[System.Single]`} name="BeginTransitionEnd" id={typeof BeginTransitionEnd === "object" && "id" in BeginTransitionEnd ? BeginTransitionEnd?.id : undefined} value={typeof BeginTransitionEnd === "object" && "value" in BeginTransitionEnd ? BeginTransitionEnd?.value : BeginTransitionEnd} /* default: 0 */  />
<Member type={`FrooxEngine.Sync\`1[System.Single]`} name="EndTransitionStart" id={typeof EndTransitionStart === "object" && "id" in EndTransitionStart ? EndTransitionStart?.id : undefined} value={typeof EndTransitionStart === "object" && "value" in EndTransitionStart ? EndTransitionStart?.value : EndTransitionStart} /* default: 0 */  />
<Member type={`FrooxEngine.Sync\`1[System.Single]`} name="EndTransitionEnd" id={typeof EndTransitionEnd === "object" && "id" in EndTransitionEnd ? EndTransitionEnd?.id : undefined} value={typeof EndTransitionEnd === "object" && "value" in EndTransitionEnd ? EndTransitionEnd?.value : EndTransitionEnd} /* default: 0 */  />
...
<Member type={`FrooxEngine.Sync\`1[BaseX.color]`} name="IntersectEmissiveColor" id={typeof IntersectEmissiveColor === "object" && "id" in IntersectEmissiveColor ? IntersectEmissiveColor?.id : undefined} value={typeof IntersectEmissiveColor === "object" && "value" in IntersectEmissiveColor ? IntersectEmissiveColor?.value : IntersectEmissiveColor} /* default: [0; 0; 0; 0] */  />
