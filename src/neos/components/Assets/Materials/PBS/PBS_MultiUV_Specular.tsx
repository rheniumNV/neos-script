...
<Member type={`FrooxEngine.Sync\`1[BaseX.float2]`} name="SpecularMapScale" id={typeof SpecularMapScale === "object" && "id" in SpecularMapScale ? SpecularMapScale?.id : undefined} value={typeof SpecularMapScale === "object" && "value" in SpecularMapScale ? SpecularMapScale?.value : SpecularMapScale} /* default: [0; 0] */  isRaw={typeof SpecularMapScale === "object" && "isRaw" in SpecularMapScale && SpecularMapScale.isRaw ? true : undefined} />
<Member type={`FrooxEngine.Sync\`1[BaseX.float2]`} name="SpecularMapOffset" id={typeof SpecularMapOffset === "object" && "id" in SpecularMapOffset ? SpecularMapOffset?.id : undefined} value={typeof SpecularMapOffset === "object" && "value" in SpecularMapOffset ? SpecularMapOffset?.value : SpecularMapOffset} /* default: [0; 0] */  isRaw={typeof SpecularMapOffset === "object" && "isRaw" in SpecularMapOffset && SpecularMapOffset.isRaw ? true : undefined} />
<Member type={`FrooxEngine.Sync\`1[System.Int32]`} name="SpecularMapUV" id={typeof SpecularMapUV === "object" && "id" in SpecularMapUV ? SpecularMapUV?.id : undefined} value={typeof SpecularMapUV === "object" && "value" in SpecularMapUV ? SpecularMapUV?.value : SpecularMapUV} /* default: 0 */  isRaw={typeof SpecularMapUV === "object" && "isRaw" in SpecularMapUV && SpecularMapUV.isRaw ? true : undefined} />
        </Component>
      );
    };
