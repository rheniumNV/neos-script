...
_zwrite?: member<any>;
    ...
    export function PBS_RimMetallic(props: PBS_RimMetallicInput){
...
_zwrite, } = props;
      ...
      return (
        <Component type="FrooxEngine.PBS_RimMetallic" id={id} persistentId={persistentId} updateOrder={updateOrder}>
