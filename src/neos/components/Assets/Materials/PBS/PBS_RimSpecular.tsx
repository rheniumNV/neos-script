...
_zwrite?: member<any>;
    ...
    export function PBS_RimSpecular(props: PBS_RimSpecularInput){
...
_zwrite, } = props;
      ...
      return (
        <Component type="FrooxEngine.PBS_RimSpecular" id={id} persistentId={persistentId} updateOrder={updateOrder}>
