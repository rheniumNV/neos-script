...
_transparent?: member<any>;
    ...
    export function PBS_SliceMetallic(props: PBS_SliceMetallicInput){
...
_transparent, } = props;
      ...
      return (
        <Component type="FrooxEngine.PBS_SliceMetallic" id={id} persistentId={persistentId} updateOrder={updateOrder} version={1}>
