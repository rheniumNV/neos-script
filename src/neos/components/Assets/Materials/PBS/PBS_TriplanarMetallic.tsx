...
_transparent?: member<any>;
    ...
    export function PBS_TriplanarMetallic(props: PBS_TriplanarMetallicInput){
...
_transparent, } = props;
      ...
      return (
        <Component type="FrooxEngine.PBS_TriplanarMetallic" id={id} persistentId={persistentId} updateOrder={updateOrder}>
...
<Member type={`FrooxEngine.Sync\`1[System.Single]`} name="TriplanarBlendPower" id={typeof TriplanarBlendPower === "object" && "id" in TriplanarBlendPower ? TriplanarBlendPower?.id : undefined} value={typeof TriplanarBlendPower === "object" && "value" in TriplanarBlendPower ? TriplanarBlendPower?.value : TriplanarBlendPower} /* default: 0 */  isRaw={typeof TriplanarBlendPower === "object" && "isRaw" in TriplanarBlendPower && TriplanarBlendPower.isRaw ? true : undefined} />
<Member type={`FrooxEngine.Sync\`1[System.Boolean]`} name="ObjectSpace" id={typeof ObjectSpace === "object" && "id" in ObjectSpace ? ObjectSpace?.id : undefined} value={typeof ObjectSpace === "object" && "value" in ObjectSpace ? ObjectSpace?.value : ObjectSpace} /* default: false */  isRaw={typeof ObjectSpace === "object" && "isRaw" in ObjectSpace && ObjectSpace.isRaw ? true : undefined} />
