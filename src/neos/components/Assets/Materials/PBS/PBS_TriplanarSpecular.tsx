...
<Member type={`FrooxEngine.Sync\`1[System.Single]`} name="TriplanarBlendPower" id={typeof TriplanarBlendPower === "object" && "id" in TriplanarBlendPower ? TriplanarBlendPower?.id : undefined} value={typeof TriplanarBlendPower === "object" && "value" in TriplanarBlendPower ? TriplanarBlendPower?.value : TriplanarBlendPower} /* default: 0 */  />
<Member type={`FrooxEngine.Sync\`1[System.Boolean]`} name="ObjectSpace" id={typeof ObjectSpace === "object" && "id" in ObjectSpace ? ObjectSpace?.id : undefined} value={typeof ObjectSpace === "object" && "value" in ObjectSpace ? ObjectSpace?.value : ObjectSpace} /* default: false */  />
