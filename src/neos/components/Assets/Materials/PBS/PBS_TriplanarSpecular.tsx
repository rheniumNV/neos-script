...
_transparent?: member<any>;
    ...
    export function PBS_TriplanarSpecular(props: PBS_TriplanarSpecularInput){
...
_transparent, } = props;
      ...
      return (
        <Component type="FrooxEngine.PBS_TriplanarSpecular" id={id} persistentId={persistentId} updateOrder={updateOrder}>
