...
_transparentFront?: member<any>;
    ...
    export function PBS_VertexColorMetallic(props: PBS_VertexColorMetallicInput){
...
_regular,
_transparent,
_transparentFront, } = props;
    
      return (
        <Component type="FrooxEngine.PBS_VertexColorMetallic" id={id} persistentId={persistentId} updateOrder={updateOrder}>
...
<Member type={`FrooxEngine.Sync\`1[FrooxEngine.PBS_VertexColorMetallic+ColorTarget]`} name="VertexColorTarget" id={typeof VertexColorTarget === "object" && "id" in VertexColorTarget ? VertexColorTarget?.id : undefined} value={typeof VertexColorTarget === "object" && "value" in VertexColorTarget ? VertexColorTarget?.value : VertexColorTarget} /* default: Albedo */  isRaw={typeof VertexColorTarget === "object" && "isRaw" in VertexColorTarget && VertexColorTarget.isRaw ? true : undefined} />
...
<Member type={`FrooxEngine.AssetRef\`1[FrooxEngine.Shader]`} name="_transparentFront-ID" id={typeof _transparentFront === "object" && "id" in _transparentFront ? _transparentFront?.id : undefined} value={typeof _transparentFront === "object" && "value" in _transparentFront ? _transparentFront?.value : _transparentFront} /* default: ID0 */ readOnly isRaw={typeof _transparentFront === "object" && "isRaw" in _transparentFront && _transparentFront.isRaw ? true : undefined} />
        </Component>
      );
    };
