...
<Member type={`FrooxEngine.Sync\`1[FrooxEngine.PBS_VertexColorSpecular+ColorTarget]`} name="VertexColorTarget" id={typeof VertexColorTarget === "object" && "id" in VertexColorTarget ? VertexColorTarget?.id : undefined} value={typeof VertexColorTarget === "object" && "value" in VertexColorTarget ? VertexColorTarget?.value : VertexColorTarget} /* default: Albedo */  />
