...
_transparentFront?: member<any>;
    ...
    export function PBS_VertexColorSpecular(props: PBS_VertexColorSpecularInput){
...
_transparentFront, } = props;
      ...
      return (
        <Component type="FrooxEngine.PBS_VertexColorSpecular" id={id} persistentId={persistentId} updateOrder={updateOrder}>
...
<Member type={`FrooxEngine.Sync\`1[FrooxEngine.PBS_VertexColorSpecular+ColorTarget]`} name="VertexColorTarget" id={typeof VertexColorTarget === "object" && "id" in VertexColorTarget ? VertexColorTarget?.id : undefined} value={typeof VertexColorTarget === "object" && "value" in VertexColorTarget ? VertexColorTarget?.value : VertexColorTarget} /* default: Albedo */  isRaw={typeof VertexColorTarget === "object" && "isRaw" in VertexColorTarget && VertexColorTarget.isRaw ? true : undefined} />
