...
SpecularMap?: member<any>;
    ...
    export function PBS_Specular(props: PBS_SpecularInput){
...
SpecularMap, } = props;
      ...
      return (
        <Component type="FrooxEngine.PBS_Specular" id={id} persistentId={persistentId} updateOrder={updateOrder}>
...
<Member type={`FrooxEngine.AssetRef\`1[FrooxEngine.ITexture2D]`} name="HeightMap" id={typeof HeightMap === "object" && "id" in HeightMap ? HeightMap?.id : undefined} value={typeof HeightMap === "object" && "value" in HeightMap ? HeightMap?.value : HeightMap} /* default: ID0 */  />
<Member type={`FrooxEngine.Sync\`1[System.Single]`} name="HeightScale" id={typeof HeightScale === "object" && "id" in HeightScale ? HeightScale?.id : undefined} value={typeof HeightScale === "object" && "value" in HeightScale ? HeightScale?.value : HeightScale} /* default: 0 */  />
