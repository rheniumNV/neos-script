...
<Member type={`FrooxEngine.RelayRef\`1[FrooxEngine.Light]`} name="Sun" id={typeof Sun === "object" && "id" in Sun ? Sun?.id : undefined} value={typeof Sun === "object" && "value" in Sun ? Sun?.value : Sun} /* default: ID0 */  isRaw={typeof Sun === "object" && "isRaw" in Sun && Sun.isRaw ? true : undefined} />
