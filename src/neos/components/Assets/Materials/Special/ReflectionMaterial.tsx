...
<Member type={`FrooxEngine.Sync\`1[System.Single]`} name="Distort" id={typeof Distort === "object" && "id" in Distort ? Distort?.id : undefined} value={typeof Distort === "object" && "value" in Distort ? Distort?.value : Distort} /* default: 0 */  isRaw={typeof Distort === "object" && "isRaw" in Distort && Distort.isRaw ? true : undefined} />
