...
<Member type={`FrooxEngine.Sync\`1[BaseX.color]`} name="OuterColor" id={typeof OuterColor === "object" && "id" in OuterColor ? OuterColor?.id : undefined} value={typeof OuterColor === "object" && "value" in OuterColor ? OuterColor?.value : OuterColor} /* default: [0; 0; 0; 0] */  isRaw={typeof OuterColor === "object" && "isRaw" in OuterColor && OuterColor.isRaw ? true : undefined} />
<Member type={`FrooxEngine.Sync\`1[BaseX.color]`} name="InnerColor" id={typeof InnerColor === "object" && "id" in InnerColor ? InnerColor?.id : undefined} value={typeof InnerColor === "object" && "value" in InnerColor ? InnerColor?.value : InnerColor} /* default: [0; 0; 0; 0] */  isRaw={typeof InnerColor === "object" && "isRaw" in InnerColor && InnerColor.isRaw ? true : undefined} />
<Member type={`FrooxEngine.Sync\`1[System.Nullable\`1[BaseX.Rect]]`} name="ClipRect" id={typeof ClipRect === "object" && "id" in ClipRect ? ClipRect?.id : undefined} value={typeof ClipRect === "object" && "value" in ClipRect ? ClipRect?.value : ClipRect} /* default: <i>null</i> */  isRaw={typeof ClipRect === "object" && "isRaw" in ClipRect && ClipRect.isRaw ? true : undefined} />
