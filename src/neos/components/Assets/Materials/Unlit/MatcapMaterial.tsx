...
RenderQueue?: member<number>;
    ...
    export function MatcapMaterial(props: MatcapMaterialInput){
...
RenderQueue, } = props;
      ...
      return (
        <Component type="FrooxEngine.MatcapMaterial" id={id} persistentId={persistentId} updateOrder={updateOrder}>
