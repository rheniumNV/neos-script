...
<Member type={`FrooxEngine.AssetRef\`1[FrooxEngine.ITexture2D]`} name="SecondaryTexture" id={typeof SecondaryTexture === "object" && "id" in SecondaryTexture ? SecondaryTexture?.id : undefined} value={typeof SecondaryTexture === "object" && "value" in SecondaryTexture ? SecondaryTexture?.value : SecondaryTexture} /* default: ID0 */  isRaw={typeof SecondaryTexture === "object" && "isRaw" in SecondaryTexture && SecondaryTexture.isRaw ? true : undefined} />
...
<Member type={`FrooxEngine.AssetRef\`1[FrooxEngine.Cubemap]`} name="SecondaryCubemap" id={typeof SecondaryCubemap === "object" && "id" in SecondaryCubemap ? SecondaryCubemap?.id : undefined} value={typeof SecondaryCubemap === "object" && "value" in SecondaryCubemap ? SecondaryCubemap?.value : SecondaryCubemap} /* default: ID0 */  isRaw={typeof SecondaryCubemap === "object" && "isRaw" in SecondaryCubemap && SecondaryCubemap.isRaw ? true : undefined} />
<Member type={`FrooxEngine.Sync\`1[System.Nullable\`1[System.Single]]`} name="CubemapLOD" id={typeof CubemapLOD === "object" && "id" in CubemapLOD ? CubemapLOD?.id : undefined} value={typeof CubemapLOD === "object" && "value" in CubemapLOD ? CubemapLOD?.value : CubemapLOD} /* default: <i>null</i> */  isRaw={typeof CubemapLOD === "object" && "isRaw" in CubemapLOD && CubemapLOD.isRaw ? true : undefined} />
<Member type={`FrooxEngine.Sync\`1[System.Single]`} name="TextureLerp" id={typeof TextureLerp === "object" && "id" in TextureLerp ? TextureLerp?.id : undefined} value={typeof TextureLerp === "object" && "value" in TextureLerp ? TextureLerp?.value : TextureLerp} /* default: 0 */  isRaw={typeof TextureLerp === "object" && "isRaw" in TextureLerp && TextureLerp.isRaw ? true : undefined} />
<Member type={`FrooxEngine.Sync\`1[FrooxEngine.Projection360Material+Mode]`} name="Projection" id={typeof Projection === "object" && "id" in Projection ? Projection?.id : undefined} value={typeof Projection === "object" && "value" in Projection ? Projection?.value : Projection} /* default: View */  isRaw={typeof Projection === "object" && "isRaw" in Projection && Projection.isRaw ? true : undefined} />
...
<Member type={`FrooxEngine.Sync\`1[System.Single]`} name="Gamma" id={typeof Gamma === "object" && "id" in Gamma ? Gamma?.id : undefined} value={typeof Gamma === "object" && "value" in Gamma ? Gamma?.value : Gamma} /* default: 0 */  isRaw={typeof Gamma === "object" && "isRaw" in Gamma && Gamma.isRaw ? true : undefined} />
<Member type={`FrooxEngine.AssetRef\`1[FrooxEngine.ITexture2D]`} name="TintTexture" id={typeof TintTexture === "object" && "id" in TintTexture ? TintTexture?.id : undefined} value={typeof TintTexture === "object" && "value" in TintTexture ? TintTexture?.value : TintTexture} /* default: ID0 */  isRaw={typeof TintTexture === "object" && "isRaw" in TintTexture && TintTexture.isRaw ? true : undefined} />
<Member type={`FrooxEngine.Sync\`1[BaseX.float2]`} name="TintTextureScale" id={typeof TintTextureScale === "object" && "id" in TintTextureScale ? TintTextureScale?.id : undefined} value={typeof TintTextureScale === "object" && "value" in TintTextureScale ? TintTextureScale?.value : TintTextureScale} /* default: [0; 0] */  isRaw={typeof TintTextureScale === "object" && "isRaw" in TintTextureScale && TintTextureScale.isRaw ? true : undefined} />
<Member type={`FrooxEngine.Sync\`1[BaseX.float2]`} name="TintTextureOffset" id={typeof TintTextureOffset === "object" && "id" in TintTextureOffset ? TintTextureOffset?.id : undefined} value={typeof TintTextureOffset === "object" && "value" in TintTextureOffset ? TintTextureOffset?.value : TintTextureOffset} /* default: [0; 0] */  isRaw={typeof TintTextureOffset === "object" && "isRaw" in TintTextureOffset && TintTextureOffset.isRaw ? true : undefined} />
<Member type={`FrooxEngine.Sync\`1[FrooxEngine.Projection360Material+TintMode]`} name="TintTextureMode" id={typeof TintTextureMode === "object" && "id" in TintTextureMode ? TintTextureMode?.id : undefined} value={typeof TintTextureMode === "object" && "value" in TintTextureMode ? TintTextureMode?.value : TintTextureMode} /* default: Direct */  isRaw={typeof TintTextureMode === "object" && "isRaw" in TintTextureMode && TintTextureMode.isRaw ? true : undefined} />
<Member type={`FrooxEngine.Sync\`1[BaseX.color]`} name="Tint0" id={typeof Tint0 === "object" && "id" in Tint0 ? Tint0?.id : undefined} value={typeof Tint0 === "object" && "value" in Tint0 ? Tint0?.value : Tint0} /* default: [0; 0; 0; 0] */  isRaw={typeof Tint0 === "object" && "isRaw" in Tint0 && Tint0.isRaw ? true : undefined} />
<Member type={`FrooxEngine.Sync\`1[BaseX.color]`} name="Tint1" id={typeof Tint1 === "object" && "id" in Tint1 ? Tint1?.id : undefined} value={typeof Tint1 === "object" && "value" in Tint1 ? Tint1?.value : Tint1} /* default: [0; 0; 0; 0] */  isRaw={typeof Tint1 === "object" && "isRaw" in Tint1 && Tint1.isRaw ? true : undefined} />
<Member type={`FrooxEngine.Sync\`1[FrooxEngine.Projection360Material+Outside]`} name="OutsideMode" id={typeof OutsideMode === "object" && "id" in OutsideMode ? OutsideMode?.id : undefined} value={typeof OutsideMode === "object" && "value" in OutsideMode ? OutsideMode?.value : OutsideMode} /* default: Clip */  isRaw={typeof OutsideMode === "object" && "isRaw" in OutsideMode && OutsideMode.isRaw ? true : undefined} />
<Member type={`FrooxEngine.Sync\`1[BaseX.color]`} name="OutsideColor" id={typeof OutsideColor === "object" && "id" in OutsideColor ? OutsideColor?.id : undefined} value={typeof OutsideColor === "object" && "value" in OutsideColor ? OutsideColor?.value : OutsideColor} /* default: [0; 0; 0; 0] */  isRaw={typeof OutsideColor === "object" && "isRaw" in OutsideColor && OutsideColor.isRaw ? true : undefined} />
...
<Member type={`FrooxEngine.Sync\`1[System.Boolean]`} name="StereoTextureTransform" id={typeof StereoTextureTransform === "object" && "id" in StereoTextureTransform ? StereoTextureTransform?.id : undefined} value={typeof StereoTextureTransform === "object" && "value" in StereoTextureTransform ? StereoTextureTransform?.value : StereoTextureTransform} /* default: false */  isRaw={typeof StereoTextureTransform === "object" && "isRaw" in StereoTextureTransform && StereoTextureTransform.isRaw ? true : undefined} />
<Member type={`FrooxEngine.Sync\`1[BaseX.float2]`} name="RightEyeTextureOffset" id={typeof RightEyeTextureOffset === "object" && "id" in RightEyeTextureOffset ? RightEyeTextureOffset?.id : undefined} value={typeof RightEyeTextureOffset === "object" && "value" in RightEyeTextureOffset ? RightEyeTextureOffset?.value : RightEyeTextureOffset} /* default: [0; 0] */  isRaw={typeof RightEyeTextureOffset === "object" && "isRaw" in RightEyeTextureOffset && RightEyeTextureOffset.isRaw ? true : undefined} />
<Member type={`FrooxEngine.Sync\`1[BaseX.float2]`} name="RightEyeTextureScale" id={typeof RightEyeTextureScale === "object" && "id" in RightEyeTextureScale ? RightEyeTextureScale?.id : undefined} value={typeof RightEyeTextureScale === "object" && "value" in RightEyeTextureScale ? RightEyeTextureScale?.value : RightEyeTextureScale} /* default: [0; 0] */  isRaw={typeof RightEyeTextureScale === "object" && "isRaw" in RightEyeTextureScale && RightEyeTextureScale.isRaw ? true : undefined} />
...
<Member type={`FrooxEngine.AssetRef\`1[FrooxEngine.ITexture2D]`} name="OffsetTexture" id={typeof OffsetTexture === "object" && "id" in OffsetTexture ? OffsetTexture?.id : undefined} value={typeof OffsetTexture === "object" && "value" in OffsetTexture ? OffsetTexture?.value : OffsetTexture} /* default: ID0 */  isRaw={typeof OffsetTexture === "object" && "isRaw" in OffsetTexture && OffsetTexture.isRaw ? true : undefined} />
<Member type={`FrooxEngine.AssetRef\`1[FrooxEngine.ITexture2D]`} name="OffsetMask" id={typeof OffsetMask === "object" && "id" in OffsetMask ? OffsetMask?.id : undefined} value={typeof OffsetMask === "object" && "value" in OffsetMask ? OffsetMask?.value : OffsetMask} /* default: ID0 */  isRaw={typeof OffsetMask === "object" && "isRaw" in OffsetMask && OffsetMask.isRaw ? true : undefined} />
<Member type={`FrooxEngine.Sync\`1[BaseX.float2]`} name="OffsetTextureOffset" id={typeof OffsetTextureOffset === "object" && "id" in OffsetTextureOffset ? OffsetTextureOffset?.id : undefined} value={typeof OffsetTextureOffset === "object" && "value" in OffsetTextureOffset ? OffsetTextureOffset?.value : OffsetTextureOffset} /* default: [0; 0] */  isRaw={typeof OffsetTextureOffset === "object" && "isRaw" in OffsetTextureOffset && OffsetTextureOffset.isRaw ? true : undefined} />
<Member type={`FrooxEngine.Sync\`1[BaseX.float2]`} name="OffsetTextureScale" id={typeof OffsetTextureScale === "object" && "id" in OffsetTextureScale ? OffsetTextureScale?.id : undefined} value={typeof OffsetTextureScale === "object" && "value" in OffsetTextureScale ? OffsetTextureScale?.value : OffsetTextureScale} /* default: [0; 0] */  isRaw={typeof OffsetTextureScale === "object" && "isRaw" in OffsetTextureScale && OffsetTextureScale.isRaw ? true : undefined} />
<Member type={`FrooxEngine.Sync\`1[BaseX.float2]`} name="OffsetMagnitude" id={typeof OffsetMagnitude === "object" && "id" in OffsetMagnitude ? OffsetMagnitude?.id : undefined} value={typeof OffsetMagnitude === "object" && "value" in OffsetMagnitude ? OffsetMagnitude?.value : OffsetMagnitude} /* default: [0; 0] */  isRaw={typeof OffsetMagnitude === "object" && "isRaw" in OffsetMagnitude && OffsetMagnitude.isRaw ? true : undefined} />
