...
<Member type={`FrooxEngine.Sync\`1[BaseX.float3]`} name="Point" id={typeof Point === "object" && "id" in Point ? Point?.id : undefined} value={typeof Point === "object" && "value" in Point ? Point?.value : Point} /* default: [0; 0; 0] */  isRaw={typeof Point === "object" && "isRaw" in Point && Point.isRaw ? true : undefined} />
...
<Member type={`FrooxEngine.Sync\`1[System.Single]`} name="TransitionRange" id={typeof TransitionRange === "object" && "id" in TransitionRange ? TransitionRange?.id : undefined} value={typeof TransitionRange === "object" && "value" in TransitionRange ? TransitionRange?.value : TransitionRange} /* default: 0 */  isRaw={typeof TransitionRange === "object" && "isRaw" in TransitionRange && TransitionRange.isRaw ? true : undefined} />
<Member type={`FrooxEngine.AssetRef\`1[FrooxEngine.ITexture2D]`} name="NearTexture" id={typeof NearTexture === "object" && "id" in NearTexture ? NearTexture?.id : undefined} value={typeof NearTexture === "object" && "value" in NearTexture ? NearTexture?.value : NearTexture} /* default: ID0 */  isRaw={typeof NearTexture === "object" && "isRaw" in NearTexture && NearTexture.isRaw ? true : undefined} />
<Member type={`FrooxEngine.AssetRef\`1[FrooxEngine.ITexture2D]`} name="FarTexture" id={typeof FarTexture === "object" && "id" in FarTexture ? FarTexture?.id : undefined} value={typeof FarTexture === "object" && "value" in FarTexture ? FarTexture?.value : FarTexture} /* default: ID0 */  isRaw={typeof FarTexture === "object" && "isRaw" in FarTexture && FarTexture.isRaw ? true : undefined} />
<Member type={`FrooxEngine.Sync\`1[BaseX.float2]`} name="NearTextureScale" id={typeof NearTextureScale === "object" && "id" in NearTextureScale ? NearTextureScale?.id : undefined} value={typeof NearTextureScale === "object" && "value" in NearTextureScale ? NearTextureScale?.value : NearTextureScale} /* default: [0; 0] */  isRaw={typeof NearTextureScale === "object" && "isRaw" in NearTextureScale && NearTextureScale.isRaw ? true : undefined} />
<Member type={`FrooxEngine.Sync\`1[BaseX.float2]`} name="NearTextureOffset" id={typeof NearTextureOffset === "object" && "id" in NearTextureOffset ? NearTextureOffset?.id : undefined} value={typeof NearTextureOffset === "object" && "value" in NearTextureOffset ? NearTextureOffset?.value : NearTextureOffset} /* default: [0; 0] */  isRaw={typeof NearTextureOffset === "object" && "isRaw" in NearTextureOffset && NearTextureOffset.isRaw ? true : undefined} />
<Member type={`FrooxEngine.Sync\`1[BaseX.float2]`} name="FarTextureScale" id={typeof FarTextureScale === "object" && "id" in FarTextureScale ? FarTextureScale?.id : undefined} value={typeof FarTextureScale === "object" && "value" in FarTextureScale ? FarTextureScale?.value : FarTextureScale} /* default: [0; 0] */  isRaw={typeof FarTextureScale === "object" && "isRaw" in FarTextureScale && FarTextureScale.isRaw ? true : undefined} />
<Member type={`FrooxEngine.Sync\`1[BaseX.float2]`} name="FarTextureOffset" id={typeof FarTextureOffset === "object" && "id" in FarTextureOffset ? FarTextureOffset?.id : undefined} value={typeof FarTextureOffset === "object" && "value" in FarTextureOffset ? FarTextureOffset?.value : FarTextureOffset} /* default: [0; 0] */  isRaw={typeof FarTextureOffset === "object" && "isRaw" in FarTextureOffset && FarTextureOffset.isRaw ? true : undefined} />
<Member type={`FrooxEngine.Sync\`1[BaseX.color]`} name="NearColor" id={typeof NearColor === "object" && "id" in NearColor ? NearColor?.id : undefined} value={typeof NearColor === "object" && "value" in NearColor ? NearColor?.value : NearColor} /* default: [0; 0; 0; 0] */  isRaw={typeof NearColor === "object" && "isRaw" in NearColor && NearColor.isRaw ? true : undefined} />
<Member type={`FrooxEngine.Sync\`1[BaseX.color]`} name="FarColor" id={typeof FarColor === "object" && "id" in FarColor ? FarColor?.id : undefined} value={typeof FarColor === "object" && "value" in FarColor ? FarColor?.value : FarColor} /* default: [0; 0; 0; 0] */  isRaw={typeof FarColor === "object" && "isRaw" in FarColor && FarColor.isRaw ? true : undefined} />
