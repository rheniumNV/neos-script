...
<Member type={`FrooxEngine.Sync\`1[System.Boolean]`} name="DecodeAsNormalMap" id={typeof DecodeAsNormalMap === "object" && "id" in DecodeAsNormalMap ? DecodeAsNormalMap?.id : undefined} value={typeof DecodeAsNormalMap === "object" && "value" in DecodeAsNormalMap ? DecodeAsNormalMap?.value : DecodeAsNormalMap} /* default: false */  isRaw={typeof DecodeAsNormalMap === "object" && "isRaw" in DecodeAsNormalMap && DecodeAsNormalMap.isRaw ? true : undefined} />
<Member type={`FrooxEngine.Sync\`1[System.Boolean]`} name="UseBillboardGeometry" id={typeof UseBillboardGeometry === "object" && "id" in UseBillboardGeometry ? UseBillboardGeometry?.id : undefined} value={typeof UseBillboardGeometry === "object" && "value" in UseBillboardGeometry ? UseBillboardGeometry?.value : UseBillboardGeometry} /* default: false */  isRaw={typeof UseBillboardGeometry === "object" && "isRaw" in UseBillboardGeometry && UseBillboardGeometry.isRaw ? true : undefined} />
<Member type={`FrooxEngine.Sync\`1[System.Boolean]`} name="UsePerBillboardScale" id={typeof UsePerBillboardScale === "object" && "id" in UsePerBillboardScale ? UsePerBillboardScale?.id : undefined} value={typeof UsePerBillboardScale === "object" && "value" in UsePerBillboardScale ? UsePerBillboardScale?.value : UsePerBillboardScale} /* default: false */  isRaw={typeof UsePerBillboardScale === "object" && "isRaw" in UsePerBillboardScale && UsePerBillboardScale.isRaw ? true : undefined} />
<Member type={`FrooxEngine.Sync\`1[System.Boolean]`} name="UsePerBillboardRotation" id={typeof UsePerBillboardRotation === "object" && "id" in UsePerBillboardRotation ? UsePerBillboardRotation?.id : undefined} value={typeof UsePerBillboardRotation === "object" && "value" in UsePerBillboardRotation ? UsePerBillboardRotation?.value : UsePerBillboardRotation} /* default: false */  isRaw={typeof UsePerBillboardRotation === "object" && "isRaw" in UsePerBillboardRotation && UsePerBillboardRotation.isRaw ? true : undefined} />
<Member type={`FrooxEngine.Sync\`1[System.Boolean]`} name="UsePerBillboardUV" id={typeof UsePerBillboardUV === "object" && "id" in UsePerBillboardUV ? UsePerBillboardUV?.id : undefined} value={typeof UsePerBillboardUV === "object" && "value" in UsePerBillboardUV ? UsePerBillboardUV?.value : UsePerBillboardUV} /* default: false */  isRaw={typeof UsePerBillboardUV === "object" && "isRaw" in UsePerBillboardUV && UsePerBillboardUV.isRaw ? true : undefined} />
<Member type={`FrooxEngine.Sync\`1[BaseX.float2]`} name="BillboardSize" id={typeof BillboardSize === "object" && "id" in BillboardSize ? BillboardSize?.id : undefined} value={typeof BillboardSize === "object" && "value" in BillboardSize ? BillboardSize?.value : BillboardSize} /* default: [0; 0] */  isRaw={typeof BillboardSize === "object" && "isRaw" in BillboardSize && BillboardSize.isRaw ? true : undefined} />
...
<Member type={`FrooxEngine.AssetRef\`1[FrooxEngine.Shader]`} name="_unlit-ID" id={typeof _unlit === "object" && "id" in _unlit ? _unlit?.id : undefined} value={typeof _unlit === "object" && "value" in _unlit ? _unlit?.value : _unlit} /* default: ID0 */ readOnly isRaw={typeof _unlit === "object" && "isRaw" in _unlit && _unlit.isRaw ? true : undefined} />
<Member type={`FrooxEngine.AssetRef\`1[FrooxEngine.Shader]`} name="_unlitBillboard-ID" id={typeof _unlitBillboard === "object" && "id" in _unlitBillboard ? _unlitBillboard?.id : undefined} value={typeof _unlitBillboard === "object" && "value" in _unlitBillboard ? _unlitBillboard?.value : _unlitBillboard} /* default: ID0 */ readOnly isRaw={typeof _unlitBillboard === "object" && "isRaw" in _unlitBillboard && _unlitBillboard.isRaw ? true : undefined} />
        </Component>
      );
    };
