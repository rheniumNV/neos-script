...
Amplitude?: member<number>;
    ...
    export function SawtoothWaveClip(props: SawtoothWaveClipInput){
...
Amplitude, } = props;
      ...
      return (
        <Component type="FrooxEngine.SawtoothWaveClip" id={id} persistentId={persistentId} updateOrder={updateOrder}>
