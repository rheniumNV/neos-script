...
Amplitude?: member<number>;
    ...
    export function SquareWaveClip(props: SquareWaveClipInput){
...
Amplitude, } = props;
      ...
      return (
        <Component type="FrooxEngine.SquareWaveClip" id={id} persistentId={persistentId} updateOrder={updateOrder}>
