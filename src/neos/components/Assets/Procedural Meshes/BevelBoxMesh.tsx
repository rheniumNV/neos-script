...
<Member type={`FrooxEngine.Sync\`1[System.Single]`} name="Bevel" id={typeof Bevel === "object" && "id" in Bevel ? Bevel?.id : undefined} value={typeof Bevel === "object" && "value" in Bevel ? Bevel?.value : Bevel} /* default: 0 */  isRaw={typeof Bevel === "object" && "isRaw" in Bevel && Bevel.isRaw ? true : undefined} />
