...
ScaleUVWithSize?: member<boolean>;
    ...
    export function BevelBoxMesh(props: BevelBoxMeshInput){
...
ScaleUVWithSize, } = props;
      ...
      return (
        <Component type="FrooxEngine.BevelBoxMesh" id={id} persistentId={persistentId} updateOrder={updateOrder}>
...
<Member type={`FrooxEngine.Sync\`1[System.Single]`} name="Bevel" id={typeof Bevel === "object" && "id" in Bevel ? Bevel?.id : undefined} value={typeof Bevel === "object" && "value" in Bevel ? Bevel?.value : Bevel} /* default: 0 */  />
<Member type={`FrooxEngine.Sync\`1[BaseX.float3]`} name="UVScale" id={typeof UVScale === "object" && "id" in UVScale ? UVScale?.id : undefined} value={typeof UVScale === "object" && "value" in UVScale ? UVScale?.value : UVScale} /* default: [0; 0; 0] */  />
