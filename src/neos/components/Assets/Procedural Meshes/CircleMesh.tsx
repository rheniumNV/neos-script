...
TriangleFan, } = props;
      ...
      return (
        <Component type="FrooxEngine.CircleMesh" id={id} persistentId={persistentId} updateOrder={updateOrder}>
...
<Member type={`FrooxEngine.Sync\`1[System.Boolean]`} name="TriangleFan" id={typeof TriangleFan === "object" && "id" in TriangleFan ? TriangleFan?.id : undefined} value={typeof TriangleFan === "object" && "value" in TriangleFan ? TriangleFan?.value : TriangleFan} /* default: false */  />
        </Component>
      );
    };
