...
<Member type={`FrooxEngine.Sync\`1[System.Single]`} name="RadiusBase" id={typeof RadiusBase === "object" && "id" in RadiusBase ? RadiusBase?.id : undefined} value={typeof RadiusBase === "object" && "value" in RadiusBase ? RadiusBase?.value : RadiusBase} /* default: 0 */  />
<Member type={`FrooxEngine.Sync\`1[System.Single]`} name="RadiusTop" id={typeof RadiusTop === "object" && "id" in RadiusTop ? RadiusTop?.id : undefined} value={typeof RadiusTop === "object" && "value" in RadiusTop ? RadiusTop?.value : RadiusTop} /* default: 0 */  />
...
<Member type={`FrooxEngine.Sync\`1[System.Boolean]`} name="Caps" id={typeof Caps === "object" && "id" in Caps ? Caps?.id : undefined} value={typeof Caps === "object" && "value" in Caps ? Caps?.value : Caps} /* default: false */  />
