...
BarRatio?: member<number>;
    ...
    export function CrossMesh(props: CrossMeshInput){
...
BarRatio, } = props;
      ...
      return (
        <Component type="FrooxEngine.CrossMesh" id={id} persistentId={persistentId} updateOrder={updateOrder}>
...
<Member type={`FrooxEngine.Sync\`1[System.Single]`} name="BarRatio" id={typeof BarRatio === "object" && "id" in BarRatio ? BarRatio?.id : undefined} value={typeof BarRatio === "object" && "value" in BarRatio ? BarRatio?.value : BarRatio} /* default: 0 */  isRaw={typeof BarRatio === "object" && "isRaw" in BarRatio && BarRatio.isRaw ? true : undefined} />
        </Component>
      );
    };
