...
UVScale?: member<[number, number]>;
    ...
    export function FrameMesh(props: FrameMeshInput){
...
UVScale, } = props;
      ...
      return (
        <Component type="FrooxEngine.FrameMesh" id={id} persistentId={persistentId} updateOrder={updateOrder}>
...
<Member type={`FrooxEngine.Sync\`1[BaseX.float2]`} name="ContentSize" id={typeof ContentSize === "object" && "id" in ContentSize ? ContentSize?.id : undefined} value={typeof ContentSize === "object" && "value" in ContentSize ? ContentSize?.value : ContentSize} /* default: [0; 0] */  isRaw={typeof ContentSize === "object" && "isRaw" in ContentSize && ContentSize.isRaw ? true : undefined} />
