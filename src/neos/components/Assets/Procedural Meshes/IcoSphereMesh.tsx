...
<Member type={`FrooxEngine.Sync\`1[System.Int32]`} name="Subdivisions" id={typeof Subdivisions === "object" && "id" in Subdivisions ? Subdivisions?.id : undefined} value={typeof Subdivisions === "object" && "value" in Subdivisions ? Subdivisions?.value : Subdivisions} /* default: 0 */  />
...
<Member type={`FrooxEngine.Sync\`1[System.Single]`} name="FlatFaceExtrude" id={typeof FlatFaceExtrude === "object" && "id" in FlatFaceExtrude ? FlatFaceExtrude?.id : undefined} value={typeof FlatFaceExtrude === "object" && "value" in FlatFaceExtrude ? FlatFaceExtrude?.value : FlatFaceExtrude} /* default: 0 */  />
<Member type={`FrooxEngine.Sync\`1[System.Single]`} name="FlatFaceScale" id={typeof FlatFaceScale === "object" && "id" in FlatFaceScale ? FlatFaceScale?.id : undefined} value={typeof FlatFaceScale === "object" && "value" in FlatFaceScale ? FlatFaceScale?.value : FlatFaceScale} /* default: 0 */  />
        </Component>
      );
    };
