...
<Member type={`FrooxEngine.Sync\`1[BaseX.SegmentedBuilder+Topology]`} name="Topology" id={typeof Topology === "object" && "id" in Topology ? Topology?.id : undefined} value={typeof Topology === "object" && "value" in Topology ? Topology?.value : Topology} /* default: Circle */  isRaw={typeof Topology === "object" && "isRaw" in Topology && Topology.isRaw ? true : undefined} />
