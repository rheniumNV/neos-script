...
Lines?: member<any>;
    ...
    export function MultiLineMesh(props: MultiLineMeshInput){
...
Lines, } = props;
      ...
      return (
        <Component type="FrooxEngine.MultiLineMesh" id={id} persistentId={persistentId} updateOrder={updateOrder}>
...
<Member type={`FrooxEngine.SyncList\`1[FrooxEngine.MultiLineMesh+Line]`} name="Lines" id={typeof Lines === "object" && "id" in Lines ? Lines?.id : undefined} value={typeof Lines === "object" && "value" in Lines ? Lines?.value : Lines} /* default: FrooxEngine.SyncList`1[FrooxEngine.MultiLineMesh+Line] */  isRaw={typeof Lines === "object" && "isRaw" in Lines && Lines.isRaw ? true : undefined} />
        </Component>
      );
    };
