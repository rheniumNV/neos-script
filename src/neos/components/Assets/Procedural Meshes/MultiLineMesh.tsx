...
<Member type={`FrooxEngine.SyncList\`1[FrooxEngine.MultiLineMesh+Line]`} name="Lines" id={typeof Lines === "object" && "id" in Lines ? Lines?.id : undefined} value={typeof Lines === "object" && "value" in Lines ? Lines?.value : Lines} /* default: FrooxEngine.SyncList`1[FrooxEngine.MultiLineMesh+Line] */  />
        </Component>
      );
    };
