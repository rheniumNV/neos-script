...
<Member type={`FrooxEngine.SyncList\`1[FrooxEngine.MultiSegmentMesh+SegmentInfo]`} name="Segments" id={typeof Segments === "object" && "id" in Segments ? Segments?.id : undefined} value={typeof Segments === "object" && "value" in Segments ? Segments?.value : Segments} /* default: FrooxEngine.SyncList`1[FrooxEngine.MultiSegmentMesh+SegmentInfo] */  isRaw={typeof Segments === "object" && "isRaw" in Segments && Segments.isRaw ? true : undefined} />
        </Component>
      );
    };
