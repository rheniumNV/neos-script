...
<Member type={`FrooxEngine.SyncList\`1[FrooxEngine.MultiBevelSoliStripeMesh+Stripe]`} name="Stripes" id={typeof Stripes === "object" && "id" in Stripes ? Stripes?.id : undefined} value={typeof Stripes === "object" && "value" in Stripes ? Stripes?.value : Stripes} /* default: FrooxEngine.SyncList`1[FrooxEngine.MultiBevelSoliStripeMesh+Stripe] */  />
        </Component>
      );
    };
