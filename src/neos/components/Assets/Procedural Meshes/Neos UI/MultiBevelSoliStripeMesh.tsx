...
Stripes?: member<any>;
    ...
    export function MultiBevelSoliStripeMesh(props: MultiBevelSoliStripeMeshInput){
...
Stripes, } = props;
      ...
      return (
        <Component type="FrooxEngine.MultiBevelSoliStripeMesh" id={id} persistentId={persistentId} updateOrder={updateOrder}>
...
<Member type={`FrooxEngine.SyncList\`1[FrooxEngine.MultiBevelSoliStripeMesh+Stripe]`} name="Stripes" id={typeof Stripes === "object" && "id" in Stripes ? Stripes?.id : undefined} value={typeof Stripes === "object" && "value" in Stripes ? Stripes?.value : Stripes} /* default: FrooxEngine.SyncList`1[FrooxEngine.MultiBevelSoliStripeMesh+Stripe] */  isRaw={typeof Stripes === "object" && "isRaw" in Stripes && Stripes.isRaw ? true : undefined} />
        </Component>
      );
    };
