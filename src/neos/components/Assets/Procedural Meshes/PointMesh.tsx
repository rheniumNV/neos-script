...
<Member type={`FrooxEngine.SyncArray\`1[System.Single]`} name="Rotations" id={typeof Rotations === "object" && "id" in Rotations ? Rotations?.id : undefined} value={typeof Rotations === "object" && "value" in Rotations ? Rotations?.value : Rotations} /* default: FrooxEngine.SyncArray`1[System.Single] */  />
...
<Member type={`FrooxEngine.Sync\`1[System.Boolean]`} name="Sort" id={typeof Sort === "object" && "id" in Sort ? Sort?.id : undefined} value={typeof Sort === "object" && "value" in Sort ? Sort?.value : Sort} /* default: false */  />
<Member type={`FrooxEngine.Sync\`1[BaseX.float3]`} name="SortPoint" id={typeof SortPoint === "object" && "id" in SortPoint ? SortPoint?.id : undefined} value={typeof SortPoint === "object" && "value" in SortPoint ? SortPoint?.value : SortPoint} /* default: [0; 0; 0] */  />
        </Component>
      );
    };
