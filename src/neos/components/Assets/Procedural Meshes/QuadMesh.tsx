...
<Member type={`FrooxEngine.Sync\`1[BaseX.color]`} name="UpperLeftColor" id={typeof UpperLeftColor === "object" && "id" in UpperLeftColor ? UpperLeftColor?.id : undefined} value={typeof UpperLeftColor === "object" && "value" in UpperLeftColor ? UpperLeftColor?.value : UpperLeftColor} /* default: [0; 0; 0; 0] */  isRaw={typeof UpperLeftColor === "object" && "isRaw" in UpperLeftColor && UpperLeftColor.isRaw ? true : undefined} />
<Member type={`FrooxEngine.Sync\`1[BaseX.color]`} name="LowerLeftColor" id={typeof LowerLeftColor === "object" && "id" in LowerLeftColor ? LowerLeftColor?.id : undefined} value={typeof LowerLeftColor === "object" && "value" in LowerLeftColor ? LowerLeftColor?.value : LowerLeftColor} /* default: [0; 0; 0; 0] */  isRaw={typeof LowerLeftColor === "object" && "isRaw" in LowerLeftColor && LowerLeftColor.isRaw ? true : undefined} />
<Member type={`FrooxEngine.Sync\`1[BaseX.color]`} name="LowerRightColor" id={typeof LowerRightColor === "object" && "id" in LowerRightColor ? LowerRightColor?.id : undefined} value={typeof LowerRightColor === "object" && "value" in LowerRightColor ? LowerRightColor?.value : LowerRightColor} /* default: [0; 0; 0; 0] */  isRaw={typeof LowerRightColor === "object" && "isRaw" in LowerRightColor && LowerRightColor.isRaw ? true : undefined} />
<Member type={`FrooxEngine.Sync\`1[BaseX.color]`} name="UpperRightColor" id={typeof UpperRightColor === "object" && "id" in UpperRightColor ? UpperRightColor?.id : undefined} value={typeof UpperRightColor === "object" && "value" in UpperRightColor ? UpperRightColor?.value : UpperRightColor} /* default: [0; 0; 0; 0] */  isRaw={typeof UpperRightColor === "object" && "isRaw" in UpperRightColor && UpperRightColor.isRaw ? true : undefined} />
        </Component>
      );
    };
