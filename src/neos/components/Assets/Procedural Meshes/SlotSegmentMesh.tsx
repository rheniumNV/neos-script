...
<Member type={`FrooxEngine.SyncRef\`1[FrooxEngine.Slot]`} name="PointA" id={typeof PointA === "object" && "id" in PointA ? PointA?.id : undefined} value={typeof PointA === "object" && "value" in PointA ? PointA?.value : PointA} /* default: ID0 */  />
<Member type={`FrooxEngine.SyncRef\`1[FrooxEngine.Slot]`} name="PointB" id={typeof PointB === "object" && "id" in PointB ? PointB?.id : undefined} value={typeof PointB === "object" && "value" in PointB ? PointB?.value : PointB} /* default: ID0 */  />
        </Component>
      );
    };
