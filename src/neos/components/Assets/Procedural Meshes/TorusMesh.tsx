...
<Member type={`FrooxEngine.Sync\`1[System.Int32]`} name="MinorSegments" id={typeof MinorSegments === "object" && "id" in MinorSegments ? MinorSegments?.id : undefined} value={typeof MinorSegments === "object" && "value" in MinorSegments ? MinorSegments?.value : MinorSegments} /* default: 0 */  />
<Member type={`FrooxEngine.Sync\`1[System.Int32]`} name="MajorSegments" id={typeof MajorSegments === "object" && "id" in MajorSegments ? MajorSegments?.id : undefined} value={typeof MajorSegments === "object" && "value" in MajorSegments ? MajorSegments?.value : MajorSegments} /* default: 0 */  />
<Member type={`FrooxEngine.Sync\`1[System.Single]`} name="MajorRadius" id={typeof MajorRadius === "object" && "id" in MajorRadius ? MajorRadius?.id : undefined} value={typeof MajorRadius === "object" && "value" in MajorRadius ? MajorRadius?.value : MajorRadius} /* default: 0 */  />
<Member type={`FrooxEngine.Sync\`1[System.Single]`} name="MinorRadius" id={typeof MinorRadius === "object" && "id" in MinorRadius ? MinorRadius?.id : undefined} value={typeof MinorRadius === "object" && "value" in MinorRadius ? MinorRadius?.value : MinorRadius} /* default: 0 */  />
