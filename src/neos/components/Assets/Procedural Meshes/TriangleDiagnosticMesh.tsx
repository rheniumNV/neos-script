...
<Member type={`FrooxEngine.Sync\`1[System.Int32]`} name="TriangleIndex" id={typeof TriangleIndex === "object" && "id" in TriangleIndex ? TriangleIndex?.id : undefined} value={typeof TriangleIndex === "object" && "value" in TriangleIndex ? TriangleIndex?.value : TriangleIndex} /* default: 0 */  />
<Member type={`FrooxEngine.Sync\`1[BaseX.color]`} name="Vertex0Color" id={typeof Vertex0Color === "object" && "id" in Vertex0Color ? Vertex0Color?.id : undefined} value={typeof Vertex0Color === "object" && "value" in Vertex0Color ? Vertex0Color?.value : Vertex0Color} /* default: [0; 0; 0; 0] */  />
<Member type={`FrooxEngine.Sync\`1[BaseX.color]`} name="Vertex1Color" id={typeof Vertex1Color === "object" && "id" in Vertex1Color ? Vertex1Color?.id : undefined} value={typeof Vertex1Color === "object" && "value" in Vertex1Color ? Vertex1Color?.value : Vertex1Color} /* default: [0; 0; 0; 0] */  />
<Member type={`FrooxEngine.Sync\`1[BaseX.color]`} name="Vertex2Color" id={typeof Vertex2Color === "object" && "id" in Vertex2Color ? Vertex2Color?.id : undefined} value={typeof Vertex2Color === "object" && "value" in Vertex2Color ? Vertex2Color?.value : Vertex2Color} /* default: [0; 0; 0; 0] */  />
<Member type={`FrooxEngine.Sync\`1[System.Single]`} name="Displace" id={typeof Displace === "object" && "id" in Displace ? Displace?.id : undefined} value={typeof Displace === "object" && "value" in Displace ? Displace?.value : Displace} /* default: 0 */  />
