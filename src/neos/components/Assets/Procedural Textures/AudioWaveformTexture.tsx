...
ForegroundColor?: member<[number, number, number, number]>;
    ...
    export function AudioWaveformTexture(props: AudioWaveformTextureInput){
...
ForegroundColor, } = props;
      ...
      return (
        <Component type="FrooxEngine.AudioWaveformTexture" id={id} persistentId={persistentId} updateOrder={updateOrder}>
...
<Member type={`FrooxEngine.Sync\`1[BaseX.color]`} name="ForegroundColor" id={typeof ForegroundColor === "object" && "id" in ForegroundColor ? ForegroundColor?.id : undefined} value={typeof ForegroundColor === "object" && "value" in ForegroundColor ? ForegroundColor?.value : ForegroundColor} /* default: [0; 0; 0; 0] */  isRaw={typeof ForegroundColor === "object" && "isRaw" in ForegroundColor && ForegroundColor.isRaw ? true : undefined} />
        </Component>
      );
    };
