...
<Member type={`FrooxEngine.Sync\`1[BaseX.color]`} name="ForegroundColor" id={typeof ForegroundColor === "object" && "id" in ForegroundColor ? ForegroundColor?.id : undefined} value={typeof ForegroundColor === "object" && "value" in ForegroundColor ? ForegroundColor?.value : ForegroundColor} /* default: [0; 0; 0; 0] */  />
        </Component>
      );
    };
