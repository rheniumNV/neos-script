...
<Member type={`FrooxEngine.Sync\`1[BaseX.float2]`} name="Offset" id={typeof Offset === "object" && "id" in Offset ? Offset?.id : undefined} value={typeof Offset === "object" && "value" in Offset ? Offset?.value : Offset} /* default: [0; 0] */  isRaw={typeof Offset === "object" && "isRaw" in Offset && Offset.isRaw ? true : undefined} />
...
<Member type={`FrooxEngine.Sync\`1[BaseX.color]`} name="Background" id={typeof Background === "object" && "id" in Background ? Background?.id : undefined} value={typeof Background === "object" && "value" in Background ? Background?.value : Background} /* default: [0; 0; 0; 0] */  isRaw={typeof Background === "object" && "isRaw" in Background && Background.isRaw ? true : undefined} />
<Member type={`FrooxEngine.Sync\`1[BaseX.color]`} name="Foreground" id={typeof Foreground === "object" && "id" in Foreground ? Foreground?.id : undefined} value={typeof Foreground === "object" && "value" in Foreground ? Foreground?.value : Foreground} /* default: [0; 0; 0; 0] */  isRaw={typeof Foreground === "object" && "isRaw" in Foreground && Foreground.isRaw ? true : undefined} />
<Member type={`FrooxEngine.Sync\`1[System.Boolean]`} name="Use3D" id={typeof Use3D === "object" && "id" in Use3D ? Use3D?.id : undefined} value={typeof Use3D === "object" && "value" in Use3D ? Use3D?.value : Use3D} /* default: false */  isRaw={typeof Use3D === "object" && "isRaw" in Use3D && Use3D.isRaw ? true : undefined} />
<Member type={`FrooxEngine.Sync\`1[System.Single]`} name="ZOffset" id={typeof ZOffset === "object" && "id" in ZOffset ? ZOffset?.id : undefined} value={typeof ZOffset === "object" && "value" in ZOffset ? ZOffset?.value : ZOffset} /* default: 0 */  isRaw={typeof ZOffset === "object" && "isRaw" in ZOffset && ZOffset.isRaw ? true : undefined} />
        </Component>
      );
    };
