...
<Member type={`FrooxEngine.Sync\`1[BaseX.float4]`} name="Borders" id={typeof Borders === "object" && "id" in Borders ? Borders?.id : undefined} value={typeof Borders === "object" && "value" in Borders ? Borders?.value : Borders} /* default: [0; 0; 0; 0] */  />
