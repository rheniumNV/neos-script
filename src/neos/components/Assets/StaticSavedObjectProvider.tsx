...
<Member type={`FrooxEngine.Sync\`1[System.Boolean]`} name="PreGather" id={typeof PreGather === "object" && "id" in PreGather ? PreGather?.id : undefined} value={typeof PreGather === "object" && "value" in PreGather ? PreGather?.value : PreGather} /* default: false */  isRaw={typeof PreGather === "object" && "isRaw" in PreGather && PreGather.isRaw ? true : undefined} />
        </Component>
      );
    };
