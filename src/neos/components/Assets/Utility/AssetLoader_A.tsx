...
<Member type={`FrooxEngine.AssetRef\`1[A]`} name="Asset" id={typeof Asset === "object" && "id" in Asset ? Asset?.id : undefined} value={typeof Asset === "object" && "value" in Asset ? Asset?.value : Asset} /* default: null */  />
        </Component>
      );
    };
