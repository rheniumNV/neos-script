...
<Member type={`FrooxEngine.RawOutput\`1[System.String]`} name="VariantID" id={typeof VariantID === "object" && "id" in VariantID ? VariantID?.id : undefined} value={typeof VariantID === "object" && "value" in VariantID ? VariantID?.value : VariantID} /* default: FrooxEngine.RawOutput`1[System.String] */  />
<Member type={`FrooxEngine.RawOutput\`1[System.String]`} name="RawVariantID" id={typeof RawVariantID === "object" && "id" in RawVariantID ? RawVariantID?.id : undefined} value={typeof RawVariantID === "object" && "value" in RawVariantID ? RawVariantID?.value : RawVariantID} /* default: FrooxEngine.RawOutput`1[System.String] */  />
<Member type={`FrooxEngine.RawOutput\`1[System.Boolean]`} name="WaitingForApply" id={typeof WaitingForApply === "object" && "id" in WaitingForApply ? WaitingForApply?.id : undefined} value={typeof WaitingForApply === "object" && "value" in WaitingForApply ? WaitingForApply?.value : WaitingForApply} /* default: FrooxEngine.RawOutput`1[System.Boolean] */  />
        </Component>
      );
    };
