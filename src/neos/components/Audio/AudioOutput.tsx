...
<Member type={`FrooxEngine.Sync\`1[System.Single]`} name="DopplerLevel" id={typeof DopplerLevel === "object" && "id" in DopplerLevel ? DopplerLevel?.id : undefined} value={typeof DopplerLevel === "object" && "value" in DopplerLevel ? DopplerLevel?.value : DopplerLevel} /* default: 0 */  isRaw={typeof DopplerLevel === "object" && "isRaw" in DopplerLevel && DopplerLevel.isRaw ? true : undefined} />
<Member type={`FrooxEngine.Sync\`1[FrooxEngine.AudioRolloffMode]`} name="RolloffMode" id={typeof RolloffMode === "object" && "id" in RolloffMode ? RolloffMode?.id : undefined} value={typeof RolloffMode === "object" && "value" in RolloffMode ? RolloffMode?.value : RolloffMode} /* default: Logarithmic */  isRaw={typeof RolloffMode === "object" && "isRaw" in RolloffMode && RolloffMode.isRaw ? true : undefined} />
...
<Member type={`FrooxEngine.Sync\`1[FrooxEngine.AudioTypeGroup]`} name="AudioTypeGroup" id={typeof AudioTypeGroup === "object" && "id" in AudioTypeGroup ? AudioTypeGroup?.id : undefined} value={typeof AudioTypeGroup === "object" && "value" in AudioTypeGroup ? AudioTypeGroup?.value : AudioTypeGroup} /* default: SoundEffect */  isRaw={typeof AudioTypeGroup === "object" && "isRaw" in AudioTypeGroup && AudioTypeGroup.isRaw ? true : undefined} />
<Member type={`FrooxEngine.Sync\`1[FrooxEngine.AudioDistanceSpace]`} name="DistanceSpace" id={typeof DistanceSpace === "object" && "id" in DistanceSpace ? DistanceSpace?.id : undefined} value={typeof DistanceSpace === "object" && "value" in DistanceSpace ? DistanceSpace?.value : DistanceSpace} /* default: Local */  isRaw={typeof DistanceSpace === "object" && "isRaw" in DistanceSpace && DistanceSpace.isRaw ? true : undefined} />
...
<Member type={`FrooxEngine.Sync\`1[System.Boolean]`} name="IgnoreReverbZones" id={typeof IgnoreReverbZones === "object" && "id" in IgnoreReverbZones ? IgnoreReverbZones?.id : undefined} value={typeof IgnoreReverbZones === "object" && "value" in IgnoreReverbZones ? IgnoreReverbZones?.value : IgnoreReverbZones} /* default: false */  isRaw={typeof IgnoreReverbZones === "object" && "isRaw" in IgnoreReverbZones && IgnoreReverbZones.isRaw ? true : undefined} />
<Member type={`FrooxEngine.SyncRefList\`1[FrooxEngine.User]`} name="excludedUsers" id={typeof excludedUsers === "object" && "id" in excludedUsers ? excludedUsers?.id : undefined} value={typeof excludedUsers === "object" && "value" in excludedUsers ? excludedUsers?.value : excludedUsers} /* default: FrooxEngine.SyncRefList`1[FrooxEngine.User] */  isRaw={typeof excludedUsers === "object" && "isRaw" in excludedUsers && excludedUsers.isRaw ? true : undefined} />
        </Component>
      );
    };
