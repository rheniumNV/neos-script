...
<Member type={`FrooxEngine.RawOutput\`1[CloudX.Shared.ServerStatus]`} name="Status" id={typeof Status === "object" && "id" in Status ? Status?.id : undefined} value={typeof Status === "object" && "value" in Status ? Status?.value : Status} /* default: FrooxEngine.RawOutput`1[CloudX.Shared.ServerStatus] */  />
<Member type={`FrooxEngine.RawOutput\`1[System.Int32]`} name="ResponseTimeMilliseconds" id={typeof ResponseTimeMilliseconds === "object" && "id" in ResponseTimeMilliseconds ? ResponseTimeMilliseconds?.id : undefined} value={typeof ResponseTimeMilliseconds === "object" && "value" in ResponseTimeMilliseconds ? ResponseTimeMilliseconds?.value : ResponseTimeMilliseconds} /* default: FrooxEngine.RawOutput`1[System.Int32] */  />
<Member type={`FrooxEngine.RawOutput\`1[System.DateTime]`} name="LastServerUpdateTime" id={typeof LastServerUpdateTime === "object" && "id" in LastServerUpdateTime ? LastServerUpdateTime?.id : undefined} value={typeof LastServerUpdateTime === "object" && "value" in LastServerUpdateTime ? LastServerUpdateTime?.value : LastServerUpdateTime} /* default: FrooxEngine.RawOutput`1[System.DateTime] */  />
<Member type={`FrooxEngine.RawOutput\`1[System.DateTime]`} name="LastServerStateFetch" id={typeof LastServerStateFetch === "object" && "id" in LastServerStateFetch ? LastServerStateFetch?.id : undefined} value={typeof LastServerStateFetch === "object" && "value" in LastServerStateFetch ? LastServerStateFetch?.value : LastServerStateFetch} /* default: FrooxEngine.RawOutput`1[System.DateTime] */  />
<Member type={`FrooxEngine.RawOutput\`1[System.DateTime]`} name="LastLocalServerResponseTime" id={typeof LastLocalServerResponseTime === "object" && "id" in LastLocalServerResponseTime ? LastLocalServerResponseTime?.id : undefined} value={typeof LastLocalServerResponseTime === "object" && "value" in LastLocalServerResponseTime ? LastLocalServerResponseTime?.value : LastLocalServerResponseTime} /* default: FrooxEngine.RawOutput`1[System.DateTime] */  />
        </Component>
      );
    };
