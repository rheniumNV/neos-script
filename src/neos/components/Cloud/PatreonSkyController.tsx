...
<Member type={`FrooxEngine.Sync\`1[System.Single]`} name="NameSize" id={typeof NameSize === "object" && "id" in NameSize ? NameSize?.id : undefined} value={typeof NameSize === "object" && "value" in NameSize ? NameSize?.value : NameSize} /* default: 0 */  isRaw={typeof NameSize === "object" && "isRaw" in NameSize && NameSize.isRaw ? true : undefined} />
<Member type={`FrooxEngine.Sync\`1[System.Single]`} name="PictureSize" id={typeof PictureSize === "object" && "id" in PictureSize ? PictureSize?.id : undefined} value={typeof PictureSize === "object" && "value" in PictureSize ? PictureSize?.value : PictureSize} /* default: 0 */  isRaw={typeof PictureSize === "object" && "isRaw" in PictureSize && PictureSize.isRaw ? true : undefined} />
...
<Member type={`FrooxEngine.Sync\`1[BaseX.color]`} name="NameColor" id={typeof NameColor === "object" && "id" in NameColor ? NameColor?.id : undefined} value={typeof NameColor === "object" && "value" in NameColor ? NameColor?.value : NameColor} /* default: [0; 0; 0; 0] */  isRaw={typeof NameColor === "object" && "isRaw" in NameColor && NameColor.isRaw ? true : undefined} />
        </Component>
      );
    };
