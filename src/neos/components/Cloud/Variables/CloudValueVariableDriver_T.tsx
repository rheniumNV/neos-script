...
<Member type={`FrooxEngine.RawOutput\`1[System.Boolean]`} name="IsLinkedToCloud" id={typeof IsLinkedToCloud === "object" && "id" in IsLinkedToCloud ? IsLinkedToCloud?.id : undefined} value={typeof IsLinkedToCloud === "object" && "value" in IsLinkedToCloud ? IsLinkedToCloud?.value : IsLinkedToCloud} /* default: null */  />
...
<Member type={`FrooxEngine.Sync\`1[System.String]`} name="OverrideOwner" id={typeof OverrideOwner === "object" && "id" in OverrideOwner ? OverrideOwner?.id : undefined} value={typeof OverrideOwner === "object" && "value" in OverrideOwner ? OverrideOwner?.value : OverrideOwner} /* default: null */  />
        </Component>
      );
    };
