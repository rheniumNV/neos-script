...
<Member type={`FrooxEngine.Sync\`1[System.Int32]`} name="Count" id={typeof Count === "object" && "id" in Count ? Count?.id : undefined} value={typeof Count === "object" && "value" in Count ? Count?.value : Count} /* default: 0 */  />
<Member type={`FrooxEngine.Sync\`1[System.Boolean]`} name="EraseFromBeginning" id={typeof EraseFromBeginning === "object" && "id" in EraseFromBeginning ? EraseFromBeginning?.id : undefined} value={typeof EraseFromBeginning === "object" && "value" in EraseFromBeginning ? EraseFromBeginning?.value : EraseFromBeginning} /* default: false */  />
        </Component>
      );
    };
