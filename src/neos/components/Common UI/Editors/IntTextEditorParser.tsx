...
<Member type={`FrooxEngine.Sync\`1[System.Int32]`} name="ParsedValue" id={typeof ParsedValue === "object" && "id" in ParsedValue ? ParsedValue?.id : undefined} value={typeof ParsedValue === "object" && "value" in ParsedValue ? ParsedValue?.value : ParsedValue} /* default: 0 */  />
<Member type={`FrooxEngine.Sync\`1[System.Int32]`} name="Min" id={typeof Min === "object" && "id" in Min ? Min?.id : undefined} value={typeof Min === "object" && "value" in Min ? Min?.value : Min} /* default: 0 */  />
<Member type={`FrooxEngine.Sync\`1[System.Int32]`} name="Max" id={typeof Max === "object" && "id" in Max ? Max?.id : undefined} value={typeof Max === "object" && "value" in Max ? Max?.value : Max} /* default: 0 */  />
<Member type={`FrooxEngine.Sync\`1[System.Int32]`} name="Increments" id={typeof Increments === "object" && "id" in Increments ? Increments?.id : undefined} value={typeof Increments === "object" && "value" in Increments ? Increments?.value : Increments} /* default: 0 */  />
