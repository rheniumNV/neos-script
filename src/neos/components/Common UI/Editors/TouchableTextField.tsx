...
<Member type={`FrooxEngine.SyncRef\`1[FrooxEngine.TextEditor]`} name="TextEditor" id={typeof TextEditor === "object" && "id" in TextEditor ? TextEditor?.id : undefined} value={typeof TextEditor === "object" && "value" in TextEditor ? TextEditor?.value : TextEditor} /* default: ID0 */  />
