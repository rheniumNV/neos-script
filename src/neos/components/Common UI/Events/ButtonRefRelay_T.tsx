...
<Member type={`FrooxEngine.SyncRef\`1[${T}]`} name="Argument" id={typeof Argument === "object" && "id" in Argument ? Argument?.id : undefined} value={typeof Argument === "object" && "value" in Argument ? Argument?.value : Argument} /* default: null */  isRaw={typeof Argument === "object" && "isRaw" in Argument && Argument.isRaw ? true : undefined} />
