...
<Member type={`FrooxEngine.Sync\`1[${T}]`} name="Argument" id={typeof Argument === "object" && "id" in Argument ? Argument?.id : undefined} value={typeof Argument === "object" && "value" in Argument ? Argument?.value : Argument} /* default: null */  />
