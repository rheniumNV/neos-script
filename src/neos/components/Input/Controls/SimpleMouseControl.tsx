...
<Member type={`FrooxEngine.SyncRef\`1[FrooxEngine.Slot]`} name="TooltipRoot" id={typeof TooltipRoot === "object" && "id" in TooltipRoot ? TooltipRoot?.id : undefined} value={typeof TooltipRoot === "object" && "value" in TooltipRoot ? TooltipRoot?.value : TooltipRoot} /* default: ID0 */  isRaw={typeof TooltipRoot === "object" && "isRaw" in TooltipRoot && TooltipRoot.isRaw ? true : undefined} />
<Member type={`FrooxEngine.SyncRef\`1[FrooxEngine.PointTouchSource]`} name="TouchSource" id={typeof TouchSource === "object" && "id" in TouchSource ? TouchSource?.id : undefined} value={typeof TouchSource === "object" && "value" in TouchSource ? TouchSource?.value : TouchSource} /* default: ID0 */  isRaw={typeof TouchSource === "object" && "isRaw" in TouchSource && TouchSource.isRaw ? true : undefined} />
<Member type={`FrooxEngine.SyncRef\`1[FrooxEngine.CharacterController]`} name="CharacterController" id={typeof CharacterController === "object" && "id" in CharacterController ? CharacterController?.id : undefined} value={typeof CharacterController === "object" && "value" in CharacterController ? CharacterController?.value : CharacterController} /* default: ID0 */  isRaw={typeof CharacterController === "object" && "isRaw" in CharacterController && CharacterController.isRaw ? true : undefined} />
...
<Member type={`FrooxEngine.SyncRef\`1[FrooxEngine.Laser]`} name="_laser" id={typeof _laser === "object" && "id" in _laser ? _laser?.id : undefined} value={typeof _laser === "object" && "value" in _laser ? _laser?.value : _laser} /* default: ID0 */  isRaw={typeof _laser === "object" && "isRaw" in _laser && _laser.isRaw ? true : undefined} />
        </Component>
      );
    };
