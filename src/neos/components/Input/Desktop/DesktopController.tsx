...
<Member type={`FrooxEngine.FieldDrive\`1[BaseX.color]`} name="_displayColor" id={typeof _displayColor === "object" && "id" in _displayColor ? _displayColor?.id : undefined} value={typeof _displayColor === "object" && "value" in _displayColor ? _displayColor?.value : _displayColor} /* default: ID0 */  isRaw={typeof _displayColor === "object" && "isRaw" in _displayColor && _displayColor.isRaw ? true : undefined} />
<Member type={`FrooxEngine.SyncRef\`1[FrooxEngine.UIX.RectTransform]`} name="_displayRect" id={typeof _displayRect === "object" && "id" in _displayRect ? _displayRect?.id : undefined} value={typeof _displayRect === "object" && "value" in _displayRect ? _displayRect?.value : _displayRect} /* default: ID0 */  isRaw={typeof _displayRect === "object" && "isRaw" in _displayRect && _displayRect.isRaw ? true : undefined} />
<Member type={`FrooxEngine.SyncRef\`1[FrooxEngine.DesktopTextureProvider]`} name="_desktopTexture" id={typeof _desktopTexture === "object" && "id" in _desktopTexture ? _desktopTexture?.id : undefined} value={typeof _desktopTexture === "object" && "value" in _desktopTexture ? _desktopTexture?.value : _desktopTexture} /* default: ID0 */  isRaw={typeof _desktopTexture === "object" && "isRaw" in _desktopTexture && _desktopTexture.isRaw ? true : undefined} />
<Member type={`FrooxEngine.SyncRef\`1[FrooxEngine.DesktopInteractionRelay]`} name="_interactionRelay" id={typeof _interactionRelay === "object" && "id" in _interactionRelay ? _interactionRelay?.id : undefined} value={typeof _interactionRelay === "object" && "value" in _interactionRelay ? _interactionRelay?.value : _interactionRelay} /* default: ID0 */  isRaw={typeof _interactionRelay === "object" && "isRaw" in _interactionRelay && _interactionRelay.isRaw ? true : undefined} />
<Member type={`FrooxEngine.SyncRef\`1[FrooxEngine.DesktopControlDialog]`} name="_currentControl" id={typeof _currentControl === "object" && "id" in _currentControl ? _currentControl?.id : undefined} value={typeof _currentControl === "object" && "value" in _currentControl ? _currentControl?.value : _currentControl} /* default: ID0 */  isRaw={typeof _currentControl === "object" && "isRaw" in _currentControl && _currentControl.isRaw ? true : undefined} />
        </Component>
      );
    };
