...
<Member type={`FrooxEngine.Sync\`1[System.Boolean]`} name="UseLegacyTextInput" id={typeof UseLegacyTextInput === "object" && "id" in UseLegacyTextInput ? UseLegacyTextInput?.id : undefined} value={typeof UseLegacyTextInput === "object" && "value" in UseLegacyTextInput ? UseLegacyTextInput?.value : UseLegacyTextInput} /* default: false */  isRaw={typeof UseLegacyTextInput === "object" && "isRaw" in UseLegacyTextInput && UseLegacyTextInput.isRaw ? true : undefined} />
        </Component>
      );
    };
