...
<Member type={`FrooxEngine.Sync\`1[System.Nullable\`1[System.Single]]`} name="DistanceScale" id={typeof DistanceScale === "object" && "id" in DistanceScale ? DistanceScale?.id : undefined} value={typeof DistanceScale === "object" && "value" in DistanceScale ? DistanceScale?.value : DistanceScale} /* default: <i>null</i> */  isRaw={typeof DistanceScale === "object" && "isRaw" in DistanceScale && DistanceScale.isRaw ? true : undefined} />
<Member type={`FrooxEngine.Sync\`1[System.Nullable\`1[BaseX.float3]]`} name="AxisScale" id={typeof AxisScale === "object" && "id" in AxisScale ? AxisScale?.id : undefined} value={typeof AxisScale === "object" && "value" in AxisScale ? AxisScale?.value : AxisScale} /* default: <i>null</i> */  isRaw={typeof AxisScale === "object" && "isRaw" in AxisScale && AxisScale.isRaw ? true : undefined} />
<Member type={`FrooxEngine.Sync\`1[System.Single]`} name="MinIntensity" id={typeof MinIntensity === "object" && "id" in MinIntensity ? MinIntensity?.id : undefined} value={typeof MinIntensity === "object" && "value" in MinIntensity ? MinIntensity?.value : MinIntensity} /* default: 0 */  isRaw={typeof MinIntensity === "object" && "isRaw" in MinIntensity && MinIntensity.isRaw ? true : undefined} />
<Member type={`FrooxEngine.Sync\`1[System.Single]`} name="MaxIntensity" id={typeof MaxIntensity === "object" && "id" in MaxIntensity ? MaxIntensity?.id : undefined} value={typeof MaxIntensity === "object" && "value" in MaxIntensity ? MaxIntensity?.value : MaxIntensity} /* default: 0 */  isRaw={typeof MaxIntensity === "object" && "isRaw" in MaxIntensity && MaxIntensity.isRaw ? true : undefined} />
