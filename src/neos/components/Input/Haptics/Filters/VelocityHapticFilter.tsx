...
<Member type={`FrooxEngine.Sync\`1[System.Single]`} name="VelocitySmoothTime" id={typeof VelocitySmoothTime === "object" && "id" in VelocitySmoothTime ? VelocitySmoothTime?.id : undefined} value={typeof VelocitySmoothTime === "object" && "value" in VelocitySmoothTime ? VelocitySmoothTime?.value : VelocitySmoothTime} /* default: 0 */  />
<Member type={`FrooxEngine.Sync\`1[System.Single]`} name="StartVelocity" id={typeof StartVelocity === "object" && "id" in StartVelocity ? StartVelocity?.id : undefined} value={typeof StartVelocity === "object" && "value" in StartVelocity ? StartVelocity?.value : StartVelocity} /* default: 0 */  />
<Member type={`FrooxEngine.Sync\`1[System.Single]`} name="EndVelocity" id={typeof EndVelocity === "object" && "id" in EndVelocity ? EndVelocity?.id : undefined} value={typeof EndVelocity === "object" && "value" in EndVelocity ? EndVelocity?.value : EndVelocity} /* default: 0 */  />
