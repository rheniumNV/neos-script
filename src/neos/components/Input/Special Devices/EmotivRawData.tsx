...
<Member type={`FrooxEngine.Sync\`1[System.Boolean]`} name="HeadsetConnected" id={typeof HeadsetConnected === "object" && "id" in HeadsetConnected ? HeadsetConnected?.id : undefined} value={typeof HeadsetConnected === "object" && "value" in HeadsetConnected ? HeadsetConnected?.value : HeadsetConnected} /* default: false */  />
<Member type={`FrooxEngine.Sync\`1[System.Boolean]`} name="ProfileLoaded" id={typeof ProfileLoaded === "object" && "id" in ProfileLoaded ? ProfileLoaded?.id : undefined} value={typeof ProfileLoaded === "object" && "value" in ProfileLoaded ? ProfileLoaded?.value : ProfileLoaded} /* default: false */  />
<Member type={`FrooxEngine.Sync\`1[System.String]`} name="CurrentProfile" id={typeof CurrentProfile === "object" && "id" in CurrentProfile ? CurrentProfile?.id : undefined} value={typeof CurrentProfile === "object" && "value" in CurrentProfile ? CurrentProfile?.value : CurrentProfile} /* default: <i>null</i> */  />
<Member type={`FrooxEngine.Sync\`1[System.String]`} name="HeadsetId" id={typeof HeadsetId === "object" && "id" in HeadsetId ? HeadsetId?.id : undefined} value={typeof HeadsetId === "object" && "value" in HeadsetId ? HeadsetId?.value : HeadsetId} /* default: <i>null</i> */  />
