...
<Member type={`FrooxEngine.SyncRef\`1[FrooxEngine.CrossMesh]`} name="_crossMesh" id={typeof _crossMesh === "object" && "id" in _crossMesh ? _crossMesh?.id : undefined} value={typeof _crossMesh === "object" && "value" in _crossMesh ? _crossMesh?.value : _crossMesh} /* default: ID0 */  />
