...
Locale?: member<any>;
    ...
    export function LocaleMessageCount(props: LocaleMessageCountInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
Locale, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Assets.LocaleMessageCount" id={id} persistentId={persistentId} updateOrder={updateOrder}>
