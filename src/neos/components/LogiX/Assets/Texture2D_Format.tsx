...
Texture?: member<any>;
    ...
    export function Texture2D_Format(props: Texture2D_FormatInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
Texture, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Assets.Texture2D_Format" id={id} persistentId={persistentId} updateOrder={updateOrder}>
