import { member, Member, Component } from "../../../../core";
    ...
    export interface GetUserAnchorInput {
...
User?: member<any>;
    ...
    export function GetUserAnchor(props: GetUserAnchorInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
User, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Avatar.GetUserAnchor" id={id} persistentId={persistentId} updateOrder={updateOrder}>
