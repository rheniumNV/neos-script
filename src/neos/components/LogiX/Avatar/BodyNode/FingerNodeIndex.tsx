import { member, Member, Component } from "../../../../core";
    ...
    export interface FingerNodeIndexInput {
...
Node?: member<any>;
    ...
    export function FingerNodeIndex(props: FingerNodeIndexInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
Node, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Utility.FingerNodeIndex" id={id} persistentId={persistentId} updateOrder={updateOrder}>
