import { member, Member, Component } from "../../../../core";
    ...
    export interface GetFingerTypeInput {
...
Node?: member<any>;
    ...
    export function GetFingerType(props: GetFingerTypeInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
Node, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Utility.GetFingerType" id={id} persistentId={persistentId} updateOrder={updateOrder}>
