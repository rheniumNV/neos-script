import { member, Member, Component } from "../../../../core";
    ...
    export interface RelativeBodyNodeInput {
...
Node?: member<any>;
    ...
    export function RelativeBodyNode(props: RelativeBodyNodeInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
Node, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Utility.RelativeBodyNode" id={id} persistentId={persistentId} updateOrder={updateOrder}>
