...
<Member type={`FrooxEngine.LogiX.Input\`1[FrooxEngine.Slot]`} name="AvatarRoot" id={typeof AvatarRoot === "object" && "id" in AvatarRoot ? AvatarRoot?.id : undefined} value={typeof AvatarRoot === "object" && "value" in AvatarRoot ? AvatarRoot?.value : AvatarRoot} /* default: ID0 */  />
<Member type={`FrooxEngine.LogiX.Input\`1[System.Boolean]`} name="DestroyOld" id={typeof DestroyOld === "object" && "id" in DestroyOld ? DestroyOld?.id : undefined} value={typeof DestroyOld === "object" && "value" in DestroyOld ? DestroyOld?.value : DestroyOld} /* default: ID0 */  />
