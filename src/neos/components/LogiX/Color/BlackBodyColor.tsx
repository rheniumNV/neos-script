...
<Member type={`FrooxEngine.LogiX.Input\`1[System.Single]`} name="Temperature" id={typeof Temperature === "object" && "id" in Temperature ? Temperature?.id : undefined} value={typeof Temperature === "object" && "value" in Temperature ? Temperature?.value : Temperature} /* default: ID0 */  isRaw={typeof Temperature === "object" && "isRaw" in Temperature && Temperature.isRaw ? true : undefined} />
        </Component>
      );
    };
