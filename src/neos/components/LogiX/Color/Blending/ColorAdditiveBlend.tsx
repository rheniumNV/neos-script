import { member, Member, Component } from "../../../../core";
    ...
    export interface ColorAdditiveBlendInput {
...
Destination?: member<any>;
    ...
    export function ColorAdditiveBlend(props: ColorAdditiveBlendInput){
...
Destination, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.Color.ColorAdditiveBlend" id={id} persistentId={persistentId} updateOrder={updateOrder}>
