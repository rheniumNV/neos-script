import { member, Member, Component } from "../../../../core";
    ...
    export interface ColorAlphaBlendInput {
...
Destination?: member<any>;
    ...
    export function ColorAlphaBlend(props: ColorAlphaBlendInput){
...
Destination, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.Color.ColorAlphaBlend" id={id} persistentId={persistentId} updateOrder={updateOrder}>
