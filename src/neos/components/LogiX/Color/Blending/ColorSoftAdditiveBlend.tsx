import { member, Member, Component } from "../../../../core";
    ...
    export interface ColorSoftAdditiveBlendInput {
...
Destination?: member<any>;
    ...
    export function ColorSoftAdditiveBlend(props: ColorSoftAdditiveBlendInput){
...
Destination, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.Color.ColorSoftAdditiveBlend" id={id} persistentId={persistentId} updateOrder={updateOrder}>
