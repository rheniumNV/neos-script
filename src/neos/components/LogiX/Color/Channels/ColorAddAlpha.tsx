import { member, Member, Component } from "../../../../core";
    ...
    export interface ColorAddAlphaInput {
...
Value?: member<any>;
    ...
    export function ColorAddAlpha(props: ColorAddAlphaInput){
...
Value, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.Color.ColorAddAlpha" id={id} persistentId={persistentId} updateOrder={updateOrder}>
