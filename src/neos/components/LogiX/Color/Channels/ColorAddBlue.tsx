import { member, Member, Component } from "../../../../core";
    ...
    export interface ColorAddBlueInput {
...
Value?: member<any>;
    ...
    export function ColorAddBlue(props: ColorAddBlueInput){
...
Value, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.Color.ColorAddBlue" id={id} persistentId={persistentId} updateOrder={updateOrder}>
