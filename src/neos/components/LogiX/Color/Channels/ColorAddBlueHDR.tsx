import { member, Member, Component } from "../../../../core";
    ...
    export interface ColorAddBlueHDRInput {
...
Value?: member<any>;
    ...
    export function ColorAddBlueHDR(props: ColorAddBlueHDRInput){
...
Value, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.Color.ColorAddBlueHDR" id={id} persistentId={persistentId} updateOrder={updateOrder}>
