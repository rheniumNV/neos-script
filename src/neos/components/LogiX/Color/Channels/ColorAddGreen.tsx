import { member, Member, Component } from "../../../../core";
    ...
    export interface ColorAddGreenInput {
...
Value?: member<any>;
    ...
    export function ColorAddGreen(props: ColorAddGreenInput){
...
Value, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.Color.ColorAddGreen" id={id} persistentId={persistentId} updateOrder={updateOrder}>
