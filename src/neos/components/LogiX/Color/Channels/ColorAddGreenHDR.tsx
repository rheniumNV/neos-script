import { member, Member, Component } from "../../../../core";
    ...
    export interface ColorAddGreenHDRInput {
...
Value?: member<any>;
    ...
    export function ColorAddGreenHDR(props: ColorAddGreenHDRInput){
...
Value, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.Color.ColorAddGreenHDR" id={id} persistentId={persistentId} updateOrder={updateOrder}>
