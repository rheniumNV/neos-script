import { member, Member, Component } from "../../../../core";
    ...
    export interface ColorAddHueInput {
...
Value?: member<any>;
    ...
    export function ColorAddHue(props: ColorAddHueInput){
...
Value, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.Color.ColorAddHue" id={id} persistentId={persistentId} updateOrder={updateOrder}>
