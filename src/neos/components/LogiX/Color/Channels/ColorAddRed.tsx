import { member, Member, Component } from "../../../../core";
    ...
    export interface ColorAddRedInput {
...
Value?: member<any>;
    ...
    export function ColorAddRed(props: ColorAddRedInput){
...
Value, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.Color.ColorAddRed" id={id} persistentId={persistentId} updateOrder={updateOrder}>
