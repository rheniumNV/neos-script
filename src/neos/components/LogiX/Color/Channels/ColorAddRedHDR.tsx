import { member, Member, Component } from "../../../../core";
    ...
    export interface ColorAddRedHDRInput {
...
Value?: member<any>;
    ...
    export function ColorAddRedHDR(props: ColorAddRedHDRInput){
...
Value, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.Color.ColorAddRedHDR" id={id} persistentId={persistentId} updateOrder={updateOrder}>
