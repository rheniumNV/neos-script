import { member, Member, Component } from "../../../../core";
    ...
    export interface ColorAddSaturationInput {
...
Value?: member<any>;
    ...
    export function ColorAddSaturation(props: ColorAddSaturationInput){
...
Value, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.Color.ColorAddSaturation" id={id} persistentId={persistentId} updateOrder={updateOrder}>
