import { member, Member, Component } from "../../../../core";
    ...
    export interface ColorAddValueInput {
...
Value?: member<any>;
    ...
    export function ColorAddValue(props: ColorAddValueInput){
...
Value, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.Color.ColorAddValue" id={id} persistentId={persistentId} updateOrder={updateOrder}>
