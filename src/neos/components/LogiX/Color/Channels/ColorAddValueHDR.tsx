import { member, Member, Component } from "../../../../core";
    ...
    export interface ColorAddValueHDRInput {
...
Value?: member<any>;
    ...
    export function ColorAddValueHDR(props: ColorAddValueHDRInput){
...
Value, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.Color.ColorAddValueHDR" id={id} persistentId={persistentId} updateOrder={updateOrder}>
