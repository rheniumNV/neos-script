import { member, Member, Component } from "../../../../core";
    ...
    export interface ColorMulAlphaInput {
...
Value?: member<any>;
    ...
    export function ColorMulAlpha(props: ColorMulAlphaInput){
...
Value, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.Color.ColorMulAlpha" id={id} persistentId={persistentId} updateOrder={updateOrder}>
