import { member, Member, Component } from "../../../../core";
    ...
    export interface ColorMulBlueInput {
...
Value?: member<any>;
    ...
    export function ColorMulBlue(props: ColorMulBlueInput){
...
Value, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.Color.ColorMulBlue" id={id} persistentId={persistentId} updateOrder={updateOrder}>
