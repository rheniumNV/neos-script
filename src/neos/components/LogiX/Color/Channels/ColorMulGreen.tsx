import { member, Member, Component } from "../../../../core";
    ...
    export interface ColorMulGreenInput {
...
Value?: member<any>;
    ...
    export function ColorMulGreen(props: ColorMulGreenInput){
...
Value, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.Color.ColorMulGreen" id={id} persistentId={persistentId} updateOrder={updateOrder}>
