import { member, Member, Component } from "../../../../core";
    ...
    export interface ColorMulRGBInput {
...
Value?: member<any>;
    ...
    export function ColorMulRGB(props: ColorMulRGBInput){
...
Value, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.Color.ColorMulRGB" id={id} persistentId={persistentId} updateOrder={updateOrder}>
