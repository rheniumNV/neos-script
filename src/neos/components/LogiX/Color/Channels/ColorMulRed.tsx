import { member, Member, Component } from "../../../../core";
    ...
    export interface ColorMulRedInput {
...
Value?: member<any>;
    ...
    export function ColorMulRed(props: ColorMulRedInput){
...
Value, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.Color.ColorMulRed" id={id} persistentId={persistentId} updateOrder={updateOrder}>
