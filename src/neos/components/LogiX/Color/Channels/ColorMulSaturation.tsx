import { member, Member, Component } from "../../../../core";
    ...
    export interface ColorMulSaturationInput {
...
Value?: member<any>;
    ...
    export function ColorMulSaturation(props: ColorMulSaturationInput){
...
Value, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.Color.ColorMulSaturation" id={id} persistentId={persistentId} updateOrder={updateOrder}>
