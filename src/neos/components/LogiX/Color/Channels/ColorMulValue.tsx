import { member, Member, Component } from "../../../../core";
    ...
    export interface ColorMulValueInput {
...
Value?: member<any>;
    ...
    export function ColorMulValue(props: ColorMulValueInput){
...
Value, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.Color.ColorMulValue" id={id} persistentId={persistentId} updateOrder={updateOrder}>
