import { member, Member, Component } from "../../../../core";
    ...
    export interface ColorSetAlphaInput {
...
Value?: member<any>;
    ...
    export function ColorSetAlpha(props: ColorSetAlphaInput){
...
Value, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.Color.ColorSetAlpha" id={id} persistentId={persistentId} updateOrder={updateOrder}>
