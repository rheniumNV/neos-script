import { member, Member, Component } from "../../../../core";
    ...
    export interface ColorSetBlueInput {
...
Value?: member<any>;
    ...
    export function ColorSetBlue(props: ColorSetBlueInput){
...
Value, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.Color.ColorSetBlue" id={id} persistentId={persistentId} updateOrder={updateOrder}>
