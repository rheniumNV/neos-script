import { member, Member, Component } from "../../../../core";
    ...
    export interface ColorSetGreenInput {
...
Value?: member<any>;
    ...
    export function ColorSetGreen(props: ColorSetGreenInput){
...
Value, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.Color.ColorSetGreen" id={id} persistentId={persistentId} updateOrder={updateOrder}>
