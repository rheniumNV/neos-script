import { member, Member, Component } from "../../../../core";
    ...
    export interface ColorSetHueInput {
...
Value?: member<any>;
    ...
    export function ColorSetHue(props: ColorSetHueInput){
...
Value, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.Color.ColorSetHue" id={id} persistentId={persistentId} updateOrder={updateOrder}>
