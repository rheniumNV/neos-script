import { member, Member, Component } from "../../../../core";
    ...
    export interface ColorSetRedInput {
...
Value?: member<any>;
    ...
    export function ColorSetRed(props: ColorSetRedInput){
...
Value, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.Color.ColorSetRed" id={id} persistentId={persistentId} updateOrder={updateOrder}>
