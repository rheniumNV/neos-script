import { member, Member, Component } from "../../../../core";
    ...
    export interface ColorSetSaturationInput {
...
Value?: member<any>;
    ...
    export function ColorSetSaturation(props: ColorSetSaturationInput){
...
Value, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.Color.ColorSetSaturation" id={id} persistentId={persistentId} updateOrder={updateOrder}>
