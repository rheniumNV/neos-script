import { member, Member, Component } from "../../../../core";
    ...
    export interface ColorSetValueInput {
...
Value?: member<any>;
    ...
    export function ColorSetValue(props: ColorSetValueInput){
...
Value, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.Color.ColorSetValue" id={id} persistentId={persistentId} updateOrder={updateOrder}>
