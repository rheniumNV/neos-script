import { member, Member, Component } from "../../../core";
    ...
    export interface ColorLuminanceInput {
...
Color?: member<any>;
    ...
    export function ColorLuminance(props: ColorLuminanceInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
Color, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Color.ColorLuminance" id={id} persistentId={persistentId} updateOrder={updateOrder}>
