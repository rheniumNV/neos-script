...
<Member type={`FrooxEngine.LogiX.Input\`1[System.Single]`} name="Length" id={typeof Length === "object" && "id" in Length ? Length?.id : undefined} value={typeof Length === "object" && "value" in Length ? Length?.value : Length} /* default: ID0 */  />
<Member type={`FrooxEngine.LogiX.Input\`1[BaseX.color]`} name="RightColor" id={typeof RightColor === "object" && "id" in RightColor ? RightColor?.id : undefined} value={typeof RightColor === "object" && "value" in RightColor ? RightColor?.value : RightColor} /* default: ID0 */  />
<Member type={`FrooxEngine.LogiX.Input\`1[BaseX.color]`} name="UpColor" id={typeof UpColor === "object" && "id" in UpColor ? UpColor?.id : undefined} value={typeof UpColor === "object" && "value" in UpColor ? UpColor?.value : UpColor} /* default: ID0 */  />
<Member type={`FrooxEngine.LogiX.Input\`1[BaseX.color]`} name="ForwardColor" id={typeof ForwardColor === "object" && "id" in ForwardColor ? ForwardColor?.id : undefined} value={typeof ForwardColor === "object" && "value" in ForwardColor ? ForwardColor?.value : ForwardColor} /* default: ID0 */  />
