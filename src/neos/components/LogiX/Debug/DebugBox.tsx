...
<Member type={`FrooxEngine.LogiX.Input\`1[BaseX.floatQ]`} name="Orientation" id={typeof Orientation === "object" && "id" in Orientation ? Orientation?.id : undefined} value={typeof Orientation === "object" && "value" in Orientation ? Orientation?.value : Orientation} /* default: ID0 */  isRaw={typeof Orientation === "object" && "isRaw" in Orientation && Orientation.isRaw ? true : undefined} />
