...
<Member type={`FrooxEngine.LogiX.Input\`1[BaseX.float3]`} name="Point2" id={typeof Point2 === "object" && "id" in Point2 ? Point2?.id : undefined} value={typeof Point2 === "object" && "value" in Point2 ? Point2?.value : Point2} /* default: ID0 */  />
