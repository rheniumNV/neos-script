import { member, Member, Component } from "../../../core";
    ...
    export interface DebugTriangleInput {
...
OnDisplay?: member<any>;
    ...
    export function DebugTriangle(props: DebugTriangleInput){
...
OnDisplay, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.Debug.DebugTriangle" id={id} persistentId={persistentId} updateOrder={updateOrder}>
...
<Member type={`FrooxEngine.LogiX.Input\`1[BaseX.float3]`} name="Point2" id={typeof Point2 === "object" && "id" in Point2 ? Point2?.id : undefined} value={typeof Point2 === "object" && "value" in Point2 ? Point2?.value : Point2} /* default: ID0 */  isRaw={typeof Point2 === "object" && "isRaw" in Point2 && Point2.isRaw ? true : undefined} />
