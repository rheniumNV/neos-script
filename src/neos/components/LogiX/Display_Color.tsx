import { member, Member, Component } from "../../core";
    ...
    export interface Display_ColorInput {
...
_color?: member<any>;
    ...
    export function Display_Color(props: Display_ColorInput){
...
_color, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.Display.Display_Color" id={id} persistentId={persistentId} updateOrder={updateOrder}>
...
<Member type={`FrooxEngine.FieldDrive\`1[BaseX.color]`} name="_color" id={typeof _color === "object" && "id" in _color ? _color?.id : undefined} value={typeof _color === "object" && "value" in _color ? _color?.value : _color} /* default: ID0 */  isRaw={typeof _color === "object" && "isRaw" in _color && _color.isRaw ? true : undefined} />
        </Component>
      );
    };
