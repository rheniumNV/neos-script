...
<Member type={`FrooxEngine.FieldDrive\`1[BaseX.color]`} name="_color" id={typeof _color === "object" && "id" in _color ? _color?.id : undefined} value={typeof _color === "object" && "value" in _color ? _color?.value : _color} /* default: ID0 */  />
        </Component>
      );
    };
