...
<Member type={`FrooxEngine.LogiX.Input\`1[BaseX.colorX]`} name="Source" id={typeof Source === "object" && "id" in Source ? Source?.id : undefined} value={typeof Source === "object" && "value" in Source ? Source?.value : Source} /* default: ID0 */  />
...
<Member type={`FrooxEngine.FieldDrive\`1[BaseX.colorX]`} name="_color" id={typeof _color === "object" && "id" in _color ? _color?.id : undefined} value={typeof _color === "object" && "value" in _color ? _color?.value : _color} /* default: ID0 */  />
        </Component>
      );
    };
