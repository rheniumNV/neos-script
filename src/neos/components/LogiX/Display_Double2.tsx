import { member, Member, Component } from "../../core";
    ...
    export interface Display_Double2Input {
...
_text1?: member<string>;
    ...
    export function Display_Double2(props: Display_Double2Input){
...
_text1, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.Display.Display_Double2" id={id} persistentId={persistentId} updateOrder={updateOrder}>
...
<Member type={`FrooxEngine.LogiX.Input\`1[BaseX.double2]`} name="Source" id={typeof Source === "object" && "id" in Source ? Source?.id : undefined} value={typeof Source === "object" && "value" in Source ? Source?.value : Source} /* default: ID0 */  isRaw={typeof Source === "object" && "isRaw" in Source && Source.isRaw ? true : undefined} />
