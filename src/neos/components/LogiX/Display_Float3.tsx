import { member, Member, Component } from "../../core";
    ...
    export interface Display_Float3Input {
...
_text2?: member<string>;
    ...
    export function Display_Float3(props: Display_Float3Input){
...
_text2, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.Display.Display_Float3" id={id} persistentId={persistentId} updateOrder={updateOrder}>
...
<Member type={`FrooxEngine.LogiX.Input\`1[BaseX.float3]`} name="Source" id={typeof Source === "object" && "id" in Source ? Source?.id : undefined} value={typeof Source === "object" && "value" in Source ? Source?.value : Source} /* default: ID0 */  isRaw={typeof Source === "object" && "isRaw" in Source && Source.isRaw ? true : undefined} />
