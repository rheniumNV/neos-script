import { member, Member, Component } from "../../core";
    ...
    export interface Display_Float4Input {
...
_text3?: member<string>;
    ...
    export function Display_Float4(props: Display_Float4Input){
...
_text3, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.Display.Display_Float4" id={id} persistentId={persistentId} updateOrder={updateOrder}>
...
<Member type={`FrooxEngine.LogiX.Input\`1[BaseX.float4]`} name="Source" id={typeof Source === "object" && "id" in Source ? Source?.id : undefined} value={typeof Source === "object" && "value" in Source ? Source?.value : Source} /* default: ID0 */  isRaw={typeof Source === "object" && "isRaw" in Source && Source.isRaw ? true : undefined} />
