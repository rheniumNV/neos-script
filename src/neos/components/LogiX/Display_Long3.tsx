import { member, Member, Component } from "../../core";
    ...
    export interface Display_Long3Input {
...
_text2?: member<string>;
    ...
    export function Display_Long3(props: Display_Long3Input){
...
_text2, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.Display.Display_Long3" id={id} persistentId={persistentId} updateOrder={updateOrder}>
...
<Member type={`FrooxEngine.LogiX.Input\`1[BaseX.long3]`} name="Source" id={typeof Source === "object" && "id" in Source ? Source?.id : undefined} value={typeof Source === "object" && "value" in Source ? Source?.value : Source} /* default: ID0 */  isRaw={typeof Source === "object" && "isRaw" in Source && Source.isRaw ? true : undefined} />
