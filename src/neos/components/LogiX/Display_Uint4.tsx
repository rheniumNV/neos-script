import { member, Member, Component } from "../../core";
    ...
    export interface Display_Uint4Input {
...
_text3?: member<string>;
    ...
    export function Display_Uint4(props: Display_Uint4Input){
...
_text3, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.Display.Display_Uint4" id={id} persistentId={persistentId} updateOrder={updateOrder}>
...
<Member type={`FrooxEngine.LogiX.Input\`1[BaseX.uint4]`} name="Source" id={typeof Source === "object" && "id" in Source ? Source?.id : undefined} value={typeof Source === "object" && "value" in Source ? Source?.value : Source} /* default: ID0 */  isRaw={typeof Source === "object" && "isRaw" in Source && Source.isRaw ? true : undefined} />
