...
<Member type={`FrooxEngine.LogiX.Input\`1[System.Single]`} name="Delay" id={typeof Delay === "object" && "id" in Delay ? Delay?.id : undefined} value={typeof Delay === "object" && "value" in Delay ? Delay?.value : Delay} /* default: null */  isRaw={typeof Delay === "object" && "isRaw" in Delay && Delay.isRaw ? true : undefined} />
