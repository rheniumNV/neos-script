...
<Member type={`FrooxEngine.LogiX.Impulse`} name="Destroyed" id={typeof Destroyed === "object" && "id" in Destroyed ? Destroyed?.id : undefined} value={typeof Destroyed === "object" && "value" in Destroyed ? Destroyed?.value : Destroyed} /* default: FrooxEngine.WorldDelegate */  />
