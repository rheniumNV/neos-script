...
<Member type={`FrooxEngine.LogiX.Impulse`} name="Started" id={typeof Started === "object" && "id" in Started ? Started?.id : undefined} value={typeof Started === "object" && "value" in Started ? Started?.value : Started} /* default: FrooxEngine.WorldDelegate */  isRaw={typeof Started === "object" && "isRaw" in Started && Started.isRaw ? true : undefined} />
