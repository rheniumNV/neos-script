...
<Member type={`FrooxEngine.Sync\`1[FrooxEngine.Grabbable]`} name="_lastValue" id={typeof _lastValue === "object" && "id" in _lastValue ? _lastValue?.id : undefined} value={typeof _lastValue === "object" && "value" in _lastValue ? _lastValue?.value : _lastValue} /* default: <i>null</i> */  isRaw={typeof _lastValue === "object" && "isRaw" in _lastValue && _lastValue.isRaw ? true : undefined} />
        </Component>
      );
    };
