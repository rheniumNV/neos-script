import { member, Member, Component } from "../../../core";
    ...
    export interface FireOntrueInput {
...
_lastState?: member<boolean>;
    ...
    export function FireOntrue(props: FireOntrueInput){
...
_lastState, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.ProgramFlow.FireOntrue" id={id} persistentId={persistentId} updateOrder={updateOrder}>
