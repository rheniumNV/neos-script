import { member, Member, Component } from "../../../core";
    ...
    export interface LocalFireOnfalseInput {
...
Pulse?: member<any>;
    ...
    export function LocalFireOnfalse(props: LocalFireOnfalseInput){
...
Pulse, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.ProgramFlow.LocalFireOnfalse" id={id} persistentId={persistentId} updateOrder={updateOrder}>
