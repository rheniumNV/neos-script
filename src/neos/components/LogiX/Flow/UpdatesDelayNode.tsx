...
<Member type={`FrooxEngine.LogiX.Input\`1[System.Int32]`} name="Updates" id={typeof Updates === "object" && "id" in Updates ? Updates?.id : undefined} value={typeof Updates === "object" && "value" in Updates ? Updates?.value : Updates} /* default: ID0 */  isRaw={typeof Updates === "object" && "isRaw" in Updates && Updates.isRaw ? true : undefined} />
        </Component>
      );
    };
