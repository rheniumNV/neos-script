...
<Member type={`FrooxEngine.SyncRef\`1[FrooxEngine.ValueStream\`1[System.Boolean]]`} name="_menu" id={typeof _menu === "object" && "id" in _menu ? _menu?.id : undefined} value={typeof _menu === "object" && "value" in _menu ? _menu?.value : _menu} /* default: ID0 */  />
<Member type={`FrooxEngine.SyncRef\`1[FrooxEngine.ValueStream\`1[System.Boolean]]`} name="_buttonBY" id={typeof _buttonBY === "object" && "id" in _buttonBY ? _buttonBY?.id : undefined} value={typeof _buttonBY === "object" && "value" in _buttonBY ? _buttonBY?.value : _buttonBY} /* default: ID0 */  />
<Member type={`FrooxEngine.SyncRef\`1[FrooxEngine.ValueStream\`1[System.Boolean]]`} name="_buttonAX" id={typeof _buttonAX === "object" && "id" in _buttonAX ? _buttonAX?.id : undefined} value={typeof _buttonAX === "object" && "value" in _buttonAX ? _buttonAX?.value : _buttonAX} /* default: ID0 */  />
...
<Member type={`FrooxEngine.SyncRef\`1[FrooxEngine.ValueStream\`1[System.Boolean]]`} name="_bumper" id={typeof _bumper === "object" && "id" in _bumper ? _bumper?.id : undefined} value={typeof _bumper === "object" && "value" in _bumper ? _bumper?.value : _bumper} /* default: ID0 */  />
        </Component>
      );
    };
