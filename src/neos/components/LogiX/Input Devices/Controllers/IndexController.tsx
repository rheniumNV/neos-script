...
<Member type={`FrooxEngine.SyncRef\`1[FrooxEngine.ValueStream\`1[System.Boolean]]`} name="_buttonA" id={typeof _buttonA === "object" && "id" in _buttonA ? _buttonA?.id : undefined} value={typeof _buttonA === "object" && "value" in _buttonA ? _buttonA?.value : _buttonA} /* default: ID0 */  isRaw={typeof _buttonA === "object" && "isRaw" in _buttonA && _buttonA.isRaw ? true : undefined} />
<Member type={`FrooxEngine.SyncRef\`1[FrooxEngine.ValueStream\`1[System.Boolean]]`} name="_buttonB" id={typeof _buttonB === "object" && "id" in _buttonB ? _buttonB?.id : undefined} value={typeof _buttonB === "object" && "value" in _buttonB ? _buttonB?.value : _buttonB} /* default: ID0 */  isRaw={typeof _buttonB === "object" && "isRaw" in _buttonB && _buttonB.isRaw ? true : undefined} />
<Member type={`FrooxEngine.SyncRef\`1[FrooxEngine.ValueStream\`1[System.Boolean]]`} name="_buttonA_Touch" id={typeof _buttonA_Touch === "object" && "id" in _buttonA_Touch ? _buttonA_Touch?.id : undefined} value={typeof _buttonA_Touch === "object" && "value" in _buttonA_Touch ? _buttonA_Touch?.value : _buttonA_Touch} /* default: ID0 */  isRaw={typeof _buttonA_Touch === "object" && "isRaw" in _buttonA_Touch && _buttonA_Touch.isRaw ? true : undefined} />
<Member type={`FrooxEngine.SyncRef\`1[FrooxEngine.ValueStream\`1[System.Boolean]]`} name="_buttonB_Touch" id={typeof _buttonB_Touch === "object" && "id" in _buttonB_Touch ? _buttonB_Touch?.id : undefined} value={typeof _buttonB_Touch === "object" && "value" in _buttonB_Touch ? _buttonB_Touch?.value : _buttonB_Touch} /* default: ID0 */  isRaw={typeof _buttonB_Touch === "object" && "isRaw" in _buttonB_Touch && _buttonB_Touch.isRaw ? true : undefined} />
...
<Member type={`FrooxEngine.SyncRef\`1[FrooxEngine.ValueStream\`1[System.Single]]`} name="_touchpadForce" id={typeof _touchpadForce === "object" && "id" in _touchpadForce ? _touchpadForce?.id : undefined} value={typeof _touchpadForce === "object" && "value" in _touchpadForce ? _touchpadForce?.value : _touchpadForce} /* default: ID0 */  isRaw={typeof _touchpadForce === "object" && "isRaw" in _touchpadForce && _touchpadForce.isRaw ? true : undefined} />
        </Component>
      );
    };
