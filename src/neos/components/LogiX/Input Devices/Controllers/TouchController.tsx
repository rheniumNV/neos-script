...
<Member type={`FrooxEngine.SyncRef\`1[FrooxEngine.ValueStream\`1[System.Boolean]]`} name="_start" id={typeof _start === "object" && "id" in _start ? _start?.id : undefined} value={typeof _start === "object" && "value" in _start ? _start?.value : _start} /* default: ID0 */  isRaw={typeof _start === "object" && "isRaw" in _start && _start.isRaw ? true : undefined} />
...
<Member type={`FrooxEngine.SyncRef\`1[FrooxEngine.ValueStream\`1[System.Boolean]]`} name="_buttonYB_Touch" id={typeof _buttonYB_Touch === "object" && "id" in _buttonYB_Touch ? _buttonYB_Touch?.id : undefined} value={typeof _buttonYB_Touch === "object" && "value" in _buttonYB_Touch ? _buttonYB_Touch?.value : _buttonYB_Touch} /* default: ID0 */  isRaw={typeof _buttonYB_Touch === "object" && "isRaw" in _buttonYB_Touch && _buttonYB_Touch.isRaw ? true : undefined} />
<Member type={`FrooxEngine.SyncRef\`1[FrooxEngine.ValueStream\`1[System.Boolean]]`} name="_buttonXA_Touch" id={typeof _buttonXA_Touch === "object" && "id" in _buttonXA_Touch ? _buttonXA_Touch?.id : undefined} value={typeof _buttonXA_Touch === "object" && "value" in _buttonXA_Touch ? _buttonXA_Touch?.value : _buttonXA_Touch} /* default: ID0 */  isRaw={typeof _buttonXA_Touch === "object" && "isRaw" in _buttonXA_Touch && _buttonXA_Touch.isRaw ? true : undefined} />
<Member type={`FrooxEngine.SyncRef\`1[FrooxEngine.ValueStream\`1[System.Boolean]]`} name="_thumbRestTouch" id={typeof _thumbRestTouch === "object" && "id" in _thumbRestTouch ? _thumbRestTouch?.id : undefined} value={typeof _thumbRestTouch === "object" && "value" in _thumbRestTouch ? _thumbRestTouch?.value : _thumbRestTouch} /* default: ID0 */  isRaw={typeof _thumbRestTouch === "object" && "isRaw" in _thumbRestTouch && _thumbRestTouch.isRaw ? true : undefined} />
...
<Member type={`FrooxEngine.Sync\`1[FrooxEngine.TouchController+Model]`} name="_model" id={typeof _model === "object" && "id" in _model ? _model?.id : undefined} value={typeof _model === "object" && "value" in _model ? _model?.value : _model} /* default: CV1 */  isRaw={typeof _model === "object" && "isRaw" in _model && _model.isRaw ? true : undefined} />
        </Component>
      );
    };
