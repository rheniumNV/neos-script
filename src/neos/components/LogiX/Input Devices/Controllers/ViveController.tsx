...
_touchpadClick?: member<any>;
    ...
    export function ViveController(props: ViveControllerInput){
...
_touchpadClick, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.Input.ViveController" id={id} persistentId={persistentId} updateOrder={updateOrder}>
...
<Member type={`FrooxEngine.SyncRef\`1[FrooxEngine.ValueStream\`1[System.Boolean]]`} name="_grip" id={typeof _grip === "object" && "id" in _grip ? _grip?.id : undefined} value={typeof _grip === "object" && "value" in _grip ? _grip?.value : _grip} /* default: ID0 */  />
<Member type={`FrooxEngine.SyncRef\`1[FrooxEngine.ValueStream\`1[System.Boolean]]`} name="_app" id={typeof _app === "object" && "id" in _app ? _app?.id : undefined} value={typeof _app === "object" && "value" in _app ? _app?.value : _app} /* default: ID0 */  />
...
<Member type={`FrooxEngine.SyncRef\`1[FrooxEngine.ValueStream\`1[System.Boolean]]`} name="_triggerHair" id={typeof _triggerHair === "object" && "id" in _triggerHair ? _triggerHair?.id : undefined} value={typeof _triggerHair === "object" && "value" in _triggerHair ? _triggerHair?.value : _triggerHair} /* default: ID0 */  />
