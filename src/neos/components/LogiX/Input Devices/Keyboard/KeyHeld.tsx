...
Key?: member<any>;
    ...
    export function KeyHeld(props: KeyHeldInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
Key, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Input.KeyHeld" id={id} persistentId={persistentId} updateOrder={updateOrder}>
