...
Key?: member<any>;
    ...
    export function KeyPressed(props: KeyPressedInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
Key, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Input.KeyPressed" id={id} persistentId={persistentId} updateOrder={updateOrder}>
