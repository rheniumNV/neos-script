import { member, Member, Component } from "../../../../core";
    ...
    export interface GrabbableGrabberInput {
...
Grabbable?: member<any>;
    ...
    export function GrabbableGrabber(props: GrabbableGrabberInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
Grabbable, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Interaction.GrabbableGrabber" id={id} persistentId={persistentId} updateOrder={updateOrder}>
