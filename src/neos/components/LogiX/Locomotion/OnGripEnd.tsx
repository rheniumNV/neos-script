import { member, Member, Component } from "../../../core";
    ...
    export interface OnGripEndInput {
...
OnEvent?: member<any>;
    ...
    export function OnGripEnd(props: OnGripEndInput){
...
OnEvent, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.Physics.OnGripEnd" id={id} persistentId={persistentId} updateOrder={updateOrder}>
