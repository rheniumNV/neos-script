import { member, Member, Component } from "../../../core";
    ...
    export interface OnLocomotionGripBeginInput {
...
OnEvent?: member<any>;
    ...
    export function OnLocomotionGripBegin(props: OnLocomotionGripBeginInput){
...
OnEvent, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.Physics.OnLocomotionGripBegin" id={id} persistentId={persistentId} updateOrder={updateOrder}>
