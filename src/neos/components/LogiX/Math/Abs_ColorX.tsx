import { member, Member, Component } from "../../../core";
    ...
    export interface Abs_ColorXInput {
...
N?: member<any>;
    ...
    export function Abs_ColorX(props: Abs_ColorXInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
N, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Math.Abs_ColorX" id={id} persistentId={persistentId} updateOrder={updateOrder}>
