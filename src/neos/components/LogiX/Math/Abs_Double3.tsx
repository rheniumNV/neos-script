import { member, Member, Component } from "../../../core";
    ...
    export interface Abs_Double3Input {
...
N?: member<any>;
    ...
    export function Abs_Double3(props: Abs_Double3Input){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
N, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Math.Abs_Double3" id={id} persistentId={persistentId} updateOrder={updateOrder}>
