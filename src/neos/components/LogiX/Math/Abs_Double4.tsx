import { member, Member, Component } from "../../../core";
    ...
    export interface Abs_Double4Input {
...
N?: member<any>;
    ...
    export function Abs_Double4(props: Abs_Double4Input){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
N, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Math.Abs_Double4" id={id} persistentId={persistentId} updateOrder={updateOrder}>
