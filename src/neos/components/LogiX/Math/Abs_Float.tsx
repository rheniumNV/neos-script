import { member, Member, Component } from "../../../core";
    ...
    export interface Abs_FloatInput {
...
N?: member<any>;
    ...
    export function Abs_Float(props: Abs_FloatInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
N, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Math.Abs_Float" id={id} persistentId={persistentId} updateOrder={updateOrder}>
