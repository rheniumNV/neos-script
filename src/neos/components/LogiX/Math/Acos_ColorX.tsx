import { member, Member, Component } from "../../../core";
    ...
    export interface Acos_ColorXInput {
...
N?: member<any>;
    ...
    export function Acos_ColorX(props: Acos_ColorXInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
N, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Math.Acos_ColorX" id={id} persistentId={persistentId} updateOrder={updateOrder}>
