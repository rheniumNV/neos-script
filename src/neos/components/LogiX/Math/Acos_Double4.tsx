import { member, Member, Component } from "../../../core";
    ...
    export interface Acos_Double4Input {
...
N?: member<any>;
    ...
    export function Acos_Double4(props: Acos_Double4Input){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
N, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Math.Acos_Double4" id={id} persistentId={persistentId} updateOrder={updateOrder}>
