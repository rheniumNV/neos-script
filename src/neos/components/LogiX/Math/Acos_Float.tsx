import { member, Member, Component } from "../../../core";
    ...
    export interface Acos_FloatInput {
...
N?: member<any>;
    ...
    export function Acos_Float(props: Acos_FloatInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
N, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Math.Acos_Float" id={id} persistentId={persistentId} updateOrder={updateOrder}>
