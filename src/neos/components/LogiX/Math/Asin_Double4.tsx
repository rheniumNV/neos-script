import { member, Member, Component } from "../../../core";
    ...
    export interface Asin_Double4Input {
...
N?: member<any>;
    ...
    export function Asin_Double4(props: Asin_Double4Input){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
N, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Math.Asin_Double4" id={id} persistentId={persistentId} updateOrder={updateOrder}>
