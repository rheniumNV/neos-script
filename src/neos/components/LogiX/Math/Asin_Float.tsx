import { member, Member, Component } from "../../../core";
    ...
    export interface Asin_FloatInput {
...
N?: member<any>;
    ...
    export function Asin_Float(props: Asin_FloatInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
N, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Math.Asin_Float" id={id} persistentId={persistentId} updateOrder={updateOrder}>
