import { member, Member, Component } from "../../../core";
    ...
    export interface Atan2_FloatInput {
...
X?: member<any>;
    ...
    export function Atan2_Float(props: Atan2_FloatInput){
...
X, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.Math.Atan2_Float" id={id} persistentId={persistentId} updateOrder={updateOrder} version={1}>
