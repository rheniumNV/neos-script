import { member, Member, Component } from "../../../core";
    ...
    export interface Atan_Double3Input {
...
N?: member<any>;
    ...
    export function Atan_Double3(props: Atan_Double3Input){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
N, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Math.Atan_Double3" id={id} persistentId={persistentId} updateOrder={updateOrder}>
