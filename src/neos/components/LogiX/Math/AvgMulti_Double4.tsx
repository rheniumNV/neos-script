import { member, Member, Component } from "../../../core";
    ...
    export interface AvgMulti_Double4Input {
...
Operands?: member<any>;
    ...
    export function AvgMulti_Double4(props: AvgMulti_Double4Input){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
Operands, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Math.AvgMulti_Double4" id={id} persistentId={persistentId} updateOrder={updateOrder}>
