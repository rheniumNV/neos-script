import { member, Member, Component } from "../../../../core";
    ...
    export interface ComposeBits_sbyteInput {
...
Bit7?: member<any>;
    ...
    export function ComposeBits_sbyte(props: ComposeBits_sbyteInput){
...
Bit7, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.Math.Binary.ComposeBits_sbyte" id={id} persistentId={persistentId} updateOrder={updateOrder}>
