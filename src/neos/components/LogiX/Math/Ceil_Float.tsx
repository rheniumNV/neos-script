import { member, Member, Component } from "../../../core";
    ...
    export interface Ceil_FloatInput {
...
N?: member<any>;
    ...
    export function Ceil_Float(props: Ceil_FloatInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
N, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Math.Ceil_Float" id={id} persistentId={persistentId} updateOrder={updateOrder}>
