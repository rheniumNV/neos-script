import { member, Member, Component } from "../../../core";
    ...
    export interface Clamp01_ColorXInput {
...
N?: member<any>;
    ...
    export function Clamp01_ColorX(props: Clamp01_ColorXInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
N, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Math.Clamp01_ColorX" id={id} persistentId={persistentId} updateOrder={updateOrder}>
