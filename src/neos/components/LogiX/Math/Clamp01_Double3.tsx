import { member, Member, Component } from "../../../core";
    ...
    export interface Clamp01_Double3Input {
...
N?: member<any>;
    ...
    export function Clamp01_Double3(props: Clamp01_Double3Input){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
N, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Math.Clamp01_Double3" id={id} persistentId={persistentId} updateOrder={updateOrder}>
