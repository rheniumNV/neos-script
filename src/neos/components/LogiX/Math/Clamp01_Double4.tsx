import { member, Member, Component } from "../../../core";
    ...
    export interface Clamp01_Double4Input {
...
N?: member<any>;
    ...
    export function Clamp01_Double4(props: Clamp01_Double4Input){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
N, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Math.Clamp01_Double4" id={id} persistentId={persistentId} updateOrder={updateOrder}>
