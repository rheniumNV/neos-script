import { member, Member, Component } from "../../../core";
    ...
    export interface Clamp01_FloatInput {
...
N?: member<any>;
    ...
    export function Clamp01_Float(props: Clamp01_FloatInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
N, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Math.Clamp01_Float" id={id} persistentId={persistentId} updateOrder={updateOrder}>
