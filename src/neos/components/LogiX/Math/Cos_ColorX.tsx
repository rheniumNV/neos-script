import { member, Member, Component } from "../../../core";
    ...
    export interface Cos_ColorXInput {
...
N?: member<any>;
    ...
    export function Cos_ColorX(props: Cos_ColorXInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
N, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Math.Cos_ColorX" id={id} persistentId={persistentId} updateOrder={updateOrder}>
