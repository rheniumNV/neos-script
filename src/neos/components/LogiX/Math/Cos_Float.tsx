import { member, Member, Component } from "../../../core";
    ...
    export interface Cos_FloatInput {
...
N?: member<any>;
    ...
    export function Cos_Float(props: Cos_FloatInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
N, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Math.Cos_Float" id={id} persistentId={persistentId} updateOrder={updateOrder}>
