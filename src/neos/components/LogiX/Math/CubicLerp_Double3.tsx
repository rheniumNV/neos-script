...
<Member type={`FrooxEngine.LogiX.Input\`1[BaseX.double3]`} name="ToTangent" id={typeof ToTangent === "object" && "id" in ToTangent ? ToTangent?.id : undefined} value={typeof ToTangent === "object" && "value" in ToTangent ? ToTangent?.value : ToTangent} /* default: ID0 */  isRaw={typeof ToTangent === "object" && "isRaw" in ToTangent && ToTangent.isRaw ? true : undefined} />
