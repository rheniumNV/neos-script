import { member, Member, Component } from "../../../../core";
    ...
    export interface DatetimeDayNodeInput {
...
DateTime?: member<any>;
    ...
    export function DatetimeDayNode(props: DatetimeDayNodeInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
DateTime, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Math.Time.DatetimeDayNode" id={id} persistentId={persistentId} updateOrder={updateOrder}>
