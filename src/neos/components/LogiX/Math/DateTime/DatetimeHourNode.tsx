import { member, Member, Component } from "../../../../core";
    ...
    export interface DatetimeHourNodeInput {
...
DateTime?: member<any>;
    ...
    export function DatetimeHourNode(props: DatetimeHourNodeInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
DateTime, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Math.Time.DatetimeHourNode" id={id} persistentId={persistentId} updateOrder={updateOrder}>
