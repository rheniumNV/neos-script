import { member, Member, Component } from "../../../../core";
    ...
    export interface DatetimeKindNodeInput {
...
DateTime?: member<any>;
    ...
    export function DatetimeKindNode(props: DatetimeKindNodeInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
DateTime, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Math.Time.DatetimeKindNode" id={id} persistentId={persistentId} updateOrder={updateOrder}>
