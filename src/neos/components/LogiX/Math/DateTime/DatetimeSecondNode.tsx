import { member, Member, Component } from "../../../../core";
    ...
    export interface DatetimeSecondNodeInput {
...
DateTime?: member<any>;
    ...
    export function DatetimeSecondNode(props: DatetimeSecondNodeInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
DateTime, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Math.Time.DatetimeSecondNode" id={id} persistentId={persistentId} updateOrder={updateOrder}>
