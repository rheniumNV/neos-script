import { member, Member, Component } from "../../../../core";
    ...
    export interface DatetimeYearNodeInput {
...
DateTime?: member<any>;
    ...
    export function DatetimeYearNode(props: DatetimeYearNodeInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
DateTime, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Math.Time.DatetimeYearNode" id={id} persistentId={persistentId} updateOrder={updateOrder}>
