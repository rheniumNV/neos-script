import { member, Member, Component } from "../../../../core";
    ...
    export interface ToUnixSecondsInput {
...
DateTime?: member<any>;
    ...
    export function ToUnixSeconds(props: ToUnixSecondsInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
DateTime, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Math.Time.ToUnixSeconds" id={id} persistentId={persistentId} updateOrder={updateOrder}>
