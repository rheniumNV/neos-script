import { member, Member, Component } from "../../../core";
    ...
    export interface Delta_Double3Input {
...
Value?: member<any>;
    ...
    export function Delta_Double3(props: Delta_Double3Input){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
Value, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Math.Delta_Double3" id={id} persistentId={persistentId} updateOrder={updateOrder}>
