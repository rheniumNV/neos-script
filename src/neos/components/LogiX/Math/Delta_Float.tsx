import { member, Member, Component } from "../../../core";
    ...
    export interface Delta_FloatInput {
...
Value?: member<any>;
    ...
    export function Delta_Float(props: Delta_FloatInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
Value, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Math.Delta_Float" id={id} persistentId={persistentId} updateOrder={updateOrder}>
