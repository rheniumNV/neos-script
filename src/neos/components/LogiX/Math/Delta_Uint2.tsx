import { member, Member, Component } from "../../../core";
    ...
    export interface Delta_Uint2Input {
...
Value?: member<any>;
    ...
    export function Delta_Uint2(props: Delta_Uint2Input){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
Value, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Math.Delta_Uint2" id={id} persistentId={persistentId} updateOrder={updateOrder}>
