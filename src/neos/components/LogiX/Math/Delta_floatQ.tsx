import { member, Member, Component } from "../../../core";
    ...
    export interface Delta_floatQInput {
...
Value?: member<[number, number, number, number]>;
    ...
    export function Delta_floatQ(props: Delta_floatQInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
Value, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Math.Quaternions.Delta_floatQ" id={id} persistentId={persistentId} updateOrder={updateOrder}>
