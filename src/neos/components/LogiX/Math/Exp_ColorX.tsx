import { member, Member, Component } from "../../../core";
    ...
    export interface Exp_ColorXInput {
...
N?: member<any>;
    ...
    export function Exp_ColorX(props: Exp_ColorXInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
N, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Math.Exp_ColorX" id={id} persistentId={persistentId} updateOrder={updateOrder}>
