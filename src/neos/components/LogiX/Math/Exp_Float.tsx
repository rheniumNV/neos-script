import { member, Member, Component } from "../../../core";
    ...
    export interface Exp_FloatInput {
...
N?: member<any>;
    ...
    export function Exp_Float(props: Exp_FloatInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
N, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Math.Exp_Float" id={id} persistentId={persistentId} updateOrder={updateOrder}>
