...
N?: member<any>;
    ...
    export function FloorToInt_Double3(props: FloorToInt_Double3Input){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
N, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Math.FloorToInt_Double3" id={id} persistentId={persistentId} updateOrder={updateOrder}>
