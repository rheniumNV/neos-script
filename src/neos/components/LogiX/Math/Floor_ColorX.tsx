import { member, Member, Component } from "../../../core";
    ...
    export interface Floor_ColorXInput {
...
N?: member<any>;
    ...
    export function Floor_ColorX(props: Floor_ColorXInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
N, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Math.Floor_ColorX" id={id} persistentId={persistentId} updateOrder={updateOrder}>
