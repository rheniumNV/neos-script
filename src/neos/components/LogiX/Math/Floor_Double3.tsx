import { member, Member, Component } from "../../../core";
    ...
    export interface Floor_Double3Input {
...
N?: member<any>;
    ...
    export function Floor_Double3(props: Floor_Double3Input){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
N, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Math.Floor_Double3" id={id} persistentId={persistentId} updateOrder={updateOrder}>
