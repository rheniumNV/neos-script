import { member, Member, Component } from "../../../core";
    ...
    export interface Log10_Double4Input {
...
N?: member<any>;
    ...
    export function Log10_Double4(props: Log10_Double4Input){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
N, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Math.Log10_Double4" id={id} persistentId={persistentId} updateOrder={updateOrder}>
