import { member, Member, Component } from "../../../core";
    ...
    export interface Log10_FloatInput {
...
N?: member<any>;
    ...
    export function Log10_Float(props: Log10_FloatInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
N, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Math.Log10_Float" id={id} persistentId={persistentId} updateOrder={updateOrder}>
