import { member, Member, Component } from "../../../core";
    ...
    export interface Log_ColorXInput {
...
N?: member<any>;
    ...
    export function Log_ColorX(props: Log_ColorXInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
N, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Math.Log_ColorX" id={id} persistentId={persistentId} updateOrder={updateOrder}>
