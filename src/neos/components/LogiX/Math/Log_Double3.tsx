import { member, Member, Component } from "../../../core";
    ...
    export interface Log_Double3Input {
...
N?: member<any>;
    ...
    export function Log_Double3(props: Log_Double3Input){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
N, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Math.Log_Double3" id={id} persistentId={persistentId} updateOrder={updateOrder}>
