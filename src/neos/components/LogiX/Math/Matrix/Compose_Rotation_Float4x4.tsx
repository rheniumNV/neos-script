import { member, Member, Component } from "../../../../core";
    ...
    export interface Compose_Rotation_Float4x4Input {
...
Rotation?: member<[number, number, number, number]>;
    ...
    export function Compose_Rotation_Float4x4(props: Compose_Rotation_Float4x4Input){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
Rotation, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Operators.Compose_Rotation_Float4x4" id={id} persistentId={persistentId} updateOrder={updateOrder}>
