import { member, Member, Component } from "../../../../core";
    ...
    export interface Compose_ScaleFloat4x4Input {
...
Scale?: member<any>;
    ...
    export function Compose_ScaleFloat4x4(props: Compose_ScaleFloat4x4Input){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
Scale, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Operators.Compose_ScaleFloat4x4" id={id} persistentId={persistentId} updateOrder={updateOrder}>
