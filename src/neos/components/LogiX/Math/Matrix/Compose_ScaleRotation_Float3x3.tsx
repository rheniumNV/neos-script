import { member, Member, Component } from "../../../../core";
    ...
    export interface Compose_ScaleRotation_Float3x3Input {
...
Rotation?: member<[number, number, number, number]>;
    ...
    export function Compose_ScaleRotation_Float3x3(props: Compose_ScaleRotation_Float3x3Input){
...
Rotation, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.Operators.Compose_ScaleRotation_Float3x3" id={id} persistentId={persistentId} updateOrder={updateOrder}>
