import { member, Member, Component } from "../../../core";
    ...
    export interface MaxMulti_Double4Input {
...
Operands?: member<any>;
    ...
    export function MaxMulti_Double4(props: MaxMulti_Double4Input){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
Operands, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Math.MaxMulti_Double4" id={id} persistentId={persistentId} updateOrder={updateOrder}>
