import { member, Member, Component } from "../../../core";
    ...
    export interface MaxMulti_Int3Input {
...
Operands?: member<any>;
    ...
    export function MaxMulti_Int3(props: MaxMulti_Int3Input){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
Operands, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Math.MaxMulti_Int3" id={id} persistentId={persistentId} updateOrder={updateOrder}>
