import { member, Member, Component } from "../../../core";
    ...
    export interface MaxMulti_Uint2Input {
...
Operands?: member<any>;
    ...
    export function MaxMulti_Uint2(props: MaxMulti_Uint2Input){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
Operands, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Math.MaxMulti_Uint2" id={id} persistentId={persistentId} updateOrder={updateOrder}>
