import { member, Member, Component } from "../../../core";
    ...
    export interface MaxMulti_Ulong2Input {
...
Operands?: member<any>;
    ...
    export function MaxMulti_Ulong2(props: MaxMulti_Ulong2Input){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
Operands, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Math.MaxMulti_Ulong2" id={id} persistentId={persistentId} updateOrder={updateOrder}>
