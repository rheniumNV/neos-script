import { member, Member, Component } from "../../../core";
    ...
    export interface MinMulti_Int3Input {
...
Operands?: member<any>;
    ...
    export function MinMulti_Int3(props: MinMulti_Int3Input){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
Operands, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Math.MinMulti_Int3" id={id} persistentId={persistentId} updateOrder={updateOrder}>
