import { member, Member, Component } from "../../../core";
    ...
    export interface MinMulti_Ulong2Input {
...
Operands?: member<any>;
    ...
    export function MinMulti_Ulong2(props: MinMulti_Ulong2Input){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
Operands, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Math.MinMulti_Ulong2" id={id} persistentId={persistentId} updateOrder={updateOrder}>
