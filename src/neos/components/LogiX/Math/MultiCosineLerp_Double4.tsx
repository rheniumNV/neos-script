import { member, Member, Component } from "../../../core";
    ...
    export interface MultiCosineLerp_Double4Input {
...
Lerp?: member<any>;
    ...
    export function MultiCosineLerp_Double4(props: MultiCosineLerp_Double4Input){
...
Lerp, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.Math.MultiCosineLerp_Double4" id={id} persistentId={persistentId} updateOrder={updateOrder}>
