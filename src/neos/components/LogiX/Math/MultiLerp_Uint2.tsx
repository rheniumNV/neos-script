import { member, Member, Component } from "../../../core";
    ...
    export interface MultiLerp_Uint2Input {
...
Lerp?: member<any>;
    ...
    export function MultiLerp_Uint2(props: MultiLerp_Uint2Input){
...
Lerp, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.Math.MultiLerp_Uint2" id={id} persistentId={persistentId} updateOrder={updateOrder}>
