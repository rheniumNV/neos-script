import { member, Member, Component } from "../../../core";
    ...
    export interface MultiLerp_Ulong2Input {
...
Lerp?: member<any>;
    ...
    export function MultiLerp_Ulong2(props: MultiLerp_Ulong2Input){
...
Lerp, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.Math.MultiLerp_Ulong2" id={id} persistentId={persistentId} updateOrder={updateOrder}>
