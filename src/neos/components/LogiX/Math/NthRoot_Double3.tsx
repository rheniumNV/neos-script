import { member, Member, Component } from "../../../core";
    ...
    export interface NthRoot_Double3Input {
...
N?: member<any>;
    ...
    export function NthRoot_Double3(props: NthRoot_Double3Input){
...
N, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.Math.NthRoot_Double3" id={id} persistentId={persistentId} updateOrder={updateOrder}>
