import { member, Member, Component } from "../../../core";
    ...
    export interface NthRoot_FloatInput {
...
N?: member<any>;
    ...
    export function NthRoot_Float(props: NthRoot_FloatInput){
...
N, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.Math.NthRoot_Float" id={id} persistentId={persistentId} updateOrder={updateOrder}>
