import { member, Member, Component } from "../../../core";
    ...
    export interface Pow_ColorX_FloatInput {
...
Power?: member<any>;
    ...
    export function Pow_ColorX_Float(props: Pow_ColorX_FloatInput){
...
Power, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.Math.Pow_ColorX_Float" id={id} persistentId={persistentId} updateOrder={updateOrder}>
