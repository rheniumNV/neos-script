import { member, Member, Component } from "../../../core";
    ...
    export interface Pow_FloatInput {
...
Power?: member<any>;
    ...
    export function Pow_Float(props: Pow_FloatInput){
...
Power, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.Math.Pow_Float" id={id} persistentId={persistentId} updateOrder={updateOrder}>
