import { member, Member, Component } from "../../../../core";
    ...
    export interface RectToPositionSizeInput {
...
Rect?: member<any>;
    ...
    export function RectToPositionSize(props: RectToPositionSizeInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
Rect, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Math.Rects.RectToPositionSize" id={id} persistentId={persistentId} updateOrder={updateOrder}>
