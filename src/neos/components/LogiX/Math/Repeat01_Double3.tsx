import { member, Member, Component } from "../../../core";
    ...
    export interface Repeat01_Double3Input {
...
Value?: member<any>;
    ...
    export function Repeat01_Double3(props: Repeat01_Double3Input){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
Value, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Math.Repeat01_Double3" id={id} persistentId={persistentId} updateOrder={updateOrder}>
