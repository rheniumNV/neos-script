import { member, Member, Component } from "../../../core";
    ...
    export interface Repeat_Double3_DoubleInput {
...
Length?: member<any>;
    ...
    export function Repeat_Double3_Double(props: Repeat_Double3_DoubleInput){
...
Length, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.Math.Repeat_Double3_Double" id={id} persistentId={persistentId} updateOrder={updateOrder}>
