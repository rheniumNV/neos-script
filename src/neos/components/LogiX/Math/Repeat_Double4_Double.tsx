import { member, Member, Component } from "../../../core";
    ...
    export interface Repeat_Double4_DoubleInput {
...
Length?: member<any>;
    ...
    export function Repeat_Double4_Double(props: Repeat_Double4_DoubleInput){
...
Length, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.Math.Repeat_Double4_Double" id={id} persistentId={persistentId} updateOrder={updateOrder}>
