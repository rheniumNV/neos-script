...
N?: member<any>;
    ...
    export function RoundToInt_Float(props: RoundToInt_FloatInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
N, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Math.RoundToInt_Float" id={id} persistentId={persistentId} updateOrder={updateOrder}>
