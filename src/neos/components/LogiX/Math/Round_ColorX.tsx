import { member, Member, Component } from "../../../core";
    ...
    export interface Round_ColorXInput {
...
N?: member<any>;
    ...
    export function Round_ColorX(props: Round_ColorXInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
N, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Math.Round_ColorX" id={id} persistentId={persistentId} updateOrder={updateOrder}>
