import { member, Member, Component } from "../../../core";
    ...
    export interface Round_FloatInput {
...
N?: member<any>;
    ...
    export function Round_Float(props: Round_FloatInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
N, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Math.Round_Float" id={id} persistentId={persistentId} updateOrder={updateOrder}>
