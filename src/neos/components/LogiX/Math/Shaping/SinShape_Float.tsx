import { member, Member, Component } from "../../../../core";
    ...
    export interface SinShape_FloatInput {
...
Value?: member<any>;
    ...
    export function SinShape_Float(props: SinShape_FloatInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
Value, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Operators.SinShape_Float" id={id} persistentId={persistentId} updateOrder={updateOrder}>
