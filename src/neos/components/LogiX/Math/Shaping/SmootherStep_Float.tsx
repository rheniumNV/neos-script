...
Value?: member<any>;
    ...
    export function SmootherStep_Float(props: SmootherStep_FloatInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
Value, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Operators.SmootherStep_Float" id={id} persistentId={persistentId} updateOrder={updateOrder}>
