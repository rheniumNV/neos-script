import { member, Member, Component } from "../../../../core";
    ...
    export interface SymmetricPowShape_FloatInput {
...
Power?: member<any>;
    ...
    export function SymmetricPowShape_Float(props: SymmetricPowShape_FloatInput){
...
Power, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.Operators.SymmetricPowShape_Float" id={id} persistentId={persistentId} updateOrder={updateOrder}>
