...
<Member type={`FrooxEngine.LogiX.Input\`1[System.Single]`} name="E" id={typeof E === "object" && "id" in E ? E?.id : undefined} value={typeof E === "object" && "value" in E ? E?.value : E} /* default: ID0 */  isRaw={typeof E === "object" && "isRaw" in E && E.isRaw ? true : undefined} />
