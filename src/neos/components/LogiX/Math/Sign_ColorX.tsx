import { member, Member, Component } from "../../../core";
    ...
    export interface Sign_ColorXInput {
...
N?: member<any>;
    ...
    export function Sign_ColorX(props: Sign_ColorXInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
N, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Math.Sign_ColorX" id={id} persistentId={persistentId} updateOrder={updateOrder}>
