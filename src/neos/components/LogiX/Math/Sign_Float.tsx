import { member, Member, Component } from "../../../core";
    ...
    export interface Sign_FloatInput {
...
N?: member<any>;
    ...
    export function Sign_Float(props: Sign_FloatInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
N, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Math.Sign_Float" id={id} persistentId={persistentId} updateOrder={updateOrder}>
