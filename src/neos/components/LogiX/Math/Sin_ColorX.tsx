import { member, Member, Component } from "../../../core";
    ...
    export interface Sin_ColorXInput {
...
N?: member<any>;
    ...
    export function Sin_ColorX(props: Sin_ColorXInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
N, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Math.Sin_ColorX" id={id} persistentId={persistentId} updateOrder={updateOrder}>
