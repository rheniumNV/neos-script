import { member, Member, Component } from "../../../core";
    ...
    export interface Sin_Double4Input {
...
N?: member<any>;
    ...
    export function Sin_Double4(props: Sin_Double4Input){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
N, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Math.Sin_Double4" id={id} persistentId={persistentId} updateOrder={updateOrder}>
