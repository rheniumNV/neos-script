import { member, Member, Component } from "../../../core";
    ...
    export interface Sin_FloatInput {
...
N?: member<any>;
    ...
    export function Sin_Float(props: Sin_FloatInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
N, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Math.Sin_Float" id={id} persistentId={persistentId} updateOrder={updateOrder}>
