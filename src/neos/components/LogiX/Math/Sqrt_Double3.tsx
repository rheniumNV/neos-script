import { member, Member, Component } from "../../../core";
    ...
    export interface Sqrt_Double3Input {
...
N?: member<any>;
    ...
    export function Sqrt_Double3(props: Sqrt_Double3Input){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
N, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Math.Sqrt_Double3" id={id} persistentId={persistentId} updateOrder={updateOrder}>
