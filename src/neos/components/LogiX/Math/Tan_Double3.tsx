import { member, Member, Component } from "../../../core";
    ...
    export interface Tan_Double3Input {
...
N?: member<any>;
    ...
    export function Tan_Double3(props: Tan_Double3Input){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
N, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Math.Tan_Double3" id={id} persistentId={persistentId} updateOrder={updateOrder}>
