import { member, Member, Component } from "../../../core";
    ...
    export interface Tan_FloatInput {
...
N?: member<any>;
    ...
    export function Tan_Float(props: Tan_FloatInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
N, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Math.Tan_Float" id={id} persistentId={persistentId} updateOrder={updateOrder}>
