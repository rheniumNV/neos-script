import { member, Member, Component } from "../../../../core";
    ...
    export interface TimespanDaysNodeInput {
...
TimeSpan?: member<any>;
    ...
    export function TimespanDaysNode(props: TimespanDaysNodeInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
TimeSpan, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Math.Time.TimespanDaysNode" id={id} persistentId={persistentId} updateOrder={updateOrder}>
