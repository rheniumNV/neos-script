import { member, Member, Component } from "../../../../core";
    ...
    export interface TimespanTotalDaysNodeInput {
...
TimeSpan?: member<any>;
    ...
    export function TimespanTotalDaysNode(props: TimespanTotalDaysNodeInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
TimeSpan, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Math.Time.TimespanTotalDaysNode" id={id} persistentId={persistentId} updateOrder={updateOrder}>
