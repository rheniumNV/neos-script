import { member, Member, Component } from "../../../../core";
    ...
    export interface TimespanTotalHoursNodeInput {
...
TimeSpan?: member<any>;
    ...
    export function TimespanTotalHoursNode(props: TimespanTotalHoursNodeInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
TimeSpan, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Math.Time.TimespanTotalHoursNode" id={id} persistentId={persistentId} updateOrder={updateOrder}>
