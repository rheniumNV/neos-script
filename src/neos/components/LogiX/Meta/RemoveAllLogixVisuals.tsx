...
<Member type={`FrooxEngine.LogiX.Input\`1[FrooxEngine.Slot]`} name="MoveUnder" id={typeof MoveUnder === "object" && "id" in MoveUnder ? MoveUnder?.id : undefined} value={typeof MoveUnder === "object" && "value" in MoveUnder ? MoveUnder?.value : MoveUnder} /* default: ID0 */  isRaw={typeof MoveUnder === "object" && "isRaw" in MoveUnder && MoveUnder.isRaw ? true : undefined} />
...
<Member type={`FrooxEngine.LogiX.Impulse`} name="OnRemoved" id={typeof OnRemoved === "object" && "id" in OnRemoved ? OnRemoved?.id : undefined} value={typeof OnRemoved === "object" && "value" in OnRemoved ? OnRemoved?.value : OnRemoved} /* default: FrooxEngine.WorldDelegate */  isRaw={typeof OnRemoved === "object" && "isRaw" in OnRemoved && OnRemoved.isRaw ? true : undefined} />
        </Component>
      );
    };
