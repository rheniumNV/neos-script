import { member, Member, Component } from "../../../core";
    ...
    export interface EscapeUriDataStringInput {
...
String?: member<any>;
    ...
    export function EscapeUriDataString(props: EscapeUriDataStringInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
String, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Network.EscapeUriDataString" id={id} persistentId={persistentId} updateOrder={updateOrder}>
