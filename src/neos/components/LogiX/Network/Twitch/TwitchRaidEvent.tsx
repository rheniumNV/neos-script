...
<Member type={`FrooxEngine.LogiX.Impulse`} name="OnRaid" id={typeof OnRaid === "object" && "id" in OnRaid ? OnRaid?.id : undefined} value={typeof OnRaid === "object" && "value" in OnRaid ? OnRaid?.value : OnRaid} /* default: FrooxEngine.WorldDelegate */  isRaw={typeof OnRaid === "object" && "isRaw" in OnRaid && OnRaid.isRaw ? true : undefined} />
        </Component>
      );
    };
