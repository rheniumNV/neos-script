import { member, Member, Component } from "../../../core";
    ...
    export interface UnescapeUriDataStringInput {
...
String?: member<any>;
    ...
    export function UnescapeUriDataString(props: UnescapeUriDataStringInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
String, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Network.UnescapeUriDataString" id={id} persistentId={persistentId} updateOrder={updateOrder}>
