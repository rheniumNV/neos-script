...
<Member type={`FrooxEngine.LogiX.Input\`1[FrooxEngine.User]`} name="HandlingUser" id={typeof HandlingUser === "object" && "id" in HandlingUser ? HandlingUser?.id : undefined} value={typeof HandlingUser === "object" && "value" in HandlingUser ? HandlingUser?.value : HandlingUser} /* default: ID0 */  isRaw={typeof HandlingUser === "object" && "isRaw" in HandlingUser && HandlingUser.isRaw ? true : undefined} />
<Member type={`FrooxEngine.LogiX.Impulse`} name="OnConnectStart" id={typeof OnConnectStart === "object" && "id" in OnConnectStart ? OnConnectStart?.id : undefined} value={typeof OnConnectStart === "object" && "value" in OnConnectStart ? OnConnectStart?.value : OnConnectStart} /* default: FrooxEngine.WorldDelegate */  isRaw={typeof OnConnectStart === "object" && "isRaw" in OnConnectStart && OnConnectStart.isRaw ? true : undefined} />
        </Component>
      );
    };
