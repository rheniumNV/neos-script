import { member, Member, Component } from "../../../core";
    ...
    export interface AND_Multi_Ulong2Input {
...
Operands?: member<any>;
    ...
    export function AND_Multi_Ulong2(props: AND_Multi_Ulong2Input){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
Operands, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Operators.AND_Multi_Ulong2" id={id} persistentId={persistentId} updateOrder={updateOrder}>
