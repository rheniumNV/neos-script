import { member, Member, Component } from "../../../core";
    ...
    export interface AddMulti_Double4Input {
...
Operands?: member<any>;
    ...
    export function AddMulti_Double4(props: AddMulti_Double4Input){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
Operands, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Operators.AddMulti_Double4" id={id} persistentId={persistentId} updateOrder={updateOrder}>
