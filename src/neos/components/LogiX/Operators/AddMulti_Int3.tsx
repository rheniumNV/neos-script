import { member, Member, Component } from "../../../core";
    ...
    export interface AddMulti_Int3Input {
...
Operands?: member<any>;
    ...
    export function AddMulti_Int3(props: AddMulti_Int3Input){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
Operands, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Operators.AddMulti_Int3" id={id} persistentId={persistentId} updateOrder={updateOrder}>
