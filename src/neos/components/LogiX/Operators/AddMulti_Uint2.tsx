import { member, Member, Component } from "../../../core";
    ...
    export interface AddMulti_Uint2Input {
...
Operands?: member<any>;
    ...
    export function AddMulti_Uint2(props: AddMulti_Uint2Input){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
Operands, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Operators.AddMulti_Uint2" id={id} persistentId={persistentId} updateOrder={updateOrder}>
