import { member, Member, Component } from "../../../core";
    ...
    export interface Construct_Float2Input {
...
Y?: member<any>;
    ...
    export function Construct_Float2(props: Construct_Float2Input){
...
Y, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.Operators.Construct_Float2" id={id} persistentId={persistentId} updateOrder={updateOrder}>
