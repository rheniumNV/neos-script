import { member, Member, Component } from "../../../core";
    ...
    export interface Construct_Float3Input {
...
Z?: member<any>;
    ...
    export function Construct_Float3(props: Construct_Float3Input){
...
Z, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.Operators.Construct_Float3" id={id} persistentId={persistentId} updateOrder={updateOrder}>
