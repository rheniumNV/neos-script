...
<Member type={`FrooxEngine.LogiX.Input\`1[System.UInt64]`} name="W" id={typeof W === "object" && "id" in W ? W?.id : undefined} value={typeof W === "object" && "value" in W ? W?.value : W} /* default: ID0 */  isRaw={typeof W === "object" && "isRaw" in W && W.isRaw ? true : undefined} />
        </Component>
      );
    };
