import { member, Member, Component } from "../../../core";
    ...
    export interface Cube_FloatInput {
...
X?: member<any>;
    ...
    export function Cube_Float(props: Cube_FloatInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
X, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Operators.Cube_Float" id={id} persistentId={persistentId} updateOrder={updateOrder}>
