import { member, Member, Component } from "../../../core";
    ...
    export interface Cube_UlongInput {
...
X?: member<any>;
    ...
    export function Cube_Ulong(props: Cube_UlongInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
X, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Operators.Cube_Ulong" id={id} persistentId={persistentId} updateOrder={updateOrder}>
