...
A?: member<any>;
    ...
    export function Dec_Int(props: Dec_IntInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
A, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Operators.Dec_Int" id={id} persistentId={persistentId} updateOrder={updateOrder}>
