import { member, Member, Component } from "../../../core";
    ...
    export interface Equals_StringInput {
...
B?: member<any>;
    ...
    export function Equals_String(props: Equals_StringInput){
...
B, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.Operators.Equals_String" id={id} persistentId={persistentId} updateOrder={updateOrder}>
