...
<Member type={`FrooxEngine.LogiX.Input\`1[System.Single]`} name="Fallback" id={typeof Fallback === "object" && "id" in Fallback ? Fallback?.id : undefined} value={typeof Fallback === "object" && "value" in Fallback ? Fallback?.value : Fallback} /* default: ID0 */  isRaw={typeof Fallback === "object" && "isRaw" in Fallback && Fallback.isRaw ? true : undefined} />
        </Component>
      );
    };
