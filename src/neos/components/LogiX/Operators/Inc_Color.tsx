...
A?: member<any>;
    ...
    export function Inc_Color(props: Inc_ColorInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
A, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Operators.Inc_Color" id={id} persistentId={persistentId} updateOrder={updateOrder}>
