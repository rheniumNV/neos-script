...
A?: member<any>;
    ...
    export function Inc_Int(props: Inc_IntInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
A, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Operators.Inc_Int" id={id} persistentId={persistentId} updateOrder={updateOrder}>
