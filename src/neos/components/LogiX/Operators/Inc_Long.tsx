import { member, Member, Component } from "../../../core";
    ...
    export interface Inc_LongInput {
...
A?: member<any>;
    ...
    export function Inc_Long(props: Inc_LongInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
A, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Operators.Inc_Long" id={id} persistentId={persistentId} updateOrder={updateOrder}>
