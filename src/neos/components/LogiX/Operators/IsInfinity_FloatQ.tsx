import { member, Member, Component } from "../../../core";
    ...
    export interface IsInfinity_FloatQInput {
...
Value?: member<[number, number, number, number]>;
    ...
    export function IsInfinity_FloatQ(props: IsInfinity_FloatQInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
Value, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Operators.IsInfinity_FloatQ" id={id} persistentId={persistentId} updateOrder={updateOrder}>
