import { member, Member, Component } from "../../../core";
    ...
    export interface IsNaN_FloatQInput {
...
Value?: member<[number, number, number, number]>;
    ...
    export function IsNaN_FloatQ(props: IsNaN_FloatQInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
Value, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Operators.IsNaN_FloatQ" id={id} persistentId={persistentId} updateOrder={updateOrder}>
