import { member, Member, Component } from "../../../core";
    ...
    export interface MulMulti_Double4Input {
...
Operands?: member<any>;
    ...
    export function MulMulti_Double4(props: MulMulti_Double4Input){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
Operands, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Operators.MulMulti_Double4" id={id} persistentId={persistentId} updateOrder={updateOrder}>
