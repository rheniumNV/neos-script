import { member, Member, Component } from "../../../core";
    ...
    export interface MulMulti_Int3Input {
...
Operands?: member<any>;
    ...
    export function MulMulti_Int3(props: MulMulti_Int3Input){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
Operands, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Operators.MulMulti_Int3" id={id} persistentId={persistentId} updateOrder={updateOrder}>
