import { member, Member, Component } from "../../../core";
    ...
    export interface MulMulti_Ulong2Input {
...
Operands?: member<any>;
    ...
    export function MulMulti_Ulong2(props: MulMulti_Ulong2Input){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
Operands, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Operators.MulMulti_Ulong2" id={id} persistentId={persistentId} updateOrder={updateOrder}>
