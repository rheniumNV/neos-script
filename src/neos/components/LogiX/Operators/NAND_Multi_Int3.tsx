import { member, Member, Component } from "../../../core";
    ...
    export interface NAND_Multi_Int3Input {
...
Operands?: member<any>;
    ...
    export function NAND_Multi_Int3(props: NAND_Multi_Int3Input){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
Operands, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Operators.NAND_Multi_Int3" id={id} persistentId={persistentId} updateOrder={updateOrder}>
