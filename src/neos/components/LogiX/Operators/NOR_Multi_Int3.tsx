import { member, Member, Component } from "../../../core";
    ...
    export interface NOR_Multi_Int3Input {
...
Operands?: member<any>;
    ...
    export function NOR_Multi_Int3(props: NOR_Multi_Int3Input){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
Operands, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Operators.NOR_Multi_Int3" id={id} persistentId={persistentId} updateOrder={updateOrder}>
