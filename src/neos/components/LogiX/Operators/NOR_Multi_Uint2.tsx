import { member, Member, Component } from "../../../core";
    ...
    export interface NOR_Multi_Uint2Input {
...
Operands?: member<any>;
    ...
    export function NOR_Multi_Uint2(props: NOR_Multi_Uint2Input){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
Operands, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Operators.NOR_Multi_Uint2" id={id} persistentId={persistentId} updateOrder={updateOrder}>
