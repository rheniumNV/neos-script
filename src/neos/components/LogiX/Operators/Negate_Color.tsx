import { member, Member, Component } from "../../../core";
    ...
    export interface Negate_ColorInput {
...
A?: member<any>;
    ...
    export function Negate_Color(props: Negate_ColorInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
A, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Operators.Negate_Color" id={id} persistentId={persistentId} updateOrder={updateOrder}>
