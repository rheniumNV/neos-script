...
A?: member<any>;
    ...
    export function Negate_Long(props: Negate_LongInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
A, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Operators.Negate_Long" id={id} persistentId={persistentId} updateOrder={updateOrder}>
