import { member, Member, Component } from "../../../core";
    ...
    export interface NotEquals_StringInput {
...
B?: member<any>;
    ...
    export function NotEquals_String(props: NotEquals_StringInput){
...
B, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.Operators.NotEquals_String" id={id} persistentId={persistentId} updateOrder={updateOrder}>
