import { member, Member, Component } from "../../../../core";
    ...
    export interface Parse_Bool3Input {
...
Str?: member<any>;
    ...
    export function Parse_Bool3(props: Parse_Bool3Input){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
Str, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Operators.Parse_Bool3" id={id} persistentId={persistentId} updateOrder={updateOrder}>
