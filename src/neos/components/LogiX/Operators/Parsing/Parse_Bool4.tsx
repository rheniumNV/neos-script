import { member, Member, Component } from "../../../../core";
    ...
    export interface Parse_Bool4Input {
...
Str?: member<any>;
    ...
    export function Parse_Bool4(props: Parse_Bool4Input){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
Str, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Operators.Parse_Bool4" id={id} persistentId={persistentId} updateOrder={updateOrder}>
