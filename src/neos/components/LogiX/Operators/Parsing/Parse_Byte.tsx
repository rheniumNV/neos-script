import { member, Member, Component } from "../../../../core";
    ...
    export interface Parse_ByteInput {
...
Str?: member<any>;
    ...
    export function Parse_Byte(props: Parse_ByteInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
Str, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Operators.Parse_Byte" id={id} persistentId={persistentId} updateOrder={updateOrder}>
