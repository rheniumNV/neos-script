import { member, Member, Component } from "../../../../core";
    ...
    export interface Parse_DateTimeInput {
...
Str?: member<any>;
    ...
    export function Parse_DateTime(props: Parse_DateTimeInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
Str, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Operators.Parse_DateTime" id={id} persistentId={persistentId} updateOrder={updateOrder}>
