...
Str?: member<any>;
    ...
    export function Parse_Decimal(props: Parse_DecimalInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
Str, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Operators.Parse_Decimal" id={id} persistentId={persistentId} updateOrder={updateOrder}>
