import { member, Member, Component } from "../../../../core";
    ...
    export interface Parse_DoubleInput {
...
FormatProvider?: member<any>;
    ...
    export function Parse_Double(props: Parse_DoubleInput){
...
FormatProvider, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.Operators.Parse_Double" id={id} persistentId={persistentId} updateOrder={updateOrder}>
