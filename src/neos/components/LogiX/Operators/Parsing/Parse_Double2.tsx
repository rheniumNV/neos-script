import { member, Member, Component } from "../../../../core";
    ...
    export interface Parse_Double2Input {
...
FormatProvider?: member<any>;
    ...
    export function Parse_Double2(props: Parse_Double2Input){
...
FormatProvider, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.Operators.Parse_Double2" id={id} persistentId={persistentId} updateOrder={updateOrder}>
