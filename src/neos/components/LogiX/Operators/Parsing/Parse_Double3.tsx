import { member, Member, Component } from "../../../../core";
    ...
    export interface Parse_Double3Input {
...
FormatProvider?: member<any>;
    ...
    export function Parse_Double3(props: Parse_Double3Input){
...
FormatProvider, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.Operators.Parse_Double3" id={id} persistentId={persistentId} updateOrder={updateOrder}>
