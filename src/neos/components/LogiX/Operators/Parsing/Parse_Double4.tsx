import { member, Member, Component } from "../../../../core";
    ...
    export interface Parse_Double4Input {
...
FormatProvider?: member<any>;
    ...
    export function Parse_Double4(props: Parse_Double4Input){
...
FormatProvider, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.Operators.Parse_Double4" id={id} persistentId={persistentId} updateOrder={updateOrder}>
