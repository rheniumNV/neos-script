import { member, Member, Component } from "../../../../core";
    ...
    export interface Parse_DoubleQInput {
...
FormatProvider?: member<any>;
    ...
    export function Parse_DoubleQ(props: Parse_DoubleQInput){
...
FormatProvider, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.Operators.Parse_DoubleQ" id={id} persistentId={persistentId} updateOrder={updateOrder}>
