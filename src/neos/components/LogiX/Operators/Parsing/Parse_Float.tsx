import { member, Member, Component } from "../../../../core";
    ...
    export interface Parse_FloatInput {
...
FormatProvider?: member<any>;
    ...
    export function Parse_Float(props: Parse_FloatInput){
...
FormatProvider, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.Operators.Parse_Float" id={id} persistentId={persistentId} updateOrder={updateOrder}>
