import { member, Member, Component } from "../../../../core";
    ...
    export interface Parse_Float2Input {
...
FormatProvider?: member<any>;
    ...
    export function Parse_Float2(props: Parse_Float2Input){
...
FormatProvider, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.Operators.Parse_Float2" id={id} persistentId={persistentId} updateOrder={updateOrder}>
