import { member, Member, Component } from "../../../../core";
    ...
    export interface Parse_Float3Input {
...
FormatProvider?: member<any>;
    ...
    export function Parse_Float3(props: Parse_Float3Input){
...
FormatProvider, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.Operators.Parse_Float3" id={id} persistentId={persistentId} updateOrder={updateOrder}>
