import { member, Member, Component } from "../../../../core";
    ...
    export interface Parse_Float4Input {
...
FormatProvider?: member<any>;
    ...
    export function Parse_Float4(props: Parse_Float4Input){
...
FormatProvider, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.Operators.Parse_Float4" id={id} persistentId={persistentId} updateOrder={updateOrder}>
