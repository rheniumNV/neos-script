import { member, Member, Component } from "../../../../core";
    ...
    export interface Parse_FloatQInput {
...
FormatProvider?: member<any>;
    ...
    export function Parse_FloatQ(props: Parse_FloatQInput){
...
FormatProvider, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.Operators.Parse_FloatQ" id={id} persistentId={persistentId} updateOrder={updateOrder}>
