import { member, Member, Component } from "../../../../core";
    ...
    export interface Parse_IntInput {
...
FormatProvider?: member<any>;
    ...
    export function Parse_Int(props: Parse_IntInput){
...
FormatProvider, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.Operators.Parse_Int" id={id} persistentId={persistentId} updateOrder={updateOrder}>
