import { member, Member, Component } from "../../../../core";
    ...
    export interface Parse_Int2Input {
...
FormatProvider?: member<any>;
    ...
    export function Parse_Int2(props: Parse_Int2Input){
...
FormatProvider, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.Operators.Parse_Int2" id={id} persistentId={persistentId} updateOrder={updateOrder}>
