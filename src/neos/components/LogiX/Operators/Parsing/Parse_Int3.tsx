import { member, Member, Component } from "../../../../core";
    ...
    export interface Parse_Int3Input {
...
FormatProvider?: member<any>;
    ...
    export function Parse_Int3(props: Parse_Int3Input){
...
FormatProvider, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.Operators.Parse_Int3" id={id} persistentId={persistentId} updateOrder={updateOrder}>
