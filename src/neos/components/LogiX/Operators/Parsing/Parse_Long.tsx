import { member, Member, Component } from "../../../../core";
    ...
    export interface Parse_LongInput {
...
FormatProvider?: member<any>;
    ...
    export function Parse_Long(props: Parse_LongInput){
...
FormatProvider, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.Operators.Parse_Long" id={id} persistentId={persistentId} updateOrder={updateOrder}>
