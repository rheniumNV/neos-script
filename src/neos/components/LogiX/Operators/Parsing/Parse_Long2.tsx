import { member, Member, Component } from "../../../../core";
    ...
    export interface Parse_Long2Input {
...
FormatProvider?: member<any>;
    ...
    export function Parse_Long2(props: Parse_Long2Input){
...
FormatProvider, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.Operators.Parse_Long2" id={id} persistentId={persistentId} updateOrder={updateOrder}>
