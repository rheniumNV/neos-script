import { member, Member, Component } from "../../../../core";
    ...
    export interface Parse_Long3Input {
...
FormatProvider?: member<any>;
    ...
    export function Parse_Long3(props: Parse_Long3Input){
...
FormatProvider, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.Operators.Parse_Long3" id={id} persistentId={persistentId} updateOrder={updateOrder}>
