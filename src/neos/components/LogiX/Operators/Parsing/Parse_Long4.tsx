import { member, Member, Component } from "../../../../core";
    ...
    export interface Parse_Long4Input {
...
FormatProvider?: member<any>;
    ...
    export function Parse_Long4(props: Parse_Long4Input){
...
FormatProvider, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.Operators.Parse_Long4" id={id} persistentId={persistentId} updateOrder={updateOrder}>
