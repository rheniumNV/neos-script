import { member, Member, Component } from "../../../../core";
    ...
    export interface Parse_ShortInput {
...
Str?: member<any>;
    ...
    export function Parse_Short(props: Parse_ShortInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
Str, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Operators.Parse_Short" id={id} persistentId={persistentId} updateOrder={updateOrder}>
