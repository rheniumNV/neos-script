import { member, Member, Component } from "../../../../core";
    ...
    export interface Parse_UintInput {
...
FormatProvider?: member<any>;
    ...
    export function Parse_Uint(props: Parse_UintInput){
...
FormatProvider, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.Operators.Parse_Uint" id={id} persistentId={persistentId} updateOrder={updateOrder}>
