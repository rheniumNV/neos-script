import { member, Member, Component } from "../../../../core";
    ...
    export interface Parse_Uint2Input {
...
FormatProvider?: member<any>;
    ...
    export function Parse_Uint2(props: Parse_Uint2Input){
...
FormatProvider, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.Operators.Parse_Uint2" id={id} persistentId={persistentId} updateOrder={updateOrder}>
