import { member, Member, Component } from "../../../../core";
    ...
    export interface Parse_Uint3Input {
...
FormatProvider?: member<any>;
    ...
    export function Parse_Uint3(props: Parse_Uint3Input){
...
FormatProvider, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.Operators.Parse_Uint3" id={id} persistentId={persistentId} updateOrder={updateOrder}>
