import { member, Member, Component } from "../../../../core";
    ...
    export interface Parse_UlongInput {
...
FormatProvider?: member<any>;
    ...
    export function Parse_Ulong(props: Parse_UlongInput){
...
FormatProvider, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.Operators.Parse_Ulong" id={id} persistentId={persistentId} updateOrder={updateOrder}>
