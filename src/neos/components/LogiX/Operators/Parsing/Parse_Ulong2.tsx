import { member, Member, Component } from "../../../../core";
    ...
    export interface Parse_Ulong2Input {
...
FormatProvider?: member<any>;
    ...
    export function Parse_Ulong2(props: Parse_Ulong2Input){
...
FormatProvider, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.Operators.Parse_Ulong2" id={id} persistentId={persistentId} updateOrder={updateOrder}>
