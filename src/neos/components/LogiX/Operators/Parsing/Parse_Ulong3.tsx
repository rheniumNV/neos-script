import { member, Member, Component } from "../../../../core";
    ...
    export interface Parse_Ulong3Input {
...
FormatProvider?: member<any>;
    ...
    export function Parse_Ulong3(props: Parse_Ulong3Input){
...
FormatProvider, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.Operators.Parse_Ulong3" id={id} persistentId={persistentId} updateOrder={updateOrder}>
