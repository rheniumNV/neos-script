import { member, Member, Component } from "../../../../core";
    ...
    export interface Parse_Ulong4Input {
...
FormatProvider?: member<any>;
    ...
    export function Parse_Ulong4(props: Parse_Ulong4Input){
...
FormatProvider, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.Operators.Parse_Ulong4" id={id} persistentId={persistentId} updateOrder={updateOrder}>
