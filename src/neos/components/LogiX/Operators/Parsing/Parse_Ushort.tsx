import { member, Member, Component } from "../../../../core";
    ...
    export interface Parse_UshortInput {
...
Str?: member<any>;
    ...
    export function Parse_Ushort(props: Parse_UshortInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
Str, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Operators.Parse_Ushort" id={id} persistentId={persistentId} updateOrder={updateOrder}>
