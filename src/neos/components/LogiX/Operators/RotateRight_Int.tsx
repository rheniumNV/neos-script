import { member, Member, Component } from "../../../core";
    ...
    export interface RotateRight_IntInput {
...
Rotate?: member<any>;
    ...
    export function RotateRight_Int(props: RotateRight_IntInput){
...
Rotate, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.Operators.RotateRight_Int" id={id} persistentId={persistentId} updateOrder={updateOrder}>
