...
Rotate?: member<any>;
    ...
    export function RotateRight_Long(props: RotateRight_LongInput){
...
Rotate, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.Operators.RotateRight_Long" id={id} persistentId={persistentId} updateOrder={updateOrder}>
