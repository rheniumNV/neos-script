import { member, Member, Component } from "../../../core";
    ...
    export interface ShiftLeft_IntInput {
...
Shift?: member<any>;
    ...
    export function ShiftLeft_Int(props: ShiftLeft_IntInput){
...
Shift, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.Operators.ShiftLeft_Int" id={id} persistentId={persistentId} updateOrder={updateOrder}>
