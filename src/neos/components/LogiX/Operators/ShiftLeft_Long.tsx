import { member, Member, Component } from "../../../core";
    ...
    export interface ShiftLeft_LongInput {
...
Shift?: member<any>;
    ...
    export function ShiftLeft_Long(props: ShiftLeft_LongInput){
...
Shift, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.Operators.ShiftLeft_Long" id={id} persistentId={persistentId} updateOrder={updateOrder}>
