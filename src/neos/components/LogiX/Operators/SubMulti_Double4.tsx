import { member, Member, Component } from "../../../core";
    ...
    export interface SubMulti_Double4Input {
...
Operands?: member<any>;
    ...
    export function SubMulti_Double4(props: SubMulti_Double4Input){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
Operands, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Operators.SubMulti_Double4" id={id} persistentId={persistentId} updateOrder={updateOrder}>
