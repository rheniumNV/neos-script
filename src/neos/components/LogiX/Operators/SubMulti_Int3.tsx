import { member, Member, Component } from "../../../core";
    ...
    export interface SubMulti_Int3Input {
...
Operands?: member<any>;
    ...
    export function SubMulti_Int3(props: SubMulti_Int3Input){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
Operands, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Operators.SubMulti_Int3" id={id} persistentId={persistentId} updateOrder={updateOrder}>
