import { member, Member, Component } from "../../../core";
    ...
    export interface SubMulti_Uint2Input {
...
Operands?: member<any>;
    ...
    export function SubMulti_Uint2(props: SubMulti_Uint2Input){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
Operands, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Operators.SubMulti_Uint2" id={id} persistentId={persistentId} updateOrder={updateOrder}>
