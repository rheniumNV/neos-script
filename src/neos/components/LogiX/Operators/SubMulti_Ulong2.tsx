import { member, Member, Component } from "../../../core";
    ...
    export interface SubMulti_Ulong2Input {
...
Operands?: member<any>;
    ...
    export function SubMulti_Ulong2(props: SubMulti_Ulong2Input){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
Operands, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Operators.SubMulti_Ulong2" id={id} persistentId={persistentId} updateOrder={updateOrder}>
