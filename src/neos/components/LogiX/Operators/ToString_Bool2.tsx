import { member, Member, Component } from "../../../core";
    ...
    export interface ToString_Bool2Input {
...
FormatProvider?: member<any>;
    ...
    export function ToString_Bool2(props: ToString_Bool2Input){
...
FormatProvider, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.Operators.ToString_Bool2" id={id} persistentId={persistentId} updateOrder={updateOrder}>
