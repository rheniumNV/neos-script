import { member, Member, Component } from "../../../core";
    ...
    export interface ToString_Bool4Input {
...
FormatProvider?: member<any>;
    ...
    export function ToString_Bool4(props: ToString_Bool4Input){
...
FormatProvider, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.Operators.ToString_Bool4" id={id} persistentId={persistentId} updateOrder={updateOrder}>
...
<Member type={`FrooxEngine.LogiX.Input\`1[BaseX.bool4]`} name="V" id={typeof V === "object" && "id" in V ? V?.id : undefined} value={typeof V === "object" && "value" in V ? V?.value : V} /* default: ID0 */  isRaw={typeof V === "object" && "isRaw" in V && V.isRaw ? true : undefined} />
