import { member, Member, Component } from "../../../core";
    ...
    export interface ToString_Double2Input {
...
FormatProvider?: member<any>;
    ...
    export function ToString_Double2(props: ToString_Double2Input){
...
FormatProvider, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.Operators.ToString_Double2" id={id} persistentId={persistentId} updateOrder={updateOrder}>
