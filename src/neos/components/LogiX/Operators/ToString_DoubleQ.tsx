import { member, Member, Component } from "../../../core";
    ...
    export interface ToString_DoubleQInput {
...
FormatProvider?: member<any>;
    ...
    export function ToString_DoubleQ(props: ToString_DoubleQInput){
...
FormatProvider, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.Operators.ToString_DoubleQ" id={id} persistentId={persistentId} updateOrder={updateOrder}>
