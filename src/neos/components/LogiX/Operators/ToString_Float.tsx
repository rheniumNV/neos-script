import { member, Member, Component } from "../../../core";
    ...
    export interface ToString_FloatInput {
...
FormatProvider?: member<any>;
    ...
    export function ToString_Float(props: ToString_FloatInput){
...
FormatProvider, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.Operators.ToString_Float" id={id} persistentId={persistentId} updateOrder={updateOrder}>
