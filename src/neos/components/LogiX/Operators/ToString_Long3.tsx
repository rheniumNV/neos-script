import { member, Member, Component } from "../../../core";
    ...
    export interface ToString_Long3Input {
...
FormatProvider?: member<any>;
    ...
    export function ToString_Long3(props: ToString_Long3Input){
...
FormatProvider, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.Operators.ToString_Long3" id={id} persistentId={persistentId} updateOrder={updateOrder}>
