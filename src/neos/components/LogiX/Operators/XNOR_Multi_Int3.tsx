import { member, Member, Component } from "../../../core";
    ...
    export interface XNOR_Multi_Int3Input {
...
Operands?: member<any>;
    ...
    export function XNOR_Multi_Int3(props: XNOR_Multi_Int3Input){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
Operands, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Operators.XNOR_Multi_Int3" id={id} persistentId={persistentId} updateOrder={updateOrder}>
