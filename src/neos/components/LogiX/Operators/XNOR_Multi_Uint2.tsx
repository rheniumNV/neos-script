import { member, Member, Component } from "../../../core";
    ...
    export interface XNOR_Multi_Uint2Input {
...
Operands?: member<any>;
    ...
    export function XNOR_Multi_Uint2(props: XNOR_Multi_Uint2Input){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
Operands, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Operators.XNOR_Multi_Uint2" id={id} persistentId={persistentId} updateOrder={updateOrder}>
