import { member, Member, Component } from "../../../core";
    ...
    export interface XOR_Multi_Int3Input {
...
Operands?: member<any>;
    ...
    export function XOR_Multi_Int3(props: XOR_Multi_Int3Input){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
Operands, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Operators.XOR_Multi_Int3" id={id} persistentId={persistentId} updateOrder={updateOrder}>
