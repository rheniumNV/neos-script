import { member, Member, Component } from "../../../core";
    ...
    export interface CharacterControllerUserInput {
...
Character?: member<any>;
    ...
    export function CharacterControllerUser(props: CharacterControllerUserInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
Character, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Physics.CharacterControllerUser" id={id} persistentId={persistentId} updateOrder={updateOrder}>
