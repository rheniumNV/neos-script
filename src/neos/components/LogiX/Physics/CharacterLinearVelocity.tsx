import { member, Member, Component } from "../../../core";
    ...
    export interface CharacterLinearVelocityInput {
...
Character?: member<any>;
    ...
    export function CharacterLinearVelocity(props: CharacterLinearVelocityInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
Character, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Physics.CharacterLinearVelocity" id={id} persistentId={persistentId} updateOrder={updateOrder}>
