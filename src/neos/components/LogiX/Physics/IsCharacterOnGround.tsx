import { member, Member, Component } from "../../../core";
    ...
    export interface IsCharacterOnGroundInput {
...
Character?: member<any>;
    ...
    export function IsCharacterOnGround(props: IsCharacterOnGroundInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
Character, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Physics.IsCharacterOnGround" id={id} persistentId={persistentId} updateOrder={updateOrder}>
