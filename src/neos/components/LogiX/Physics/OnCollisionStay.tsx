import { member, Member, Component } from "../../../core";
    ...
    export interface OnCollisionStayInput {
...
OnEvent?: member<any>;
    ...
    export function OnCollisionStay(props: OnCollisionStayInput){
...
OnEvent, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.Physics.OnCollisionStay" id={id} persistentId={persistentId} updateOrder={updateOrder}>
