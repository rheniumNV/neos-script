...
<Member type={`FrooxEngine.LogiX.Input\`1[System.Single]`} name="DebugDuration" id={typeof DebugDuration === "object" && "id" in DebugDuration ? DebugDuration?.id : undefined} value={typeof DebugDuration === "object" && "value" in DebugDuration ? DebugDuration?.value : DebugDuration} /* default: ID0 */  isRaw={typeof DebugDuration === "object" && "isRaw" in DebugDuration && DebugDuration.isRaw ? true : undefined} />
...
<Member type={`FrooxEngine.LogiX.Impulse`} name="OnHit" id={typeof OnHit === "object" && "id" in OnHit ? OnHit?.id : undefined} value={typeof OnHit === "object" && "value" in OnHit ? OnHit?.value : OnHit} /* default: FrooxEngine.WorldDelegate */  isRaw={typeof OnHit === "object" && "isRaw" in OnHit && OnHit.isRaw ? true : undefined} />
<Member type={`FrooxEngine.LogiX.Impulse`} name="OnMiss" id={typeof OnMiss === "object" && "id" in OnMiss ? OnMiss?.id : undefined} value={typeof OnMiss === "object" && "value" in OnMiss ? OnMiss?.value : OnMiss} /* default: FrooxEngine.WorldDelegate */  isRaw={typeof OnMiss === "object" && "isRaw" in OnMiss && OnMiss.isRaw ? true : undefined} />
        </Component>
      );
    };
