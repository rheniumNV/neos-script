import { member, Member, Component } from "../../../core";
    ...
    export interface SetCharacterGravityInput {
...
OnDone?: member<any>;
    ...
    export function SetCharacterGravity(props: SetCharacterGravityInput){
...
OnDone, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.Physics.SetCharacterGravity" id={id} persistentId={persistentId} updateOrder={updateOrder}>
