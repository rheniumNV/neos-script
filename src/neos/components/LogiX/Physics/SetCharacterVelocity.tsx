...
<Member type={`FrooxEngine.LogiX.Input\`1[BaseX.float3]`} name="Velocity" id={typeof Velocity === "object" && "id" in Velocity ? Velocity?.id : undefined} value={typeof Velocity === "object" && "value" in Velocity ? Velocity?.value : Velocity} /* default: ID0 */  isRaw={typeof Velocity === "object" && "isRaw" in Velocity && Velocity.isRaw ? true : undefined} />
