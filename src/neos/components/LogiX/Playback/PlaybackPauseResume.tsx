import { member, Member, Component } from "../../../core";
    ...
    export interface PlaybackPauseResumeInput {
...
OnDone?: member<any>;
    ...
    export function PlaybackPauseResume(props: PlaybackPauseResumeInput){
...
OnDone, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.Playback.PlaybackPauseResume" id={id} persistentId={persistentId} updateOrder={updateOrder}>
