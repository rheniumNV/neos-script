import { member, Member, Component } from "../../../core";
    ...
    export interface PlaybackPlayInput {
...
OnDone?: member<any>;
    ...
    export function PlaybackPlay(props: PlaybackPlayInput){
...
OnDone, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.Playback.PlaybackPlay" id={id} persistentId={persistentId} updateOrder={updateOrder}>
