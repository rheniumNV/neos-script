...
OnDone?: member<any>;
    ...
    export function PlaybackResume(props: PlaybackResumeInput){
...
OnDone, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.Playback.PlaybackResume" id={id} persistentId={persistentId} updateOrder={updateOrder}>
