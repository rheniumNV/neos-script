import { member, Member, Component } from "../../../core";
    ...
    export interface PlaybackSetPositionInput {
...
Position?: member<any>;
    ...
    export function PlaybackSetPosition(props: PlaybackSetPositionInput){
...
Position, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.Playback.PlaybackSetPosition" id={id} persistentId={persistentId} updateOrder={updateOrder}>
...
<Member type={`FrooxEngine.LogiX.Input\`1[System.Single]`} name="Position" id={typeof Position === "object" && "id" in Position ? Position?.id : undefined} value={typeof Position === "object" && "value" in Position ? Position?.value : Position} /* default: ID0 */  isRaw={typeof Position === "object" && "isRaw" in Position && Position.isRaw ? true : undefined} />
        </Component>
      );
    };
