import { member, Member, Component } from "../../../core";
    ...
    export interface PlaybackStopInput {
...
OnDone?: member<any>;
    ...
    export function PlaybackStop(props: PlaybackStopInput){
...
OnDone, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.Playback.PlaybackStop" id={id} persistentId={persistentId} updateOrder={updateOrder}>
