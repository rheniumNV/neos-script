...
<Member type={`FrooxEngine.LogiX.Input\`1[System.Single]`} name="NearClip" id={typeof NearClip === "object" && "id" in NearClip ? NearClip?.id : undefined} value={typeof NearClip === "object" && "value" in NearClip ? NearClip?.value : NearClip} /* default: ID0 */  />
<Member type={`FrooxEngine.LogiX.Input\`1[System.Single]`} name="FarClip" id={typeof FarClip === "object" && "id" in FarClip ? FarClip?.id : undefined} value={typeof FarClip === "object" && "value" in FarClip ? FarClip?.value : FarClip} /* default: ID0 */  />
<Member type={`FrooxEngine.LogiX.Impulse`} name="OnSampleStart" id={typeof OnSampleStart === "object" && "id" in OnSampleStart ? OnSampleStart?.id : undefined} value={typeof OnSampleStart === "object" && "value" in OnSampleStart ? OnSampleStart?.value : OnSampleStart} /* default: FrooxEngine.WorldDelegate */  />
<Member type={`FrooxEngine.LogiX.Impulse`} name="OnSampled" id={typeof OnSampled === "object" && "id" in OnSampled ? OnSampled?.id : undefined} value={typeof OnSampled === "object" && "value" in OnSampled ? OnSampled?.value : OnSampled} /* default: FrooxEngine.WorldDelegate */  />
        </Component>
      );
    };
