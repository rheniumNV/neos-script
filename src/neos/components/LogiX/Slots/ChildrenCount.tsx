import { member, Member, Component } from "../../../core";
    ...
    export interface ChildrenCountInput {
...
Instance?: member<any>;
    ...
    export function ChildrenCount(props: ChildrenCountInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
Instance, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.WorldModel.ChildrenCount" id={id} persistentId={persistentId} updateOrder={updateOrder}>
