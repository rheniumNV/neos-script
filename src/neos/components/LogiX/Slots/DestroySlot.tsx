import { member, Member, Component } from "../../../core";
    ...
    export interface DestroySlotInput {
...
SendDestroyingEvent?: member<any>;
OnDone?: member<any>;
    }
    
    export function DestroySlot(props: DestroySlotInput){
...
OnDone, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.WorldModel.DestroySlot" id={id} persistentId={persistentId} updateOrder={updateOrder}>
...
<Member type={`FrooxEngine.LogiX.Input\`1[System.Boolean]`} name="SendDestroyingEvent" id={typeof SendDestroyingEvent === "object" && "id" in SendDestroyingEvent ? SendDestroyingEvent?.id : undefined} value={typeof SendDestroyingEvent === "object" && "value" in SendDestroyingEvent ? SendDestroyingEvent?.value : SendDestroyingEvent} /* default: ID0 */  isRaw={typeof SendDestroyingEvent === "object" && "isRaw" in SendDestroyingEvent && SendDestroyingEvent.isRaw ? true : undefined} />
