import { member, Member, Component } from "../../../core";
    ...
    export interface FindParentByNameInput {
...
IgnoreCase?: member<any>;
    ...
    export function FindParentByName(props: FindParentByNameInput){
...
IgnoreCase, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.WorldModel.FindParentByName" id={id} persistentId={persistentId} updateOrder={updateOrder}>
...
<Member type={`FrooxEngine.LogiX.Input\`1[System.String]`} name="Name" id={typeof Name === "object" && "id" in Name ? Name?.id : undefined} value={typeof Name === "object" && "value" in Name ? Name?.value : Name} /* default: ID0 */  />
<Member type={`FrooxEngine.LogiX.Input\`1[System.Boolean]`} name="MatchSubstring" id={typeof MatchSubstring === "object" && "id" in MatchSubstring ? MatchSubstring?.id : undefined} value={typeof MatchSubstring === "object" && "value" in MatchSubstring ? MatchSubstring?.value : MatchSubstring} /* default: ID0 */  />
