import { member, Member, Component } from "../../../core";
    ...
    export interface FindParentByTagInput {
...
SearchDepth?: member<any>;
    ...
    export function FindParentByTag(props: FindParentByTagInput){
...
SearchDepth, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.WorldModel.FindParentByTag" id={id} persistentId={persistentId} updateOrder={updateOrder}>
