import { member, Member, Component } from "../../../core";
    ...
    export interface GetActiveUserInput {
...
Instance?: member<any>;
    ...
    export function GetActiveUser(props: GetActiveUserInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
Instance, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.WorldModel.GetActiveUser" id={id} persistentId={persistentId} updateOrder={updateOrder}>
