import { member, Member, Component } from "../../../core";
    ...
    export interface GetObjectRootInput {
...
Instance?: member<any>;
    ...
    export function GetObjectRoot(props: GetObjectRootInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
Instance, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.WorldModel.GetObjectRoot" id={id} persistentId={persistentId} updateOrder={updateOrder}>
