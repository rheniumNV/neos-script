import { member, Member, Component } from "../../../core";
    ...
    export interface GetParentSlotInput {
...
Instance?: member<any>;
    ...
    export function GetParentSlot(props: GetParentSlotInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
Instance, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.WorldModel.GetParentSlot" id={id} persistentId={persistentId} updateOrder={updateOrder}>
