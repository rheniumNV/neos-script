import { member, Member, Component } from "../../../core";
    ...
    export interface GetSlotActiveInput {
...
Instance?: member<any>;
    ...
    export function GetSlotActive(props: GetSlotActiveInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
Instance, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.WorldModel.GetSlotActive" id={id} persistentId={persistentId} updateOrder={updateOrder}>
