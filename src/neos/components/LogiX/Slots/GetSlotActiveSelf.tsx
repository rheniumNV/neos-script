import { member, Member, Component } from "../../../core";
    ...
    export interface GetSlotActiveSelfInput {
...
Instance?: member<any>;
    ...
    export function GetSlotActiveSelf(props: GetSlotActiveSelfInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
Instance, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.WorldModel.GetSlotActiveSelf" id={id} persistentId={persistentId} updateOrder={updateOrder}>
