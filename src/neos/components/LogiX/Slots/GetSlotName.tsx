import { member, Member, Component } from "../../../core";
    ...
    export interface GetSlotNameInput {
...
Instance?: member<any>;
    ...
    export function GetSlotName(props: GetSlotNameInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
Instance, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.WorldModel.GetSlotName" id={id} persistentId={persistentId} updateOrder={updateOrder}>
