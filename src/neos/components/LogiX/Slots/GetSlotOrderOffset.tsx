import { member, Member, Component } from "../../../core";
    ...
    export interface GetSlotOrderOffsetInput {
...
Instance?: member<any>;
    ...
    export function GetSlotOrderOffset(props: GetSlotOrderOffsetInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
Instance, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.WorldModel.GetSlotOrderOffset" id={id} persistentId={persistentId} updateOrder={updateOrder}>
