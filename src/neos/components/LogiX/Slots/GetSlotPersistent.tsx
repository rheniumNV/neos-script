import { member, Member, Component } from "../../../core";
    ...
    export interface GetSlotPersistentInput {
...
Instance?: member<any>;
    ...
    export function GetSlotPersistent(props: GetSlotPersistentInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
Instance, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.WorldModel.GetSlotPersistent" id={id} persistentId={persistentId} updateOrder={updateOrder}>
