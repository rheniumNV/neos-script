...
Instance?: member<any>;
    ...
    export function GetSlotPersistentSelf(props: GetSlotPersistentSelfInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
Instance, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.WorldModel.GetSlotPersistentSelf" id={id} persistentId={persistentId} updateOrder={updateOrder}>
