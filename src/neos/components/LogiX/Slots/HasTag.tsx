...
Tag?: member<any>;
    ...
    export function HasTag(props: HasTagInput){
...
Tag, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.WorldModel.HasTag" id={id} persistentId={persistentId} updateOrder={updateOrder}>
