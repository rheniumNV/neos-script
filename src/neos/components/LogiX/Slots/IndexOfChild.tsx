import { member, Member, Component } from "../../../core";
    ...
    export interface IndexOfChildInput {
...
Instance?: member<any>;
    ...
    export function IndexOfChild(props: IndexOfChildInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
Instance, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.WorldModel.IndexOfChild" id={id} persistentId={persistentId} updateOrder={updateOrder}>
