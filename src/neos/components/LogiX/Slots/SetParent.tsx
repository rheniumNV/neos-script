...
<Member type={`FrooxEngine.LogiX.Input\`1[FrooxEngine.Slot]`} name="NewParent" id={typeof NewParent === "object" && "id" in NewParent ? NewParent?.id : undefined} value={typeof NewParent === "object" && "value" in NewParent ? NewParent?.value : NewParent} /* default: ID0 */  isRaw={typeof NewParent === "object" && "isRaw" in NewParent && NewParent.isRaw ? true : undefined} />
<Member type={`FrooxEngine.LogiX.Input\`1[System.Boolean]`} name="PreserveGlobalPosition" id={typeof PreserveGlobalPosition === "object" && "id" in PreserveGlobalPosition ? PreserveGlobalPosition?.id : undefined} value={typeof PreserveGlobalPosition === "object" && "value" in PreserveGlobalPosition ? PreserveGlobalPosition?.value : PreserveGlobalPosition} /* default: ID0 */  isRaw={typeof PreserveGlobalPosition === "object" && "isRaw" in PreserveGlobalPosition && PreserveGlobalPosition.isRaw ? true : undefined} />
