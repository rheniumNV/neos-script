...
<Member type={`FrooxEngine.LogiX.Input\`1[System.Int64]`} name="OrderOffset" id={typeof OrderOffset === "object" && "id" in OrderOffset ? OrderOffset?.id : undefined} value={typeof OrderOffset === "object" && "value" in OrderOffset ? OrderOffset?.value : OrderOffset} /* default: ID0 */  isRaw={typeof OrderOffset === "object" && "isRaw" in OrderOffset && OrderOffset.isRaw ? true : undefined} />
