...
Str?: member<any>;
    ...
    export function Capitalize(props: CapitalizeInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
Str, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.String.Capitalize" id={id} persistentId={persistentId} updateOrder={updateOrder}>
