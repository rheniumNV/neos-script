...
Index?: member<any>;
    ...
    export function GetCharacter(props: GetCharacterInput){
...
Index, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.String.Characters.GetCharacter" id={id} persistentId={persistentId} updateOrder={updateOrder}>
