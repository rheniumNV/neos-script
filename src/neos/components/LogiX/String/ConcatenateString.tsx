import { member, Member, Component } from "../../../core";
    ...
    export interface ConcatenateStringInput {
...
B?: member<any>;
    ...
    export function ConcatenateString(props: ConcatenateStringInput){
...
B, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.String.ConcatenateString" id={id} persistentId={persistentId} updateOrder={updateOrder}>
