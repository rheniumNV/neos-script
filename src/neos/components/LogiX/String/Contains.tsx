import { member, Member, Component } from "../../../core";
    ...
    export interface ContainsInput {
...
Substring?: member<any>;
    ...
    export function Contains(props: ContainsInput){
...
Substring, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.String.Contains" id={id} persistentId={persistentId} updateOrder={updateOrder}>
