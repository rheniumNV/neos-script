import { member, Member, Component } from "../../../core";
    ...
    export interface EscapeStringInput {
...
String?: member<any>;
    ...
    export function EscapeString(props: EscapeStringInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
String, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.String.EscapeString" id={id} persistentId={persistentId} updateOrder={updateOrder}>
