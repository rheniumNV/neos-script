import { member, Member, Component } from "../../../core";
    ...
    export interface GreaterOrEqual_StringInput {
...
ComparisonType?: member<any>;
    ...
    export function GreaterOrEqual_String(props: GreaterOrEqual_StringInput){
...
ComparisonType, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.String.GreaterOrEqual_String" id={id} persistentId={persistentId} updateOrder={updateOrder}>
