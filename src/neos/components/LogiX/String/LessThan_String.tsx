import { member, Member, Component } from "../../../core";
    ...
    export interface LessThan_StringInput {
...
ComparisonType?: member<any>;
    ...
    export function LessThan_String(props: LessThan_StringInput){
...
ComparisonType, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.String.LessThan_String" id={id} persistentId={persistentId} updateOrder={updateOrder}>
