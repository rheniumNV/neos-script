...
StartIndex?: member<any>;
    ...
    export function ReplaceFirstSubstring(props: ReplaceFirstSubstringInput){
...
StartIndex, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.String.ReplaceFirstSubstring" id={id} persistentId={persistentId} updateOrder={updateOrder}>
