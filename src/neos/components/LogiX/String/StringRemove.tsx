import { member, Member, Component } from "../../../core";
    ...
    export interface StringRemoveInput {
...
Length?: member<any>;
    ...
    export function StringRemove(props: StringRemoveInput){
...
Length, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.String.StringRemove" id={id} persistentId={persistentId} updateOrder={updateOrder}>
