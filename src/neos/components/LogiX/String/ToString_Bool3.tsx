import { member, Member, Component } from "../../../core";
    ...
    export interface ToString_Bool3Input {
...
FormatProvider?: member<any>;
    ...
    export function ToString_Bool3(props: ToString_Bool3Input){
...
FormatProvider, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.Operators.ToString_Bool3" id={id} persistentId={persistentId} updateOrder={updateOrder}>
