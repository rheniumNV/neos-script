import { member, Member, Component } from "../../../core";
    ...
    export interface ToString_ColorInput {
...
FormatProvider?: member<any>;
    ...
    export function ToString_Color(props: ToString_ColorInput){
...
FormatProvider, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.Operators.ToString_Color" id={id} persistentId={persistentId} updateOrder={updateOrder}>
