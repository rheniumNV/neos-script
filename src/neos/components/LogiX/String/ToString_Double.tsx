import { member, Member, Component } from "../../../core";
    ...
    export interface ToString_DoubleInput {
...
FormatProvider?: member<any>;
    ...
    export function ToString_Double(props: ToString_DoubleInput){
...
FormatProvider, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.Operators.ToString_Double" id={id} persistentId={persistentId} updateOrder={updateOrder}>
...
<Member type={`FrooxEngine.LogiX.Input\`1[System.Double]`} name="V" id={typeof V === "object" && "id" in V ? V?.id : undefined} value={typeof V === "object" && "value" in V ? V?.value : V} /* default: ID0 */  isRaw={typeof V === "object" && "isRaw" in V && V.isRaw ? true : undefined} />
