...
<Member type={`FrooxEngine.LogiX.Input\`1[BaseX.double2x2]`} name="V" id={typeof V === "object" && "id" in V ? V?.id : undefined} value={typeof V === "object" && "value" in V ? V?.value : V} /* default: ID0 */  />
