import { member, Member, Component } from "../../../core";
    ...
    export interface ToString_Double4Input {
...
FormatProvider?: member<any>;
    ...
    export function ToString_Double4(props: ToString_Double4Input){
...
FormatProvider, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.Operators.ToString_Double4" id={id} persistentId={persistentId} updateOrder={updateOrder}>
