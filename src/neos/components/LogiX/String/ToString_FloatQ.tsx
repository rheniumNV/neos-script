import { member, Member, Component } from "../../../core";
    ...
    export interface ToString_FloatQInput {
...
FormatProvider?: member<any>;
    ...
    export function ToString_FloatQ(props: ToString_FloatQInput){
...
FormatProvider, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.Operators.ToString_FloatQ" id={id} persistentId={persistentId} updateOrder={updateOrder}>
