...
<Member type={`FrooxEngine.LogiX.Input\`1[System.Int32]`} name="V" id={typeof V === "object" && "id" in V ? V?.id : undefined} value={typeof V === "object" && "value" in V ? V?.value : V} /* default: ID0 */  />
