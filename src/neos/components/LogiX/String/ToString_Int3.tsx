import { member, Member, Component } from "../../../core";
    ...
    export interface ToString_Int3Input {
...
FormatProvider?: member<any>;
    ...
    export function ToString_Int3(props: ToString_Int3Input){
...
FormatProvider, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.Operators.ToString_Int3" id={id} persistentId={persistentId} updateOrder={updateOrder}>
