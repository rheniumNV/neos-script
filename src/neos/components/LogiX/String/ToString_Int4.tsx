import { member, Member, Component } from "../../../core";
    ...
    export interface ToString_Int4Input {
...
FormatProvider?: member<any>;
    ...
    export function ToString_Int4(props: ToString_Int4Input){
...
FormatProvider, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.Operators.ToString_Int4" id={id} persistentId={persistentId} updateOrder={updateOrder}>
