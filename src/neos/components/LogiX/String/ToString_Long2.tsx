import { member, Member, Component } from "../../../core";
    ...
    export interface ToString_Long2Input {
...
FormatProvider?: member<any>;
    ...
    export function ToString_Long2(props: ToString_Long2Input){
...
FormatProvider, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.Operators.ToString_Long2" id={id} persistentId={persistentId} updateOrder={updateOrder}>
