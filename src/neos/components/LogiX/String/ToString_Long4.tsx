import { member, Member, Component } from "../../../core";
    ...
    export interface ToString_Long4Input {
...
FormatProvider?: member<any>;
    ...
    export function ToString_Long4(props: ToString_Long4Input){
...
FormatProvider, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.Operators.ToString_Long4" id={id} persistentId={persistentId} updateOrder={updateOrder}>
