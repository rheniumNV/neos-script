import { member, Member, Component } from "../../../core";
    ...
    export interface ToString_Uint3Input {
...
FormatProvider?: member<any>;
    ...
    export function ToString_Uint3(props: ToString_Uint3Input){
...
FormatProvider, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.Operators.ToString_Uint3" id={id} persistentId={persistentId} updateOrder={updateOrder}>
