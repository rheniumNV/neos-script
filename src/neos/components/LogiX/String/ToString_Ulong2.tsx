import { member, Member, Component } from "../../../core";
    ...
    export interface ToString_Ulong2Input {
...
FormatProvider?: member<any>;
    ...
    export function ToString_Ulong2(props: ToString_Ulong2Input){
...
FormatProvider, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.Operators.ToString_Ulong2" id={id} persistentId={persistentId} updateOrder={updateOrder}>
