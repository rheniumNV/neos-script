import { member, Member, Component } from "../../../core";
    ...
    export interface TrimStringInput {
...
A?: member<any>;
    ...
    export function TrimString(props: TrimStringInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
A, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.String.TrimString" id={id} persistentId={persistentId} updateOrder={updateOrder}>
