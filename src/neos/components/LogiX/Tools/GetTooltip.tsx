...
Side?: member<any>;
    ...
    export function GetTooltip(props: GetTooltipInput){
...
Side, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.Tools.GetTooltip" id={id} persistentId={persistentId} updateOrder={updateOrder}>
