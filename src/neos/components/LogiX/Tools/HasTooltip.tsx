import { member, Member, Component } from "../../../core";
    ...
    export interface HasTooltipInput {
...
Side?: member<any>;
    ...
    export function HasTooltip(props: HasTooltipInput){
...
Side, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.Tools.HasTooltip" id={id} persistentId={persistentId} updateOrder={updateOrder}>
