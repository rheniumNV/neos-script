import { member, Member, Component } from "../../../core";
    ...
    export interface TooltipEquippingSlotInput {
...
Tooltip?: member<any>;
    ...
    export function TooltipEquippingSlot(props: TooltipEquippingSlotInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
Tooltip, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Tools.TooltipEquippingSlot" id={id} persistentId={persistentId} updateOrder={updateOrder}>
