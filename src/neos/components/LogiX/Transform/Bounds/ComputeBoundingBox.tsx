...
<Member type={`FrooxEngine.LogiX.Input\`1[FrooxEngine.Slot]`} name="CoordinateSpace" id={typeof CoordinateSpace === "object" && "id" in CoordinateSpace ? CoordinateSpace?.id : undefined} value={typeof CoordinateSpace === "object" && "value" in CoordinateSpace ? CoordinateSpace?.value : CoordinateSpace} /* default: ID0 */  isRaw={typeof CoordinateSpace === "object" && "isRaw" in CoordinateSpace && CoordinateSpace.isRaw ? true : undefined} />
<Member type={`FrooxEngine.LogiX.Input\`1[System.String]`} name="OnlyWithTag" id={typeof OnlyWithTag === "object" && "id" in OnlyWithTag ? OnlyWithTag?.id : undefined} value={typeof OnlyWithTag === "object" && "value" in OnlyWithTag ? OnlyWithTag?.value : OnlyWithTag} /* default: ID0 */  isRaw={typeof OnlyWithTag === "object" && "isRaw" in OnlyWithTag && OnlyWithTag.isRaw ? true : undefined} />
        </Component>
      );
    };
