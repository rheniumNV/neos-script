import { member, Member, Component } from "../../../core";
    ...
    export interface GetBackwardInput {
...
Instance?: member<any>;
    ...
    export function GetBackward(props: GetBackwardInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
Instance, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.WorldModel.GetBackward" id={id} persistentId={persistentId} updateOrder={updateOrder}>
