...
Instance?: member<any>;
    ...
    export function GetDown(props: GetDownInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
Instance, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.WorldModel.GetDown" id={id} persistentId={persistentId} updateOrder={updateOrder}>
