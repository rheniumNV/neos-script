import { member, Member, Component } from "../../../core";
    ...
    export interface GetForwardInput {
...
Instance?: member<any>;
    ...
    export function GetForward(props: GetForwardInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
Instance, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.WorldModel.GetForward" id={id} persistentId={persistentId} updateOrder={updateOrder}>
