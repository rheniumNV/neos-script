...
Instance?: member<any>;
    ...
    export function GetLeft(props: GetLeftInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
Instance, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.WorldModel.GetLeft" id={id} persistentId={persistentId} updateOrder={updateOrder}>
