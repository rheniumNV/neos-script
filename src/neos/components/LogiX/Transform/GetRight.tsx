import { member, Member, Component } from "../../../core";
    ...
    export interface GetRightInput {
...
Instance?: member<any>;
    ...
    export function GetRight(props: GetRightInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
Instance, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.WorldModel.GetRight" id={id} persistentId={persistentId} updateOrder={updateOrder}>
