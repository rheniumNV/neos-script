...
Instance?: member<any>;
    ...
    export function GetUp(props: GetUpInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
Instance, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.WorldModel.GetUp" id={id} persistentId={persistentId} updateOrder={updateOrder}>
