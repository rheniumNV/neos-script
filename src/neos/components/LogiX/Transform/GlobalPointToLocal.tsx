...
<Member type={`FrooxEngine.LogiX.Input\`1[BaseX.float3]`} name="GlobalPoint" id={typeof GlobalPoint === "object" && "id" in GlobalPoint ? GlobalPoint?.id : undefined} value={typeof GlobalPoint === "object" && "value" in GlobalPoint ? GlobalPoint?.value : GlobalPoint} /* default: ID0 */  isRaw={typeof GlobalPoint === "object" && "isRaw" in GlobalPoint && GlobalPoint.isRaw ? true : undefined} />
        </Component>
      );
    };
