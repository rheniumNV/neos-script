import { member, Member, Component } from "../../../core";
    ...
    export interface GlobalTransformInput {
...
Instance?: member<any>;
    ...
    export function GlobalTransform(props: GlobalTransformInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
Instance, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.WorldModel.GlobalTransform" id={id} persistentId={persistentId} updateOrder={updateOrder}>
