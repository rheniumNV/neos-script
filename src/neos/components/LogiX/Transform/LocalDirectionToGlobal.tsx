...
<Member type={`FrooxEngine.LogiX.Input\`1[BaseX.float3]`} name="LocalDirection" id={typeof LocalDirection === "object" && "id" in LocalDirection ? LocalDirection?.id : undefined} value={typeof LocalDirection === "object" && "value" in LocalDirection ? LocalDirection?.value : LocalDirection} /* default: ID0 */  isRaw={typeof LocalDirection === "object" && "isRaw" in LocalDirection && LocalDirection.isRaw ? true : undefined} />
        </Component>
      );
    };
