...
<Member type={`FrooxEngine.LogiX.Input\`1[BaseX.float3]`} name="LocalPoint" id={typeof LocalPoint === "object" && "id" in LocalPoint ? LocalPoint?.id : undefined} value={typeof LocalPoint === "object" && "value" in LocalPoint ? LocalPoint?.value : LocalPoint} /* default: ID0 */  />
        </Component>
      );
    };
