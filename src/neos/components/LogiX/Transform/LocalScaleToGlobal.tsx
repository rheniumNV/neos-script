...
<Member type={`FrooxEngine.LogiX.Input\`1[BaseX.float3]`} name="LocalScale" id={typeof LocalScale === "object" && "id" in LocalScale ? LocalScale?.id : undefined} value={typeof LocalScale === "object" && "value" in LocalScale ? LocalScale?.value : LocalScale} /* default: ID0 */  isRaw={typeof LocalScale === "object" && "isRaw" in LocalScale && LocalScale.isRaw ? true : undefined} />
        </Component>
      );
    };
