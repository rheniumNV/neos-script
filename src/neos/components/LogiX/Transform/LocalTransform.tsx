...
Instance?: member<any>;
    ...
    export function LocalTransform(props: LocalTransformInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
Instance, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.WorldModel.LocalTransform" id={id} persistentId={persistentId} updateOrder={updateOrder}>
