...
<Member type={`FrooxEngine.LogiX.Input\`1[BaseX.float3]`} name="Down" id={typeof Down === "object" && "id" in Down ? Down?.id : undefined} value={typeof Down === "object" && "value" in Down ? Down?.value : Down} /* default: ID0 */  />
