import { member, Member, Component } from "../../../core";
    ...
    export interface SetGlobalPositionRotationInput {
...
OnDone?: member<any>;
    ...
    export function SetGlobalPositionRotation(props: SetGlobalPositionRotationInput){
...
OnDone, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.WorldModel.SetGlobalPositionRotation" id={id} persistentId={persistentId} updateOrder={updateOrder}>
