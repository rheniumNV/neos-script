import { member, Member, Component } from "../../../core";
    ...
    export interface SetGlobalRotationInput {
...
OnDone?: member<any>;
    ...
    export function SetGlobalRotation(props: SetGlobalRotationInput){
...
OnDone, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.WorldModel.SetGlobalRotation" id={id} persistentId={persistentId} updateOrder={updateOrder}>
