import { member, Member, Component } from "../../../core";
    ...
    export interface SetGlobalTransformInput {
...
OnDone?: member<any>;
    ...
    export function SetGlobalTransform(props: SetGlobalTransformInput){
...
OnDone, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.WorldModel.SetGlobalTransform" id={id} persistentId={persistentId} updateOrder={updateOrder}>
