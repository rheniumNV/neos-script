...
<Member type={`FrooxEngine.LogiX.Input\`1[BaseX.float3]`} name="Left" id={typeof Left === "object" && "id" in Left ? Left?.id : undefined} value={typeof Left === "object" && "value" in Left ? Left?.value : Left} /* default: ID0 */  />
