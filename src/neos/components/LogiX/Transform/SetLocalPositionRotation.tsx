import { member, Member, Component } from "../../../core";
    ...
    export interface SetLocalPositionRotationInput {
...
OnDone?: member<any>;
    ...
    export function SetLocalPositionRotation(props: SetLocalPositionRotationInput){
...
OnDone, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.WorldModel.SetLocalPositionRotation" id={id} persistentId={persistentId} updateOrder={updateOrder}>
