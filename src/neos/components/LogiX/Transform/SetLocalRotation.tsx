import { member, Member, Component } from "../../../core";
    ...
    export interface SetLocalRotationInput {
...
OnDone?: member<any>;
    ...
    export function SetLocalRotation(props: SetLocalRotationInput){
...
OnDone, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.WorldModel.SetLocalRotation" id={id} persistentId={persistentId} updateOrder={updateOrder}>
