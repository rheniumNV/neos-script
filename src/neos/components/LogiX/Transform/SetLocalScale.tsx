...
OnDone?: member<any>;
    ...
    export function SetLocalScale(props: SetLocalScaleInput){
...
OnDone, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.WorldModel.SetLocalScale" id={id} persistentId={persistentId} updateOrder={updateOrder}>
