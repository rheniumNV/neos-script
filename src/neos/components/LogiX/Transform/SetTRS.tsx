...
<Member type={`FrooxEngine.LogiX.Input\`1[BaseX.float4x4]`} name="TRS" id={typeof TRS === "object" && "id" in TRS ? TRS?.id : undefined} value={typeof TRS === "object" && "value" in TRS ? TRS?.value : TRS} /* default: ID0 */  />
