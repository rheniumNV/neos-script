...
<Member type={`FrooxEngine.LogiX.Input\`1[BaseX.float3]`} name="SourceVector" id={typeof SourceVector === "object" && "id" in SourceVector ? SourceVector?.id : undefined} value={typeof SourceVector === "object" && "value" in SourceVector ? SourceVector?.value : SourceVector} /* default: ID0 */  />
        </Component>
      );
    };
