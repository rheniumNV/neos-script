import { member, Member, Component } from "../../../core";
    ...
    export interface CreateFieldUndoStepInput {
...
OnCreated?: member<any>;
    ...
    export function CreateFieldUndoStep(props: CreateFieldUndoStepInput){
...
OnCreated, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.Undo.CreateFieldUndoStep" id={id} persistentId={persistentId} updateOrder={updateOrder}>
...
<Member type={`FrooxEngine.LogiX.Input\`1[FrooxEngine.IField]`} name="Target" id={typeof Target === "object" && "id" in Target ? Target?.id : undefined} value={typeof Target === "object" && "value" in Target ? Target?.value : Target} /* default: ID0 */  isRaw={typeof Target === "object" && "isRaw" in Target && Target.isRaw ? true : undefined} />
