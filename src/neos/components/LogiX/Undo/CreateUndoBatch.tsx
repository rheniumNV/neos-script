...
<Member type={`FrooxEngine.LogiX.Impulse`} name="Create" id={typeof Create === "object" && "id" in Create ? Create?.id : undefined} value={typeof Create === "object" && "value" in Create ? Create?.value : Create} /* default: FrooxEngine.WorldDelegate */  />
