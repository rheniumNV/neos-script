import { member, Member, Component } from "../../../core";
    ...
    export interface IsLocalUserInput {
...
User?: member<any>;
    ...
    export function IsLocalUser(props: IsLocalUserInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
User, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.WorldModel.IsLocalUser" id={id} persistentId={persistentId} updateOrder={updateOrder}>
