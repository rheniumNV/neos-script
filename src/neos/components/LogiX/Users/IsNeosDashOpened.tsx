import { member, Member, Component } from "../../../core";
    ...
    export interface IsNeosDashOpenedInput {
...
User?: member<any>;
    ...
    export function IsNeosDashOpened(props: IsNeosDashOpenedInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
User, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.WorldModel.IsNeosDashOpened" id={id} persistentId={persistentId} updateOrder={updateOrder}>
