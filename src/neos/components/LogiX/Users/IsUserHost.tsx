import { member, Member, Component } from "../../../core";
    ...
    export interface IsUserHostInput {
...
User?: member<any>;
    ...
    export function IsUserHost(props: IsUserHostInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
User, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.WorldModel.IsUserHost" id={id} persistentId={persistentId} updateOrder={updateOrder}>
