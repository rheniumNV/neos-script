import { member, Member, Component } from "../../../core";
    ...
    export interface IsUserInEditModeInput {
...
User?: member<any>;
    ...
    export function IsUserInEditMode(props: IsUserInEditModeInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
User, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.WorldModel.IsUserInEditMode" id={id} persistentId={persistentId} updateOrder={updateOrder}>
