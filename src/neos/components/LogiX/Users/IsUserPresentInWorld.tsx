...
User?: member<any>;
    ...
    export function IsUserPresentInWorld(props: IsUserPresentInWorldInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
User, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.WorldModel.IsUserPresentInWorld" id={id} persistentId={persistentId} updateOrder={updateOrder}>
