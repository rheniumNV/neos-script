import { member, Member, Component } from "../../../../core";
    ...
    export interface FeetPositionInput {
...
UserRoot?: member<any>;
    ...
    export function FeetPosition(props: FeetPositionInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
UserRoot, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.WorldModel.FeetPosition" id={id} persistentId={persistentId} updateOrder={updateOrder}>
