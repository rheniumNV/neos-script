import { member, Member, Component } from "../../../../core";
    ...
    export interface FeetRotationInput {
...
UserRoot?: member<any>;
    ...
    export function FeetRotation(props: FeetRotationInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
UserRoot, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.WorldModel.FeetRotation" id={id} persistentId={persistentId} updateOrder={updateOrder}>
