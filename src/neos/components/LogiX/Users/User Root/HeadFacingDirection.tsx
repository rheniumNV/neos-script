import { member, Member, Component } from "../../../../core";
    ...
    export interface HeadFacingDirectionInput {
...
UserRoot?: member<any>;
    ...
    export function HeadFacingDirection(props: HeadFacingDirectionInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
UserRoot, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.WorldModel.HeadFacingDirection" id={id} persistentId={persistentId} updateOrder={updateOrder}>
