import { member, Member, Component } from "../../../../core";
    ...
    export interface HeadPositionInput {
...
UserRoot?: member<any>;
    ...
    export function HeadPosition(props: HeadPositionInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
UserRoot, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.WorldModel.HeadPosition" id={id} persistentId={persistentId} updateOrder={updateOrder}>
