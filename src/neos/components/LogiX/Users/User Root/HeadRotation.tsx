import { member, Member, Component } from "../../../../core";
    ...
    export interface HeadRotationInput {
...
UserRoot?: member<any>;
    ...
    export function HeadRotation(props: HeadRotationInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
UserRoot, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.WorldModel.HeadRotation" id={id} persistentId={persistentId} updateOrder={updateOrder}>
