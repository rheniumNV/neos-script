import { member, Member, Component } from "../../../../core";
    ...
    export interface HipsPositionInput {
...
UserRoot?: member<any>;
    ...
    export function HipsPosition(props: HipsPositionInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
UserRoot, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.WorldModel.HipsPosition" id={id} persistentId={persistentId} updateOrder={updateOrder}>
