import { member, Member, Component } from "../../../../core";
    ...
    export interface HipsRotationInput {
...
UserRoot?: member<any>;
    ...
    export function HipsRotation(props: HipsRotationInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
UserRoot, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.WorldModel.HipsRotation" id={id} persistentId={persistentId} updateOrder={updateOrder}>
