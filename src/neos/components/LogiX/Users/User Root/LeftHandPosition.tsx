import { member, Member, Component } from "../../../../core";
    ...
    export interface LeftHandPositionInput {
...
UserRoot?: member<any>;
    ...
    export function LeftHandPosition(props: LeftHandPositionInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
UserRoot, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.WorldModel.LeftHandPosition" id={id} persistentId={persistentId} updateOrder={updateOrder}>
