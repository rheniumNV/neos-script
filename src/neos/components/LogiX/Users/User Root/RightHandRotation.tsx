import { member, Member, Component } from "../../../../core";
    ...
    export interface RightHandRotationInput {
...
UserRoot?: member<any>;
    ...
    export function RightHandRotation(props: RightHandRotationInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
UserRoot, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.WorldModel.RightHandRotation" id={id} persistentId={persistentId} updateOrder={updateOrder}>
