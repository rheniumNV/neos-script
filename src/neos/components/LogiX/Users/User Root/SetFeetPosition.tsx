import { member, Member, Component } from "../../../../core";
    ...
    export interface SetFeetPositionInput {
...
OnSet?: member<any>;
    ...
    export function SetFeetPosition(props: SetFeetPositionInput){
...
OnSet, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.WorldModel.SetFeetPosition" id={id} persistentId={persistentId} updateOrder={updateOrder}>
