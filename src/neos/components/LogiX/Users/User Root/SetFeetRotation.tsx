import { member, Member, Component } from "../../../../core";
    ...
    export interface SetFeetRotationInput {
...
OnSet?: member<any>;
    ...
    export function SetFeetRotation(props: SetFeetRotationInput){
...
OnSet, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.WorldModel.SetFeetRotation" id={id} persistentId={persistentId} updateOrder={updateOrder}>
