import { member, Member, Component } from "../../../../core";
    ...
    export interface SetHeadFacingRotationInput {
...
OnSet?: member<any>;
    ...
    export function SetHeadFacingRotation(props: SetHeadFacingRotationInput){
...
OnSet, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.WorldModel.SetHeadFacingRotation" id={id} persistentId={persistentId} updateOrder={updateOrder}>
