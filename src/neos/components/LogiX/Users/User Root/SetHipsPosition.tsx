import { member, Member, Component } from "../../../../core";
    ...
    export interface SetHipsPositionInput {
...
OnSet?: member<any>;
    ...
    export function SetHipsPosition(props: SetHipsPositionInput){
...
OnSet, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.WorldModel.SetHipsPosition" id={id} persistentId={persistentId} updateOrder={updateOrder}>
