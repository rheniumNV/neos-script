import { member, Member, Component } from "../../../../core";
    ...
    export interface SetHipsRotationInput {
...
OnSet?: member<any>;
    ...
    export function SetHipsRotation(props: SetHipsRotationInput){
...
OnSet, } = props;
      ...
      return (
        <Component type="FrooxEngine.LogiX.WorldModel.SetHipsRotation" id={id} persistentId={persistentId} updateOrder={updateOrder}>
