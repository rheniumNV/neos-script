import { member, Member, Component } from "../../../../core";
    ...
    export interface UserRootGlobalScaleInput {
...
UserRoot?: member<any>;
    ...
    export function UserRootGlobalScale(props: UserRootGlobalScaleInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
UserRoot, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.WorldModel.UserRootGlobalScale" id={id} persistentId={persistentId} updateOrder={updateOrder}>
