...
User?: member<any>;
    ...
    export function UserFPS(props: UserFPSInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
User, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.WorldModel.UserFPS" id={id} persistentId={persistentId} updateOrder={updateOrder}>
