import { member, Member, Component } from "../../../core";
    ...
    export interface UserHeadOutputDeviceInput {
...
User?: member<any>;
    ...
    export function UserHeadOutputDevice(props: UserHeadOutputDeviceInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
User, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.WorldModel.UserHeadOutputDevice" id={id} persistentId={persistentId} updateOrder={updateOrder}>
