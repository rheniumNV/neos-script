import { member, Member, Component } from "../../../core";
    ...
    export interface UserPingInput {
...
User?: member<any>;
    ...
    export function UserPing(props: UserPingInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
User, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.WorldModel.UserPing" id={id} persistentId={persistentId} updateOrder={updateOrder}>
