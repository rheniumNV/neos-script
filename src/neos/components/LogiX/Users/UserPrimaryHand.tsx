...
User?: member<any>;
    ...
    export function UserPrimaryHand(props: UserPrimaryHandInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
User, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.WorldModel.UserPrimaryHand" id={id} persistentId={persistentId} updateOrder={updateOrder}>
