import { member, Member, Component } from "../../../core";
    ...
    export interface UserUploadSpeedInput {
...
User?: member<any>;
    ...
    export function UserUploadSpeed(props: UserUploadSpeedInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
User, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.WorldModel.UserUploadSpeed" id={id} persistentId={persistentId} updateOrder={updateOrder}>
