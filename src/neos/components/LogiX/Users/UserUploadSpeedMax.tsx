import { member, Member, Component } from "../../../core";
    ...
    export interface UserUploadSpeedMaxInput {
...
User?: member<any>;
    ...
    export function UserUploadSpeedMax(props: UserUploadSpeedMaxInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
User, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.WorldModel.UserUploadSpeedMax" id={id} persistentId={persistentId} updateOrder={updateOrder}>
