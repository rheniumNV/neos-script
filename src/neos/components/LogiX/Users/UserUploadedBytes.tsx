import { member, Member, Component } from "../../../core";
    ...
    export interface UserUploadedBytesInput {
...
User?: member<any>;
    ...
    export function UserUploadedBytes(props: UserUploadedBytesInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
User, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.WorldModel.UserUploadedBytes" id={id} persistentId={persistentId} updateOrder={updateOrder}>
