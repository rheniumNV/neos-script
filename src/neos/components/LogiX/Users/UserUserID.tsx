import { member, Member, Component } from "../../../core";
    ...
    export interface UserUserIDInput {
...
User?: member<any>;
    ...
    export function UserUserID(props: UserUserIDInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
User, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.WorldModel.UserUserID" id={id} persistentId={persistentId} updateOrder={updateOrder}>
