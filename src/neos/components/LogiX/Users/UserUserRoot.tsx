import { member, Member, Component } from "../../../core";
    ...
    export interface UserUserRootInput {
...
User?: member<any>;
    ...
    export function UserUserRoot(props: UserUserRootInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
User, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.WorldModel.UserUserRoot" id={id} persistentId={persistentId} updateOrder={updateOrder}>
