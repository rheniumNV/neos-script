import { member, Member, Component } from "../../../core";
    ...
    export interface UserVR_ActiveInput {
...
User?: member<any>;
    ...
    export function UserVR_Active(props: UserVR_ActiveInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
User, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.WorldModel.UserVR_Active" id={id} persistentId={persistentId} updateOrder={updateOrder}>
