import { member, Member, Component } from "../../../core";
    ...
    export interface UserViewReferenceActiveInput {
...
User?: member<any>;
    ...
    export function UserViewReferenceActive(props: UserViewReferenceActiveInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
User, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.WorldModel.UserViewReferenceActive" id={id} persistentId={persistentId} updateOrder={updateOrder}>
