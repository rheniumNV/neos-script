...
Str?: member<any>;
    ...
    export function ParseGUID(props: ParseGUIDInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
Str, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Utility.ParseGUID" id={id} persistentId={persistentId} updateOrder={updateOrder}>
