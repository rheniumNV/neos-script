...
<Member type={`FrooxEngine.LogiX.Input\`1[System.String]`} name="SpaceName" id={typeof SpaceName === "object" && "id" in SpaceName ? SpaceName?.id : undefined} value={typeof SpaceName === "object" && "value" in SpaceName ? SpaceName?.value : SpaceName} /* default: ID0 */  isRaw={typeof SpaceName === "object" && "isRaw" in SpaceName && SpaceName.isRaw ? true : undefined} />
