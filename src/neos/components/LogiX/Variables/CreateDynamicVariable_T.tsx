...
<Member type={`FrooxEngine.LogiX.Input\`1[${T}]`} name="InitialValue" id={typeof InitialValue === "object" && "id" in InitialValue ? InitialValue?.id : undefined} value={typeof InitialValue === "object" && "value" in InitialValue ? InitialValue?.value : InitialValue} /* default: null */  isRaw={typeof InitialValue === "object" && "isRaw" in InitialValue && InitialValue.isRaw ? true : undefined} />
...
<Member type={`FrooxEngine.LogiX.Impulse`} name="OnAlreadyExists" id={typeof OnAlreadyExists === "object" && "id" in OnAlreadyExists ? OnAlreadyExists?.id : undefined} value={typeof OnAlreadyExists === "object" && "value" in OnAlreadyExists ? OnAlreadyExists?.value : OnAlreadyExists} /* default: FrooxEngine.WorldDelegate */  isRaw={typeof OnAlreadyExists === "object" && "isRaw" in OnAlreadyExists && OnAlreadyExists.isRaw ? true : undefined} />
