...
<Member type={`FrooxEngine.LogiX.Impulse`} name="OnReadRequest" id={typeof OnReadRequest === "object" && "id" in OnReadRequest ? OnReadRequest?.id : undefined} value={typeof OnReadRequest === "object" && "value" in OnReadRequest ? OnReadRequest?.value : OnReadRequest} /* default: FrooxEngine.WorldDelegate */  />
<Member type={`FrooxEngine.LogiX.Impulse`} name="OnRead" id={typeof OnRead === "object" && "id" in OnRead ? OnRead?.id : undefined} value={typeof OnRead === "object" && "value" in OnRead ? OnRead?.value : OnRead} /* default: FrooxEngine.WorldDelegate */  />
