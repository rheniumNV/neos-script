...
Target?: member<any>;
    ...
    export function SlotRegister(props: SlotRegisterInput){
      const { id, persistentId, updateOrder, Enabled,
_activeVisual,
Target, } = props;
    
      return (
        <Component type="FrooxEngine.LogiX.Data.SlotRegister" id={id} persistentId={persistentId} updateOrder={updateOrder}>
