...
<Member type={`FrooxEngine.LogiX.Impulse`} name="OnWriteRequest" id={typeof OnWriteRequest === "object" && "id" in OnWriteRequest ? OnWriteRequest?.id : undefined} value={typeof OnWriteRequest === "object" && "value" in OnWriteRequest ? OnWriteRequest?.value : OnWriteRequest} /* default: FrooxEngine.WorldDelegate */  isRaw={typeof OnWriteRequest === "object" && "isRaw" in OnWriteRequest && OnWriteRequest.isRaw ? true : undefined} />
