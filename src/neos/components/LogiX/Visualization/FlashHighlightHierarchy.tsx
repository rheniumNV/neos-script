...
<Member type={`FrooxEngine.LogiX.Input\`1[FrooxEngine.Slot]`} name="HierarchyRoot" id={typeof HierarchyRoot === "object" && "id" in HierarchyRoot ? HierarchyRoot?.id : undefined} value={typeof HierarchyRoot === "object" && "value" in HierarchyRoot ? HierarchyRoot?.value : HierarchyRoot} /* default: ID0 */  />
<Member type={`FrooxEngine.LogiX.Input\`1[System.Boolean]`} name="ExcludeColliders" id={typeof ExcludeColliders === "object" && "id" in ExcludeColliders ? ExcludeColliders?.id : undefined} value={typeof ExcludeColliders === "object" && "value" in ExcludeColliders ? ExcludeColliders?.value : ExcludeColliders} /* default: ID0 */  />
<Member type={`FrooxEngine.LogiX.Input\`1[System.Boolean]`} name="ExcludeMeshes" id={typeof ExcludeMeshes === "object" && "id" in ExcludeMeshes ? ExcludeMeshes?.id : undefined} value={typeof ExcludeMeshes === "object" && "value" in ExcludeMeshes ? ExcludeMeshes?.value : ExcludeMeshes} /* default: ID0 */  />
