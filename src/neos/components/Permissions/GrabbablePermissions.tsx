...
<Member type={`FrooxEngine.SyncTypeList`} name="ValidateTypes" id={typeof ValidateTypes === "object" && "id" in ValidateTypes ? ValidateTypes?.id : undefined} value={typeof ValidateTypes === "object" && "value" in ValidateTypes ? ValidateTypes?.value : ValidateTypes} /* default: FrooxEngine.SyncTypeList */  />
        </Component>
      );
    };
