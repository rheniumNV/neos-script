import { member, Member, Component } from "../../../core";
    ...
    export interface CapsuleColliderInput {
...
Radius?: member<number>;
    ...
    export function CapsuleCollider(props: CapsuleColliderInput){
...
Radius, } = props;
      ...
      return (
        <Component type="FrooxEngine.CapsuleCollider" id={id} persistentId={persistentId} updateOrder={updateOrder} version={2}>
