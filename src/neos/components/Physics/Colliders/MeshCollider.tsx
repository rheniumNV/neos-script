...
<Member type={`FrooxEngine.Sync\`1[FrooxEngine.MeshColliderSidedness]`} name="Sidedness" id={typeof Sidedness === "object" && "id" in Sidedness ? Sidedness?.id : undefined} value={typeof Sidedness === "object" && "value" in Sidedness ? Sidedness?.value : Sidedness} /* default: Front */  isRaw={typeof Sidedness === "object" && "isRaw" in Sidedness && Sidedness.isRaw ? true : undefined} />
<Member type={`FrooxEngine.RawOutput\`1[System.Single]`} name="ActualSpeculativeMargin" id={typeof ActualSpeculativeMargin === "object" && "id" in ActualSpeculativeMargin ? ActualSpeculativeMargin?.id : undefined} value={typeof ActualSpeculativeMargin === "object" && "value" in ActualSpeculativeMargin ? ActualSpeculativeMargin?.value : ActualSpeculativeMargin} /* default: FrooxEngine.RawOutput`1[System.Single] */  isRaw={typeof ActualSpeculativeMargin === "object" && "isRaw" in ActualSpeculativeMargin && ActualSpeculativeMargin.isRaw ? true : undefined} />
        </Component>
      );
    };
