import { member, Member, Component } from "../../../core";
    ...
    export interface SphereColliderInput {
...
Radius?: member<number>;
    ...
    export function SphereCollider(props: SphereColliderInput){
...
Radius, } = props;
      ...
      return (
        <Component type="FrooxEngine.SphereCollider" id={id} persistentId={persistentId} updateOrder={updateOrder} version={1}>
