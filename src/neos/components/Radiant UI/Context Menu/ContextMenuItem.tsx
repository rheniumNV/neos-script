...
<Member type={`FrooxEngine.SyncRef\`1[FrooxEngine.UIX.Image]`} name="Icon" id={typeof Icon === "object" && "id" in Icon ? Icon?.id : undefined} value={typeof Icon === "object" && "value" in Icon ? Icon?.value : Icon} /* default: ID0 */  isRaw={typeof Icon === "object" && "isRaw" in Icon && Icon.isRaw ? true : undefined} />
<Member type={`FrooxEngine.RelayRef\`1[FrooxEngine.IAssetProvider\`1[FrooxEngine.Sprite]]`} name="Sprite" id={typeof Sprite === "object" && "id" in Sprite ? Sprite?.id : undefined} value={typeof Sprite === "object" && "value" in Sprite ? Sprite?.value : Sprite} /* default: ID0 */  isRaw={typeof Sprite === "object" && "isRaw" in Sprite && Sprite.isRaw ? true : undefined} />
...
<Member type={`FrooxEngine.SyncRef\`1[FrooxEngine.ContextMenu]`} name="_menu" id={typeof _menu === "object" && "id" in _menu ? _menu?.id : undefined} value={typeof _menu === "object" && "value" in _menu ? _menu?.value : _menu} /* default: ID0 */  isRaw={typeof _menu === "object" && "isRaw" in _menu && _menu.isRaw ? true : undefined} />
<Member type={`FrooxEngine.Sync\`1[System.Boolean]`} name="_highlighted" id={typeof _highlighted === "object" && "id" in _highlighted ? _highlighted?.id : undefined} value={typeof _highlighted === "object" && "value" in _highlighted ? _highlighted?.value : _highlighted} /* default: false */  isRaw={typeof _highlighted === "object" && "isRaw" in _highlighted && _highlighted.isRaw ? true : undefined} />
<Member type={`FrooxEngine.FieldDrive\`1[System.Single]`} name="_arc" id={typeof _arc === "object" && "id" in _arc ? _arc?.id : undefined} value={typeof _arc === "object" && "value" in _arc ? _arc?.value : _arc} /* default: ID0 */  isRaw={typeof _arc === "object" && "isRaw" in _arc && _arc.isRaw ? true : undefined} />
<Member type={`FrooxEngine.FieldDrive\`1[System.Single]`} name="_outerRadius" id={typeof _outerRadius === "object" && "id" in _outerRadius ? _outerRadius?.id : undefined} value={typeof _outerRadius === "object" && "value" in _outerRadius ? _outerRadius?.value : _outerRadius} /* default: ID0 */  isRaw={typeof _outerRadius === "object" && "isRaw" in _outerRadius && _outerRadius.isRaw ? true : undefined} />
