...
<Member type={`FrooxEngine.SyncDelegate\`1[FrooxEngine.WorldItemAction]`} name="PressAction" id={typeof PressAction === "object" && "id" in PressAction ? PressAction?.id : undefined} value={typeof PressAction === "object" && "value" in PressAction ? PressAction?.value : PressAction} /* default: FrooxEngine.WorldDelegate */  isRaw={typeof PressAction === "object" && "isRaw" in PressAction && PressAction.isRaw ? true : undefined} />
...
<Member type={`FrooxEngine.SyncRef\`1[FrooxEngine.UIX.RectTransform]`} name="_nameRoot" id={typeof _nameRoot === "object" && "id" in _nameRoot ? _nameRoot?.id : undefined} value={typeof _nameRoot === "object" && "value" in _nameRoot ? _nameRoot?.value : _nameRoot} /* default: ID0 */  isRaw={typeof _nameRoot === "object" && "isRaw" in _nameRoot && _nameRoot.isRaw ? true : undefined} />
<Member type={`FrooxEngine.SyncRef\`1[FrooxEngine.UIX.RectTransform]`} name="_detailRoot" id={typeof _detailRoot === "object" && "id" in _detailRoot ? _detailRoot?.id : undefined} value={typeof _detailRoot === "object" && "value" in _detailRoot ? _detailRoot?.value : _detailRoot} /* default: ID0 */  isRaw={typeof _detailRoot === "object" && "isRaw" in _detailRoot && _detailRoot.isRaw ? true : undefined} />
<Member type={`FrooxEngine.SyncRef\`1[FrooxEngine.UIX.RectTransform]`} name="_visitedRoot" id={typeof _visitedRoot === "object" && "id" in _visitedRoot ? _visitedRoot?.id : undefined} value={typeof _visitedRoot === "object" && "value" in _visitedRoot ? _visitedRoot?.value : _visitedRoot} /* default: ID0 */  isRaw={typeof _visitedRoot === "object" && "isRaw" in _visitedRoot && _visitedRoot.isRaw ? true : undefined} />
<Member type={`FrooxEngine.SyncRef\`1[FrooxEngine.UIX.RectTransform]`} name="_counterRoot" id={typeof _counterRoot === "object" && "id" in _counterRoot ? _counterRoot?.id : undefined} value={typeof _counterRoot === "object" && "value" in _counterRoot ? _counterRoot?.value : _counterRoot} /* default: ID0 */  isRaw={typeof _counterRoot === "object" && "isRaw" in _counterRoot && _counterRoot.isRaw ? true : undefined} />
<Member type={`FrooxEngine.SyncRef\`1[FrooxEngine.UIX.RectTransform]`} name="_iconsRoot" id={typeof _iconsRoot === "object" && "id" in _iconsRoot ? _iconsRoot?.id : undefined} value={typeof _iconsRoot === "object" && "value" in _iconsRoot ? _iconsRoot?.value : _iconsRoot} /* default: ID0 */  isRaw={typeof _iconsRoot === "object" && "isRaw" in _iconsRoot && _iconsRoot.isRaw ? true : undefined} />
<Member type={`FrooxEngine.SyncRef\`1[FrooxEngine.UIX.RectTransform]`} name="_closeButton" id={typeof _closeButton === "object" && "id" in _closeButton ? _closeButton?.id : undefined} value={typeof _closeButton === "object" && "value" in _closeButton ? _closeButton?.value : _closeButton} /* default: ID0 */  isRaw={typeof _closeButton === "object" && "isRaw" in _closeButton && _closeButton.isRaw ? true : undefined} />
...
<Member type={`FrooxEngine.SyncRef\`1[FrooxEngine.UIX.Text]`} name="_detailText" id={typeof _detailText === "object" && "id" in _detailText ? _detailText?.id : undefined} value={typeof _detailText === "object" && "value" in _detailText ? _detailText?.value : _detailText} /* default: ID0 */  isRaw={typeof _detailText === "object" && "isRaw" in _detailText && _detailText.isRaw ? true : undefined} />
<Member type={`FrooxEngine.SyncRef\`1[FrooxEngine.UIX.Text]`} name="_counterText" id={typeof _counterText === "object" && "id" in _counterText ? _counterText?.id : undefined} value={typeof _counterText === "object" && "value" in _counterText ? _counterText?.value : _counterText} /* default: ID0 */  isRaw={typeof _counterText === "object" && "isRaw" in _counterText && _counterText.isRaw ? true : undefined} />
<Member type={`FrooxEngine.SyncRef\`1[FrooxEngine.UIX.Image]`} name="_borderOverlay" id={typeof _borderOverlay === "object" && "id" in _borderOverlay ? _borderOverlay?.id : undefined} value={typeof _borderOverlay === "object" && "value" in _borderOverlay ? _borderOverlay?.value : _borderOverlay} /* default: ID0 */  isRaw={typeof _borderOverlay === "object" && "isRaw" in _borderOverlay && _borderOverlay.isRaw ? true : undefined} />
<Member type={`FrooxEngine.Sync\`1[BaseX.color]`} name="_borderColor" id={typeof _borderColor === "object" && "id" in _borderColor ? _borderColor?.id : undefined} value={typeof _borderColor === "object" && "value" in _borderColor ? _borderColor?.value : _borderColor} /* default: [0; 0; 0; 0] */  isRaw={typeof _borderColor === "object" && "isRaw" in _borderColor && _borderColor.isRaw ? true : undefined} />
        </Component>
      );
    };
