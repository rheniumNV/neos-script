import { member, Member, Component } from "../../../core";
    ...
    export interface Double3ToDoubleQSwizzleDriverInput {
...
W?: member<number>;
    ...
    export function Double3ToDoubleQSwizzleDriver(props: Double3ToDoubleQSwizzleDriverInput){
...
W, } = props;
      ...
      return (
        <Component type="FrooxEngine.Double3ToDoubleQSwizzleDriver" id={id} persistentId={persistentId} updateOrder={updateOrder}>
