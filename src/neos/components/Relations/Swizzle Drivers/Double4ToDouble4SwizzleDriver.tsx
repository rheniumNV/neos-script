import { member, Member, Component } from "../../../core";
    ...
    export interface Double4ToDouble4SwizzleDriverInput {
...
W?: member<number>;
    ...
    export function Double4ToDouble4SwizzleDriver(props: Double4ToDouble4SwizzleDriverInput){
...
W, } = props;
      ...
      return (
        <Component type="FrooxEngine.Double4ToDouble4SwizzleDriver" id={id} persistentId={persistentId} updateOrder={updateOrder}>
...
<Member type={`FrooxEngine.FieldDrive\`1[BaseX.double4]`} name="Target" id={typeof Target === "object" && "id" in Target ? Target?.id : undefined} value={typeof Target === "object" && "value" in Target ? Target?.value : Target} /* default: ID0 */  isRaw={typeof Target === "object" && "isRaw" in Target && Target.isRaw ? true : undefined} />
