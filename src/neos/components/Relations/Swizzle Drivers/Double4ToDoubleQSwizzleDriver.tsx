import { member, Member, Component } from "../../../core";
    ...
    export interface Double4ToDoubleQSwizzleDriverInput {
...
W?: member<number>;
    ...
    export function Double4ToDoubleQSwizzleDriver(props: Double4ToDoubleQSwizzleDriverInput){
...
W, } = props;
      ...
      return (
        <Component type="FrooxEngine.Double4ToDoubleQSwizzleDriver" id={id} persistentId={persistentId} updateOrder={updateOrder}>
