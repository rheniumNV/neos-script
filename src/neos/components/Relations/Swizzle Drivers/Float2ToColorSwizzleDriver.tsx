import { member, Member, Component } from "../../../core";
    ...
    export interface Float2ToColorSwizzleDriverInput {
...
W?: member<number>;
    ...
    export function Float2ToColorSwizzleDriver(props: Float2ToColorSwizzleDriverInput){
...
W, } = props;
      ...
      return (
        <Component type="FrooxEngine.Float2ToColorSwizzleDriver" id={id} persistentId={persistentId} updateOrder={updateOrder}>
