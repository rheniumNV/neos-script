import { member, Member, Component } from "../../../core";
    ...
    export interface Float2ToFloat2SwizzleDriverInput {
...
Y?: member<number>;
    ...
    export function Float2ToFloat2SwizzleDriver(props: Float2ToFloat2SwizzleDriverInput){
...
Y, } = props;
      ...
      return (
        <Component type="FrooxEngine.Float2ToFloat2SwizzleDriver" id={id} persistentId={persistentId} updateOrder={updateOrder}>
