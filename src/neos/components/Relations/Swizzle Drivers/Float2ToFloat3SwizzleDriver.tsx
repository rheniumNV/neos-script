import { member, Member, Component } from "../../../core";
    ...
    export interface Float2ToFloat3SwizzleDriverInput {
...
Z?: member<number>;
    ...
    export function Float2ToFloat3SwizzleDriver(props: Float2ToFloat3SwizzleDriverInput){
...
Z, } = props;
      ...
      return (
        <Component type="FrooxEngine.Float2ToFloat3SwizzleDriver" id={id} persistentId={persistentId} updateOrder={updateOrder}>
