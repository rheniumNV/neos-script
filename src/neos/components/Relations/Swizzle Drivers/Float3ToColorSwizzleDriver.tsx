import { member, Member, Component } from "../../../core";
    ...
    export interface Float3ToColorSwizzleDriverInput {
...
W?: member<number>;
    ...
    export function Float3ToColorSwizzleDriver(props: Float3ToColorSwizzleDriverInput){
...
W, } = props;
      ...
      return (
        <Component type="FrooxEngine.Float3ToColorSwizzleDriver" id={id} persistentId={persistentId} updateOrder={updateOrder}>
