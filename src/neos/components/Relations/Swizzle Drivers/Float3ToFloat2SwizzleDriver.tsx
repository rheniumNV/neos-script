import { member, Member, Component } from "../../../core";
    ...
    export interface Float3ToFloat2SwizzleDriverInput {
...
Y?: member<number>;
    ...
    export function Float3ToFloat2SwizzleDriver(props: Float3ToFloat2SwizzleDriverInput){
...
Y, } = props;
      ...
      return (
        <Component type="FrooxEngine.Float3ToFloat2SwizzleDriver" id={id} persistentId={persistentId} updateOrder={updateOrder}>
