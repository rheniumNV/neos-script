import { member, Member, Component } from "../../../core";
    ...
    export interface Float3ToFloat3SwizzleDriverInput {
...
Z?: member<number>;
    ...
    export function Float3ToFloat3SwizzleDriver(props: Float3ToFloat3SwizzleDriverInput){
...
Z, } = props;
      ...
      return (
        <Component type="FrooxEngine.Float3ToFloat3SwizzleDriver" id={id} persistentId={persistentId} updateOrder={updateOrder}>
