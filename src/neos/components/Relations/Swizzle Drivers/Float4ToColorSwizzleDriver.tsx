import { member, Member, Component } from "../../../core";
    ...
    export interface Float4ToColorSwizzleDriverInput {
...
W?: member<number>;
    ...
    export function Float4ToColorSwizzleDriver(props: Float4ToColorSwizzleDriverInput){
...
W, } = props;
      ...
      return (
        <Component type="FrooxEngine.Float4ToColorSwizzleDriver" id={id} persistentId={persistentId} updateOrder={updateOrder}>
