import { member, Member, Component } from "../../../core";
    ...
    export interface Float4ToFloat3SwizzleDriverInput {
...
Z?: member<number>;
    ...
    export function Float4ToFloat3SwizzleDriver(props: Float4ToFloat3SwizzleDriverInput){
...
Z, } = props;
      ...
      return (
        <Component type="FrooxEngine.Float4ToFloat3SwizzleDriver" id={id} persistentId={persistentId} updateOrder={updateOrder}>
