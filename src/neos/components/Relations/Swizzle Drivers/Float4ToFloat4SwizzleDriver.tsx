import { member, Member, Component } from "../../../core";
    ...
    export interface Float4ToFloat4SwizzleDriverInput {
...
W?: member<number>;
    ...
    export function Float4ToFloat4SwizzleDriver(props: Float4ToFloat4SwizzleDriverInput){
...
W, } = props;
      ...
      return (
        <Component type="FrooxEngine.Float4ToFloat4SwizzleDriver" id={id} persistentId={persistentId} updateOrder={updateOrder}>
