import { member, Member, Component } from "../../../core";
    ...
    export interface Ulong2ToUlong4SwizzleDriverInput {
...
W?: member<number>;
    ...
    export function Ulong2ToUlong4SwizzleDriver(props: Ulong2ToUlong4SwizzleDriverInput){
...
W, } = props;
      ...
      return (
        <Component type="FrooxEngine.Ulong2ToUlong4SwizzleDriver" id={id} persistentId={persistentId} updateOrder={updateOrder}>
...
<Member type={`FrooxEngine.FieldDrive\`1[BaseX.ulong4]`} name="Target" id={typeof Target === "object" && "id" in Target ? Target?.id : undefined} value={typeof Target === "object" && "value" in Target ? Target?.value : Target} /* default: ID0 */  isRaw={typeof Target === "object" && "isRaw" in Target && Target.isRaw ? true : undefined} />
