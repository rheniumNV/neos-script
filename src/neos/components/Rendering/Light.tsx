...
<Member type={`FrooxEngine.Sync\`1[FrooxEngine.LightType]`} name="LightType" id={typeof LightType === "object" && "id" in LightType ? LightType?.id : undefined} value={typeof LightType === "object" && "value" in LightType ? LightType?.value : LightType} /* default: Point */  />
...
<Member type={`FrooxEngine.Sync\`1[System.Single]`} name="ShadowNearPlane" id={typeof ShadowNearPlane === "object" && "id" in ShadowNearPlane ? ShadowNearPlane?.id : undefined} value={typeof ShadowNearPlane === "object" && "value" in ShadowNearPlane ? ShadowNearPlane?.value : ShadowNearPlane} /* default: 0 */  />
<Member type={`FrooxEngine.Sync\`1[System.Int32]`} name="ShadowMapResolution" id={typeof ShadowMapResolution === "object" && "id" in ShadowMapResolution ? ShadowMapResolution?.id : undefined} value={typeof ShadowMapResolution === "object" && "value" in ShadowMapResolution ? ShadowMapResolution?.value : ShadowMapResolution} /* default: 0 */  />
...
<Member type={`FrooxEngine.AssetRef\`1[FrooxEngine.ITexture]`} name="Cookie" id={typeof Cookie === "object" && "id" in Cookie ? Cookie?.id : undefined} value={typeof Cookie === "object" && "value" in Cookie ? Cookie?.value : Cookie} /* default: ID0 */  />
        </Component>
      );
    };
