import { member, Member, Component } from "../../../../core";
    ...
    export interface CircleEmitterInput {
...
ForcedDirection?: member<[number, number, number]>;
    ...
    export function CircleEmitter(props: CircleEmitterInput){
...
ForcedDirection, } = props;
      ...
      return (
        <Component type="FrooxEngine.CircleEmitter" id={id} persistentId={persistentId} updateOrder={updateOrder}>
