...
DirectionReferencePoint, } = props;
      ...
      return (
        <Component type="FrooxEngine.ConeEmitter" id={id} persistentId={persistentId} updateOrder={updateOrder} version={1}>
...
<Member type={`FrooxEngine.Sync\`1[System.Single]`} name="BaseRadius" id={typeof BaseRadius === "object" && "id" in BaseRadius ? BaseRadius?.id : undefined} value={typeof BaseRadius === "object" && "value" in BaseRadius ? BaseRadius?.value : BaseRadius} /* default: 0 */  isRaw={typeof BaseRadius === "object" && "isRaw" in BaseRadius && BaseRadius.isRaw ? true : undefined} />
