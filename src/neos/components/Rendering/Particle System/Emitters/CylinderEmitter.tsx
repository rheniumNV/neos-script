import { member, Member, Component } from "../../../../core";
    ...
    export interface CylinderEmitterInput {
...
RandomDirection,
ForceDirection,
ForcedDirection, } = props;
    
      return (
        <Component type="FrooxEngine.CylinderEmitter" id={id} persistentId={persistentId} updateOrder={updateOrder}>
...
<Member type={`FrooxEngine.Sync\`1[System.Boolean]`} name="ExcludeCaps" id={typeof ExcludeCaps === "object" && "id" in ExcludeCaps ? ExcludeCaps?.id : undefined} value={typeof ExcludeCaps === "object" && "value" in ExcludeCaps ? ExcludeCaps?.value : ExcludeCaps} /* default: false */  isRaw={typeof ExcludeCaps === "object" && "isRaw" in ExcludeCaps && ExcludeCaps.isRaw ? true : undefined} />
