...
<Member type={`FrooxEngine.Sync\`1[System.Boolean]`} name="ExcludeCaps" id={typeof ExcludeCaps === "object" && "id" in ExcludeCaps ? ExcludeCaps?.id : undefined} value={typeof ExcludeCaps === "object" && "value" in ExcludeCaps ? ExcludeCaps?.value : ExcludeCaps} /* default: false */  />
