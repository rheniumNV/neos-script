...
<Member type={`FrooxEngine.DriveRef\`1[FrooxEngine.MultiLineMesh]`} name="_previewMesh" id={typeof _previewMesh === "object" && "id" in _previewMesh ? _previewMesh?.id : undefined} value={typeof _previewMesh === "object" && "value" in _previewMesh ? _previewMesh?.value : _previewMesh} /* default: ID0 */  />
...
<Member type={`FrooxEngine.SyncRef\`1[FrooxEngine.Slot]`} name="_sizeKnob" id={typeof _sizeKnob === "object" && "id" in _sizeKnob ? _sizeKnob?.id : undefined} value={typeof _sizeKnob === "object" && "value" in _sizeKnob ? _sizeKnob?.value : _sizeKnob} /* default: ID0 */  />
        </Component>
      );
    };
