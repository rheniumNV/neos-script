import { member, Member, Component } from "../../../core";
    ...
    export interface GeometryLineBrushTipInput {
...
LineStyles?: member<any>;
UseRelativeMinimumPointDistance?: member<boolean>;
RelativeMinimumPointDistanceRatio?: member<number>;
PressureAffectsSize?: member<boolean>;
MaterialPreviews?: member<any>;
_previewMesh?: member<any>;
_previewMeshOffset?: member<any>;
_sizeKnob?: member<any>;
    }
    
    export function GeometryLineBrushTip(props: GeometryLineBrushTipInput){
...
_sizeKnob, } = props;
      ...
      return (
        <Component type="FrooxEngine.GeometryLineBrushTip" id={id} persistentId={persistentId} updateOrder={updateOrder} version={1}>
...
<Member type={`FrooxEngine.SyncList\`1[FrooxEngine.GeometryLineBrushTip+Line]`} name="LineStyles" id={typeof LineStyles === "object" && "id" in LineStyles ? LineStyles?.id : undefined} value={typeof LineStyles === "object" && "value" in LineStyles ? LineStyles?.value : LineStyles} /* default: FrooxEngine.SyncList`1[FrooxEngine.GeometryLineBrushTip+Line] */  isRaw={typeof LineStyles === "object" && "isRaw" in LineStyles && LineStyles.isRaw ? true : undefined} />
<Member type={`FrooxEngine.Sync\`1[System.Boolean]`} name="UseRelativeMinimumPointDistance" id={typeof UseRelativeMinimumPointDistance === "object" && "id" in UseRelativeMinimumPointDistance ? UseRelativeMinimumPointDistance?.id : undefined} value={typeof UseRelativeMinimumPointDistance === "object" && "value" in UseRelativeMinimumPointDistance ? UseRelativeMinimumPointDistance?.value : UseRelativeMinimumPointDistance} /* default: false */  isRaw={typeof UseRelativeMinimumPointDistance === "object" && "isRaw" in UseRelativeMinimumPointDistance && UseRelativeMinimumPointDistance.isRaw ? true : undefined} />
<Member type={`FrooxEngine.Sync\`1[System.Single]`} name="RelativeMinimumPointDistanceRatio" id={typeof RelativeMinimumPointDistanceRatio === "object" && "id" in RelativeMinimumPointDistanceRatio ? RelativeMinimumPointDistanceRatio?.id : undefined} value={typeof RelativeMinimumPointDistanceRatio === "object" && "value" in RelativeMinimumPointDistanceRatio ? RelativeMinimumPointDistanceRatio?.value : RelativeMinimumPointDistanceRatio} /* default: 0 */  isRaw={typeof RelativeMinimumPointDistanceRatio === "object" && "isRaw" in RelativeMinimumPointDistanceRatio && RelativeMinimumPointDistanceRatio.isRaw ? true : undefined} />
...
<Member type={`FrooxEngine.DriveRef\`1[FrooxEngine.MultiLineMesh]`} name="_previewMesh" id={typeof _previewMesh === "object" && "id" in _previewMesh ? _previewMesh?.id : undefined} value={typeof _previewMesh === "object" && "value" in _previewMesh ? _previewMesh?.value : _previewMesh} /* default: ID0 */  isRaw={typeof _previewMesh === "object" && "isRaw" in _previewMesh && _previewMesh.isRaw ? true : undefined} />
...
<Member type={`FrooxEngine.SyncRef\`1[FrooxEngine.Slot]`} name="_sizeKnob" id={typeof _sizeKnob === "object" && "id" in _sizeKnob ? _sizeKnob?.id : undefined} value={typeof _sizeKnob === "object" && "value" in _sizeKnob ? _sizeKnob?.value : _sizeKnob} /* default: ID0 */  isRaw={typeof _sizeKnob === "object" && "isRaw" in _sizeKnob && _sizeKnob.isRaw ? true : undefined} />
        </Component>
      );
    };
