...
<Member type={`FrooxEngine.LogiX.Input\`1[BaseX.floatQ]`} name="QuadRotation" id={typeof QuadRotation === "object" && "id" in QuadRotation ? QuadRotation?.id : undefined} value={typeof QuadRotation === "object" && "value" in QuadRotation ? QuadRotation?.value : QuadRotation} /* default: ID0 */  />
...
<Member type={`FrooxEngine.DriveRef\`1[FrooxEngine.QuadArrayMesh]`} name="_previewMesh" id={typeof _previewMesh === "object" && "id" in _previewMesh ? _previewMesh?.id : undefined} value={typeof _previewMesh === "object" && "value" in _previewMesh ? _previewMesh?.value : _previewMesh} /* default: ID0 */  />
