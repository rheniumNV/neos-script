import { member, Member, Component } from "../../../core";
    ...
    export interface QuadBrushTipInput {
...
QuadRotation?: member<[number, number, number, number]>;
...
_previewMeshRotation?: member<any>;
    ...
    export function QuadBrushTip(props: QuadBrushTipInput){
...
_previewMeshRotation, } = props;
      ...
      return (
        <Component type="FrooxEngine.QuadBrushTip" id={id} persistentId={persistentId} updateOrder={updateOrder} version={1}>
...
<Member type={`FrooxEngine.LogiX.Input\`1[BaseX.floatQ]`} name="QuadRotation" id={typeof QuadRotation === "object" && "id" in QuadRotation ? QuadRotation?.id : undefined} value={typeof QuadRotation === "object" && "value" in QuadRotation ? QuadRotation?.value : QuadRotation} /* default: ID0 */  isRaw={typeof QuadRotation === "object" && "isRaw" in QuadRotation && QuadRotation.isRaw ? true : undefined} />
...
<Member type={`FrooxEngine.DriveRef\`1[FrooxEngine.QuadArrayMesh]`} name="_previewMesh" id={typeof _previewMesh === "object" && "id" in _previewMesh ? _previewMesh?.id : undefined} value={typeof _previewMesh === "object" && "value" in _previewMesh ? _previewMesh?.value : _previewMesh} /* default: ID0 */  isRaw={typeof _previewMesh === "object" && "isRaw" in _previewMesh && _previewMesh.isRaw ? true : undefined} />
