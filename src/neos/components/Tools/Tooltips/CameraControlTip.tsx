import { member, Member, Component } from "../../../core";
    ...
    export interface CameraControlTipInput {
...
_material?: member<any>;
    ...
    export function CameraControlTip(props: CameraControlTipInput){
...
_material, } = props;
      ...
      return (
        <Component type="FrooxEngine.CameraControlTip" id={id} persistentId={persistentId} updateOrder={updateOrder}>
...
<Member type={`FrooxEngine.Sync\`1[FrooxEngine.CameraControlTip+CameraMode]`} name="Mode" id={typeof Mode === "object" && "id" in Mode ? Mode?.id : undefined} value={typeof Mode === "object" && "value" in Mode ? Mode?.value : Mode} /* default: BiggestGroup */  isRaw={typeof Mode === "object" && "isRaw" in Mode && Mode.isRaw ? true : undefined} />
<Member type={`FrooxEngine.DriveRef\`1[FrooxEngine.FresnelMaterial]`} name="_material" id={typeof _material === "object" && "id" in _material ? _material?.id : undefined} value={typeof _material === "object" && "value" in _material ? _material?.value : _material} /* default: ID0 */  isRaw={typeof _material === "object" && "isRaw" in _material && _material.isRaw ? true : undefined} />
        </Component>
      );
    };
