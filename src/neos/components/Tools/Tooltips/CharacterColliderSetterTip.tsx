...
<Member type={`FrooxEngine.Sync\`1[System.Boolean]`} name="MarkGrippable" id={typeof MarkGrippable === "object" && "id" in MarkGrippable ? MarkGrippable?.id : undefined} value={typeof MarkGrippable === "object" && "value" in MarkGrippable ? MarkGrippable?.value : MarkGrippable} /* default: false */  />
<Member type={`FrooxEngine.SyncRef\`1[FrooxEngine.NeosLogoMenuController+Item]`} name="_markGrippable" id={typeof _markGrippable === "object" && "id" in _markGrippable ? _markGrippable?.id : undefined} value={typeof _markGrippable === "object" && "value" in _markGrippable ? _markGrippable?.value : _markGrippable} /* default: ID0 */  />
