import { member, Member, Component } from "../../../core";
    ...
    export interface ControllerDiagnosticTipInput {
...
_text?: member<any>;
    ...
    export function ControllerDiagnosticTip(props: ControllerDiagnosticTipInput){
...
_text, } = props;
      ...
      return (
        <Component type="FrooxEngine.ControllerDiagnosticTip" id={id} persistentId={persistentId} updateOrder={updateOrder}>
