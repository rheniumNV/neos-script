...
<Member type={`FrooxEngine.SyncRef\`1[FrooxEngine.PBS_Metallic]`} name="Material" id={typeof Material === "object" && "id" in Material ? Material?.id : undefined} value={typeof Material === "object" && "value" in Material ? Material?.value : Material} /* default: ID0 */  />
<Member type={`FrooxEngine.SyncRef\`1[FrooxEngine.BezierCurve]`} name="ActiveCurve" id={typeof ActiveCurve === "object" && "id" in ActiveCurve ? ActiveCurve?.id : undefined} value={typeof ActiveCurve === "object" && "value" in ActiveCurve ? ActiveCurve?.value : ActiveCurve} /* default: ID0 */  />
<Member type={`FrooxEngine.SyncRef\`1[FrooxEngine.CurvePoint]`} name="ActivePoint" id={typeof ActivePoint === "object" && "id" in ActivePoint ? ActivePoint?.id : undefined} value={typeof ActivePoint === "object" && "value" in ActivePoint ? ActivePoint?.value : ActivePoint} /* default: ID0 */  />
        </Component>
      );
    };
