import { member, Member, Component } from "../../../core";
    ...
    export interface DuplicatorTipInput {
...
_gripPosesGenerated?: member<boolean>;
    ...
    export function DuplicatorTip(props: DuplicatorTipInput){
...
_gripPosesGenerated, } = props;
      ...
      return (
        <Component type="FrooxEngine.DuplicatorTip" id={id} persistentId={persistentId} updateOrder={updateOrder}>
