...
<Member type={`FrooxEngine.Sync\`1[System.Boolean]`} name="SetScalable" id={typeof SetScalable === "object" && "id" in SetScalable ? SetScalable?.id : undefined} value={typeof SetScalable === "object" && "value" in SetScalable ? SetScalable?.value : SetScalable} /* default: false */  isRaw={typeof SetScalable === "object" && "isRaw" in SetScalable && SetScalable.isRaw ? true : undefined} />
