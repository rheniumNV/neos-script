import { member, Member, Component } from "../../../core";
    ...
    export interface InteractiveCameraObjectExcludeTipInput {
...
ApplyToObjectRoot?: member<boolean>;
    ...
    export function InteractiveCameraObjectExcludeTip(props: InteractiveCameraObjectExcludeTipInput){
...
_overrideActiveTool,
_gripPosesGenerated,
ApplyToObjectRoot, } = props;
    
      return (
        <Component type="FrooxEngine.InteractiveCameraObjectExcludeTip" id={id} persistentId={persistentId} updateOrder={updateOrder}>
