import { member, Member, Component } from "../../../core";
    ...
    export interface LabelerTipInput {
...
_gripPosesGenerated?: member<boolean>;
    ...
    export function LabelerTip(props: LabelerTipInput){
...
_gripPosesGenerated, } = props;
      ...
      return (
        <Component type="FrooxEngine.LabelerTip" id={id} persistentId={persistentId} updateOrder={updateOrder}>
