...
_orbSlot?: member<any>;
    ...
    export function MeshTip(props: MeshTipInput){
...
_orbSlot, } = props;
      ...
      return (
        <Component type="FrooxEngine.MeshTip" id={id} persistentId={persistentId} updateOrder={updateOrder}>
