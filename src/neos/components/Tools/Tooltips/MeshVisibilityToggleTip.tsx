...
<Member type={`FrooxEngine.Sync\`1[System.Nullable\`1[FrooxEngine.ShadowCastMode]]`} name="SetShadowCastMode" id={typeof SetShadowCastMode === "object" && "id" in SetShadowCastMode ? SetShadowCastMode?.id : undefined} value={typeof SetShadowCastMode === "object" && "value" in SetShadowCastMode ? SetShadowCastMode?.value : SetShadowCastMode} /* default: <i>null</i> */  />
        </Component>
      );
    };
