import { member, Member, Component } from "../../../core";
    ...
    export interface MeshVisibilityToggleTipInput {
...
SetShadowCastMode?: member<any>;
    }
    
    export function MeshVisibilityToggleTip(props: MeshVisibilityToggleTipInput){
...
_gripPosesGenerated,
ApplyToObjectRoot,
SetShadowCastMode, } = props;
    
      return (
        <Component type="FrooxEngine.MeshVisibilityToggleTip" id={id} persistentId={persistentId} updateOrder={updateOrder}>
...
<Member type={`FrooxEngine.Sync\`1[System.Nullable\`1[FrooxEngine.ShadowCastMode]]`} name="SetShadowCastMode" id={typeof SetShadowCastMode === "object" && "id" in SetShadowCastMode ? SetShadowCastMode?.id : undefined} value={typeof SetShadowCastMode === "object" && "value" in SetShadowCastMode ? SetShadowCastMode?.value : SetShadowCastMode} /* default: <i>null</i> */  isRaw={typeof SetShadowCastMode === "object" && "isRaw" in SetShadowCastMode && SetShadowCastMode.isRaw ? true : undefined} />
        </Component>
      );
    };
