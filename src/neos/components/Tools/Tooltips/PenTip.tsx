...
<Member type={`FrooxEngine.Sync\`1[System.Boolean]`} name="Flat" id={typeof Flat === "object" && "id" in Flat ? Flat?.id : undefined} value={typeof Flat === "object" && "value" in Flat ? Flat?.value : Flat} /* default: false */  />
...
<Member type={`FrooxEngine.SyncRef\`1[FrooxEngine.Slot]`} name="_flatTip" id={typeof _flatTip === "object" && "id" in _flatTip ? _flatTip?.id : undefined} value={typeof _flatTip === "object" && "value" in _flatTip ? _flatTip?.value : _flatTip} /* default: ID0 */  />
        </Component>
      );
    };
