...
<Member type={`FrooxEngine.Sync\`1[BaseX.float3]`} name="LocalTipOffset" id={typeof LocalTipOffset === "object" && "id" in LocalTipOffset ? LocalTipOffset?.id : undefined} value={typeof LocalTipOffset === "object" && "value" in LocalTipOffset ? LocalTipOffset?.value : LocalTipOffset} /* default: [0; 0; 0] */  isRaw={typeof LocalTipOffset === "object" && "isRaw" in LocalTipOffset && LocalTipOffset.isRaw ? true : undefined} />
<Member type={`FrooxEngine.SyncRef\`1[FrooxEngine.Slot]`} name="LocalTipReference" id={typeof LocalTipReference === "object" && "id" in LocalTipReference ? LocalTipReference?.id : undefined} value={typeof LocalTipReference === "object" && "value" in LocalTipReference ? LocalTipReference?.value : LocalTipReference} /* default: ID0 */  isRaw={typeof LocalTipReference === "object" && "isRaw" in LocalTipReference && LocalTipReference.isRaw ? true : undefined} />
<Member type={`FrooxEngine.Sync\`1[System.Boolean]`} name="UseLaser" id={typeof UseLaser === "object" && "id" in UseLaser ? UseLaser?.id : undefined} value={typeof UseLaser === "object" && "value" in UseLaser ? UseLaser?.value : UseLaser} /* default: false */  isRaw={typeof UseLaser === "object" && "isRaw" in UseLaser && UseLaser.isRaw ? true : undefined} />
<Member type={`FrooxEngine.Sync\`1[System.Boolean]`} name="BlockPrimaryWhenTouching" id={typeof BlockPrimaryWhenTouching === "object" && "id" in BlockPrimaryWhenTouching ? BlockPrimaryWhenTouching?.id : undefined} value={typeof BlockPrimaryWhenTouching === "object" && "value" in BlockPrimaryWhenTouching ? BlockPrimaryWhenTouching?.value : BlockPrimaryWhenTouching} /* default: false */  isRaw={typeof BlockPrimaryWhenTouching === "object" && "isRaw" in BlockPrimaryWhenTouching && BlockPrimaryWhenTouching.isRaw ? true : undefined} />
<Member type={`FrooxEngine.Sync\`1[System.Boolean]`} name="UseSecondary" id={typeof UseSecondary === "object" && "id" in UseSecondary ? UseSecondary?.id : undefined} value={typeof UseSecondary === "object" && "value" in UseSecondary ? UseSecondary?.value : UseSecondary} /* default: false */  isRaw={typeof UseSecondary === "object" && "isRaw" in UseSecondary && UseSecondary.isRaw ? true : undefined} />
<Member type={`FrooxEngine.Sync\`1[System.Boolean]`} name="AllowUseWhenHolding" id={typeof AllowUseWhenHolding === "object" && "id" in AllowUseWhenHolding ? AllowUseWhenHolding?.id : undefined} value={typeof AllowUseWhenHolding === "object" && "value" in AllowUseWhenHolding ? AllowUseWhenHolding?.value : AllowUseWhenHolding} /* default: false */  isRaw={typeof AllowUseWhenHolding === "object" && "isRaw" in AllowUseWhenHolding && AllowUseWhenHolding.isRaw ? true : undefined} />
<Member type={`FrooxEngine.Sync\`1[System.Boolean]`} name="Equipped" id={typeof Equipped === "object" && "id" in Equipped ? Equipped?.id : undefined} value={typeof Equipped === "object" && "value" in Equipped ? Equipped?.value : Equipped} /* default: false */  isRaw={typeof Equipped === "object" && "isRaw" in Equipped && Equipped.isRaw ? true : undefined} />
...
<Member type={`FrooxEngine.RawOutput\`1[System.Boolean]`} name="Primary" id={typeof Primary === "object" && "id" in Primary ? Primary?.id : undefined} value={typeof Primary === "object" && "value" in Primary ? Primary?.value : Primary} /* default: FrooxEngine.RawOutput`1[System.Boolean] */  isRaw={typeof Primary === "object" && "isRaw" in Primary && Primary.isRaw ? true : undefined} />
<Member type={`FrooxEngine.RawOutput\`1[System.Boolean]`} name="Secondary" id={typeof Secondary === "object" && "id" in Secondary ? Secondary?.id : undefined} value={typeof Secondary === "object" && "value" in Secondary ? Secondary?.value : Secondary} /* default: FrooxEngine.RawOutput`1[System.Boolean] */  isRaw={typeof Secondary === "object" && "isRaw" in Secondary && Secondary.isRaw ? true : undefined} />
<Member type={`FrooxEngine.SyncRef\`1[FrooxEngine.ValueStream\`1[System.Single]]`} name="_primaryStrengthStream" id={typeof _primaryStrengthStream === "object" && "id" in _primaryStrengthStream ? _primaryStrengthStream?.id : undefined} value={typeof _primaryStrengthStream === "object" && "value" in _primaryStrengthStream ? _primaryStrengthStream?.value : _primaryStrengthStream} /* default: ID0 */  isRaw={typeof _primaryStrengthStream === "object" && "isRaw" in _primaryStrengthStream && _primaryStrengthStream.isRaw ? true : undefined} />
<Member type={`FrooxEngine.SyncRef\`1[FrooxEngine.ValueStream\`1[BaseX.float2]]`} name="_secondaryAxisStream" id={typeof _secondaryAxisStream === "object" && "id" in _secondaryAxisStream ? _secondaryAxisStream?.id : undefined} value={typeof _secondaryAxisStream === "object" && "value" in _secondaryAxisStream ? _secondaryAxisStream?.value : _secondaryAxisStream} /* default: ID0 */  isRaw={typeof _secondaryAxisStream === "object" && "isRaw" in _secondaryAxisStream && _secondaryAxisStream.isRaw ? true : undefined} />
...
<Member type={`FrooxEngine.Sync\`1[System.Single]`} name="_rawStrength" id={typeof _rawStrength === "object" && "id" in _rawStrength ? _rawStrength?.id : undefined} value={typeof _rawStrength === "object" && "value" in _rawStrength ? _rawStrength?.value : _rawStrength} /* default: 0 */  isRaw={typeof _rawStrength === "object" && "isRaw" in _rawStrength && _rawStrength.isRaw ? true : undefined} />
<Member type={`FrooxEngine.Sync\`1[BaseX.float2]`} name="_rawAxis" id={typeof _rawAxis === "object" && "id" in _rawAxis ? _rawAxis?.id : undefined} value={typeof _rawAxis === "object" && "value" in _rawAxis ? _rawAxis?.value : _rawAxis} /* default: [0; 0] */  isRaw={typeof _rawAxis === "object" && "isRaw" in _rawAxis && _rawAxis.isRaw ? true : undefined} />
<Member type={`FrooxEngine.Sync\`1[System.Boolean]`} name="_rawPrimary" id={typeof _rawPrimary === "object" && "id" in _rawPrimary ? _rawPrimary?.id : undefined} value={typeof _rawPrimary === "object" && "value" in _rawPrimary ? _rawPrimary?.value : _rawPrimary} /* default: false */  isRaw={typeof _rawPrimary === "object" && "isRaw" in _rawPrimary && _rawPrimary.isRaw ? true : undefined} />
<Member type={`FrooxEngine.Sync\`1[System.Boolean]`} name="_rawSecondary" id={typeof _rawSecondary === "object" && "id" in _rawSecondary ? _rawSecondary?.id : undefined} value={typeof _rawSecondary === "object" && "value" in _rawSecondary ? _rawSecondary?.value : _rawSecondary} /* default: false */  isRaw={typeof _rawSecondary === "object" && "isRaw" in _rawSecondary && _rawSecondary.isRaw ? true : undefined} />
<Member type={`FrooxEngine.Sync\`1[System.String]`} name="UniqueTutorialKey" id={typeof UniqueTutorialKey === "object" && "id" in UniqueTutorialKey ? UniqueTutorialKey?.id : undefined} value={typeof UniqueTutorialKey === "object" && "value" in UniqueTutorialKey ? UniqueTutorialKey?.value : UniqueTutorialKey} /* default: <i>null</i> */  isRaw={typeof UniqueTutorialKey === "object" && "isRaw" in UniqueTutorialKey && UniqueTutorialKey.isRaw ? true : undefined} />
<Member type={`FrooxEngine.Sync\`1[System.String]`} name="PrimaryTutorialDescription" id={typeof PrimaryTutorialDescription === "object" && "id" in PrimaryTutorialDescription ? PrimaryTutorialDescription?.id : undefined} value={typeof PrimaryTutorialDescription === "object" && "value" in PrimaryTutorialDescription ? PrimaryTutorialDescription?.value : PrimaryTutorialDescription} /* default: <i>null</i> */  isRaw={typeof PrimaryTutorialDescription === "object" && "isRaw" in PrimaryTutorialDescription && PrimaryTutorialDescription.isRaw ? true : undefined} />
<Member type={`FrooxEngine.Sync\`1[System.String]`} name="SecondaryTutorialDescription" id={typeof SecondaryTutorialDescription === "object" && "id" in SecondaryTutorialDescription ? SecondaryTutorialDescription?.id : undefined} value={typeof SecondaryTutorialDescription === "object" && "value" in SecondaryTutorialDescription ? SecondaryTutorialDescription?.value : SecondaryTutorialDescription} /* default: <i>null</i> */  isRaw={typeof SecondaryTutorialDescription === "object" && "isRaw" in SecondaryTutorialDescription && SecondaryTutorialDescription.isRaw ? true : undefined} />
        </Component>
      );
    };
