...
<Member type={`FrooxEngine.SyncRef\`1[FrooxEngine.Rig]`} name="SourceRig" id={typeof SourceRig === "object" && "id" in SourceRig ? SourceRig?.id : undefined} value={typeof SourceRig === "object" && "value" in SourceRig ? SourceRig?.value : SourceRig} /* default: ID0 */  />
