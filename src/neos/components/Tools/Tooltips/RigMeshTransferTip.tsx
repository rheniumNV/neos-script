import { member, Member, Component } from "../../../core";
    ...
    export interface RigMeshTransferTipInput {
...
SourceRig?: member<any>;
_label?: member<any>;
    }
    
    export function RigMeshTransferTip(props: RigMeshTransferTipInput){
...
_label, } = props;
      ...
      return (
        <Component type="FrooxEngine.RigMeshTransferTip" id={id} persistentId={persistentId} updateOrder={updateOrder}>
...
<Member type={`FrooxEngine.SyncRef\`1[FrooxEngine.Rig]`} name="SourceRig" id={typeof SourceRig === "object" && "id" in SourceRig ? SourceRig?.id : undefined} value={typeof SourceRig === "object" && "value" in SourceRig ? SourceRig?.value : SourceRig} /* default: ID0 */  isRaw={typeof SourceRig === "object" && "isRaw" in SourceRig && SourceRig.isRaw ? true : undefined} />
