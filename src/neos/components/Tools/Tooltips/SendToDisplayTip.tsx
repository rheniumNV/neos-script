...
<Member type={`FrooxEngine.Sync\`1[System.Boolean]`} name="PersistentLink" id={typeof PersistentLink === "object" && "id" in PersistentLink ? PersistentLink?.id : undefined} value={typeof PersistentLink === "object" && "value" in PersistentLink ? PersistentLink?.value : PersistentLink} /* default: false */  isRaw={typeof PersistentLink === "object" && "isRaw" in PersistentLink && PersistentLink.isRaw ? true : undefined} />
