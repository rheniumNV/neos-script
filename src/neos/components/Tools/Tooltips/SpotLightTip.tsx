import { member, Member, Component } from "../../../core";
    ...
    export interface SpotLightTipInput {
...
Light?: member<any>;
    ...
    export function SpotLightTip(props: SpotLightTipInput){
...
Light, } = props;
      ...
      return (
        <Component type="FrooxEngine.SpotLightTip" id={id} persistentId={persistentId} updateOrder={updateOrder}>
...
<Member type={`FrooxEngine.SyncRef\`1[FrooxEngine.Light]`} name="Light" id={typeof Light === "object" && "id" in Light ? Light?.id : undefined} value={typeof Light === "object" && "value" in Light ? Light?.value : Light} /* default: ID0 */  />
        </Component>
      );
    };
