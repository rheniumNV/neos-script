...
<Member type={`FrooxEngine.SyncRef\`1[FrooxEngine.Light]`} name="Light" id={typeof Light === "object" && "id" in Light ? Light?.id : undefined} value={typeof Light === "object" && "value" in Light ? Light?.value : Light} /* default: ID0 */  isRaw={typeof Light === "object" && "isRaw" in Light && Light.isRaw ? true : undefined} />
        </Component>
      );
    };
