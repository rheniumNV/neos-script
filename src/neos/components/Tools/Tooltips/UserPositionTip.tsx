import { member, Member, Component } from "../../../core";
    ...
    export interface UserPositionTipInput {
...
UserSeparationOffset?: member<number>;
    }
    
    export function UserPositionTip(props: UserPositionTipInput){
...
_overrideActiveTool,
_gripPosesGenerated,
UserSeparationOffset, } = props;
    
      return (
        <Component type="FrooxEngine.UserPositionTip" id={id} persistentId={persistentId} updateOrder={updateOrder}>
...
<Member type={`FrooxEngine.Sync\`1[System.Single]`} name="UserSeparationOffset" id={typeof UserSeparationOffset === "object" && "id" in UserSeparationOffset ? UserSeparationOffset?.id : undefined} value={typeof UserSeparationOffset === "object" && "value" in UserSeparationOffset ? UserSeparationOffset?.value : UserSeparationOffset} /* default: 0 */  isRaw={typeof UserSeparationOffset === "object" && "isRaw" in UserSeparationOffset && UserSeparationOffset.isRaw ? true : undefined} />
        </Component>
      );
    };
