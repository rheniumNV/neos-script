...
<Member type={`FrooxEngine.Sync\`1[System.Single]`} name="UserSeparationOffset" id={typeof UserSeparationOffset === "object" && "id" in UserSeparationOffset ? UserSeparationOffset?.id : undefined} value={typeof UserSeparationOffset === "object" && "value" in UserSeparationOffset ? UserSeparationOffset?.value : UserSeparationOffset} /* default: 0 */  />
        </Component>
      );
    };
