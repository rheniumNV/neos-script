import { member, Member, Component } from "../../../core";
    ...
    export interface WigglerApplierInput {
...
_gripPosesGenerated?: member<boolean>;
    ...
    export function WigglerApplier(props: WigglerApplierInput){
...
_gripPosesGenerated, } = props;
      ...
      return (
        <Component type="FrooxEngine.WigglerApplier" id={id} persistentId={persistentId} updateOrder={updateOrder}>
