...
<Member type={`FrooxEngine.Sync\`1[System.Single]`} name="RetargetDistance" id={typeof RetargetDistance === "object" && "id" in RetargetDistance ? RetargetDistance?.id : undefined} value={typeof RetargetDistance === "object" && "value" in RetargetDistance ? RetargetDistance?.value : RetargetDistance} /* default: 0 */  isRaw={typeof RetargetDistance === "object" && "isRaw" in RetargetDistance && RetargetDistance.isRaw ? true : undefined} />
...
<Member type={`FrooxEngine.SyncRef\`1[FrooxEngine.User]`} name="TargetedUser" id={typeof TargetedUser === "object" && "id" in TargetedUser ? TargetedUser?.id : undefined} value={typeof TargetedUser === "object" && "value" in TargetedUser ? TargetedUser?.value : TargetedUser} /* default: ID0 */  isRaw={typeof TargetedUser === "object" && "isRaw" in TargetedUser && TargetedUser.isRaw ? true : undefined} />
<Member type={`FrooxEngine.Sync\`1[System.Boolean]`} name="AutoTarget" id={typeof AutoTarget === "object" && "id" in AutoTarget ? AutoTarget?.id : undefined} value={typeof AutoTarget === "object" && "value" in AutoTarget ? AutoTarget?.value : AutoTarget} /* default: false */  isRaw={typeof AutoTarget === "object" && "isRaw" in AutoTarget && AutoTarget.isRaw ? true : undefined} />
<Member type={`FrooxEngine.Sync\`1[System.Boolean]`} name="ExcludeActiveUser" id={typeof ExcludeActiveUser === "object" && "id" in ExcludeActiveUser ? ExcludeActiveUser?.id : undefined} value={typeof ExcludeActiveUser === "object" && "value" in ExcludeActiveUser ? ExcludeActiveUser?.value : ExcludeActiveUser} /* default: false */  isRaw={typeof ExcludeActiveUser === "object" && "isRaw" in ExcludeActiveUser && ExcludeActiveUser.isRaw ? true : undefined} />
