...
Clamp?: member<boolean>;
    ...
    export function LinearColorMapper(props: LinearColorMapperInput){
...
Clamp, } = props;
      ...
      return (
        <Component type="FrooxEngine.LinearColorMapper" id={id} persistentId={persistentId} updateOrder={updateOrder}>
...
<Member type={`FrooxEngine.FieldDrive\`1[BaseX.color]`} name="Target" id={typeof Target === "object" && "id" in Target ? Target?.id : undefined} value={typeof Target === "object" && "value" in Target ? Target?.value : Target} /* default: ID0 */  isRaw={typeof Target === "object" && "isRaw" in Target && Target.isRaw ? true : undefined} />
...
<Member type={`FrooxEngine.Sync\`1[BaseX.color]`} name="TargetMin" id={typeof TargetMin === "object" && "id" in TargetMin ? TargetMin?.id : undefined} value={typeof TargetMin === "object" && "value" in TargetMin ? TargetMin?.value : TargetMin} /* default: [0; 0; 0; 0] */  isRaw={typeof TargetMin === "object" && "isRaw" in TargetMin && TargetMin.isRaw ? true : undefined} />
<Member type={`FrooxEngine.Sync\`1[BaseX.color]`} name="TargetMax" id={typeof TargetMax === "object" && "id" in TargetMax ? TargetMax?.id : undefined} value={typeof TargetMax === "object" && "value" in TargetMax ? TargetMax?.value : TargetMax} /* default: [0; 0; 0; 0] */  isRaw={typeof TargetMax === "object" && "isRaw" in TargetMax && TargetMax.isRaw ? true : undefined} />
