...
Clamp?: member<boolean>;
    ...
    export function LinearMapper2D(props: LinearMapper2DInput){
...
Clamp, } = props;
      ...
      return (
        <Component type="FrooxEngine.LinearMapper2D" id={id} persistentId={persistentId} updateOrder={updateOrder}>
...
<Member type={`FrooxEngine.Sync\`1[BaseX.float2]`} name="TargetMin" id={typeof TargetMin === "object" && "id" in TargetMin ? TargetMin?.id : undefined} value={typeof TargetMin === "object" && "value" in TargetMin ? TargetMin?.value : TargetMin} /* default: [0; 0] */  isRaw={typeof TargetMin === "object" && "isRaw" in TargetMin && TargetMin.isRaw ? true : undefined} />
<Member type={`FrooxEngine.Sync\`1[BaseX.float2]`} name="TargetMax" id={typeof TargetMax === "object" && "id" in TargetMax ? TargetMax?.id : undefined} value={typeof TargetMax === "object" && "value" in TargetMax ? TargetMax?.value : TargetMax} /* default: [0; 0] */  isRaw={typeof TargetMax === "object" && "isRaw" in TargetMax && TargetMax.isRaw ? true : undefined} />
