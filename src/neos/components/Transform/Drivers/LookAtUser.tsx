...
<Member type={`FrooxEngine.Sync\`1[System.Boolean]`} name="TargetAtLocalUser" id={typeof TargetAtLocalUser === "object" && "id" in TargetAtLocalUser ? TargetAtLocalUser?.id : undefined} value={typeof TargetAtLocalUser === "object" && "value" in TargetAtLocalUser ? TargetAtLocalUser?.value : TargetAtLocalUser} /* default: false */  isRaw={typeof TargetAtLocalUser === "object" && "isRaw" in TargetAtLocalUser && TargetAtLocalUser.isRaw ? true : undefined} />
<Member type={`FrooxEngine.Sync\`1[BaseX.float3]`} name="SourcePositionOffset" id={typeof SourcePositionOffset === "object" && "id" in SourcePositionOffset ? SourcePositionOffset?.id : undefined} value={typeof SourcePositionOffset === "object" && "value" in SourcePositionOffset ? SourcePositionOffset?.value : SourcePositionOffset} /* default: [0; 0; 0] */  isRaw={typeof SourcePositionOffset === "object" && "isRaw" in SourcePositionOffset && SourcePositionOffset.isRaw ? true : undefined} />
<Member type={`FrooxEngine.Sync\`1[System.Boolean]`} name="Invert" id={typeof Invert === "object" && "id" in Invert ? Invert?.id : undefined} value={typeof Invert === "object" && "value" in Invert ? Invert?.value : Invert} /* default: false */  isRaw={typeof Invert === "object" && "isRaw" in Invert && Invert.isRaw ? true : undefined} />
...
<Member type={`FrooxEngine.Sync\`1[FrooxEngine.LookAtUser+UserNode]`} name="PositionSource" id={typeof PositionSource === "object" && "id" in PositionSource ? PositionSource?.id : undefined} value={typeof PositionSource === "object" && "value" in PositionSource ? PositionSource?.value : PositionSource} /* default: Root */  isRaw={typeof PositionSource === "object" && "isRaw" in PositionSource && PositionSource.isRaw ? true : undefined} />
<Member type={`FrooxEngine.Sync\`1[System.Boolean]`} name="AroundAxis" id={typeof AroundAxis === "object" && "id" in AroundAxis ? AroundAxis?.id : undefined} value={typeof AroundAxis === "object" && "value" in AroundAxis ? AroundAxis?.value : AroundAxis} /* default: false */  isRaw={typeof AroundAxis === "object" && "isRaw" in AroundAxis && AroundAxis.isRaw ? true : undefined} />
