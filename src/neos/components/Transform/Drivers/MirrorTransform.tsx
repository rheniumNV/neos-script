...
<Member type={`FrooxEngine.SyncRef\`1[FrooxEngine.Slot]`} name="MirrorSource" id={typeof MirrorSource === "object" && "id" in MirrorSource ? MirrorSource?.id : undefined} value={typeof MirrorSource === "object" && "value" in MirrorSource ? MirrorSource?.value : MirrorSource} /* default: ID0 */  isRaw={typeof MirrorSource === "object" && "isRaw" in MirrorSource && MirrorSource.isRaw ? true : undefined} />
<Member type={`FrooxEngine.SyncRef\`1[FrooxEngine.Slot]`} name="MirrorPlane" id={typeof MirrorPlane === "object" && "id" in MirrorPlane ? MirrorPlane?.id : undefined} value={typeof MirrorPlane === "object" && "value" in MirrorPlane ? MirrorPlane?.value : MirrorPlane} /* default: ID0 */  isRaw={typeof MirrorPlane === "object" && "isRaw" in MirrorPlane && MirrorPlane.isRaw ? true : undefined} />
<Member type={`FrooxEngine.Sync\`1[BaseX.float3]`} name="MirrorOffset" id={typeof MirrorOffset === "object" && "id" in MirrorOffset ? MirrorOffset?.id : undefined} value={typeof MirrorOffset === "object" && "value" in MirrorOffset ? MirrorOffset?.value : MirrorOffset} /* default: [0; 0; 0] */  isRaw={typeof MirrorOffset === "object" && "isRaw" in MirrorOffset && MirrorOffset.isRaw ? true : undefined} />
<Member type={`FrooxEngine.Sync\`1[BaseX.float3]`} name="MirrorNormal" id={typeof MirrorNormal === "object" && "id" in MirrorNormal ? MirrorNormal?.id : undefined} value={typeof MirrorNormal === "object" && "value" in MirrorNormal ? MirrorNormal?.value : MirrorNormal} /* default: [0; 0; 0] */  isRaw={typeof MirrorNormal === "object" && "isRaw" in MirrorNormal && MirrorNormal.isRaw ? true : undefined} />
