...
<Member type={`FrooxEngine.Sync\`1[BaseX.float2]`} name="_offset" id={typeof _offset === "object" && "id" in _offset ? _offset?.id : undefined} value={typeof _offset === "object" && "value" in _offset ? _offset?.value : _offset} /* default: [0; 0] */  />
<Member type={`FrooxEngine.Sync\`1[BaseX.float2]`} name="_preOffset" id={typeof _preOffset === "object" && "id" in _preOffset ? _preOffset?.id : undefined} value={typeof _preOffset === "object" && "value" in _preOffset ? _preOffset?.value : _preOffset} /* default: [0; 0] */  />
...
<Member type={`FrooxEngine.Sync\`1[BaseX.float2]`} name="_repeat" id={typeof _repeat === "object" && "id" in _repeat ? _repeat?.id : undefined} value={typeof _repeat === "object" && "value" in _repeat ? _repeat?.value : _repeat} /* default: [0; 0] */  />
