...
<Member type={`FrooxEngine.Sync\`1[BaseX.float3]`} name="_offset" id={typeof _offset === "object" && "id" in _offset ? _offset?.id : undefined} value={typeof _offset === "object" && "value" in _offset ? _offset?.value : _offset} /* default: [0; 0; 0] */  isRaw={typeof _offset === "object" && "isRaw" in _offset && _offset.isRaw ? true : undefined} />
<Member type={`FrooxEngine.Sync\`1[BaseX.float3]`} name="_preOffset" id={typeof _preOffset === "object" && "id" in _preOffset ? _preOffset?.id : undefined} value={typeof _preOffset === "object" && "value" in _preOffset ? _preOffset?.value : _preOffset} /* default: [0; 0; 0] */  isRaw={typeof _preOffset === "object" && "isRaw" in _preOffset && _preOffset.isRaw ? true : undefined} />
...
<Member type={`FrooxEngine.Sync\`1[BaseX.float3]`} name="_repeat" id={typeof _repeat === "object" && "id" in _repeat ? _repeat?.id : undefined} value={typeof _repeat === "object" && "value" in _repeat ? _repeat?.value : _repeat} /* default: [0; 0; 0] */  isRaw={typeof _repeat === "object" && "isRaw" in _repeat && _repeat.isRaw ? true : undefined} />
