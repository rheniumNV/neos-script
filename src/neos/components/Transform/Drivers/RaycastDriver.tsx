...
<Member type={`FrooxEngine.SyncRef\`1[FrooxEngine.Slot]`} name="IgnoreHierarchy" id={typeof IgnoreHierarchy === "object" && "id" in IgnoreHierarchy ? IgnoreHierarchy?.id : undefined} value={typeof IgnoreHierarchy === "object" && "value" in IgnoreHierarchy ? IgnoreHierarchy?.value : IgnoreHierarchy} /* default: ID0 */  />
<Member type={`FrooxEngine.Sync\`1[System.Single]`} name="FilterDistance" id={typeof FilterDistance === "object" && "id" in FilterDistance ? FilterDistance?.id : undefined} value={typeof FilterDistance === "object" && "value" in FilterDistance ? FilterDistance?.value : FilterDistance} /* default: 0 */  />
<Member type={`FrooxEngine.SyncRef\`1[FrooxEngine.Slot]`} name="Origin" id={typeof Origin === "object" && "id" in Origin ? Origin?.id : undefined} value={typeof Origin === "object" && "value" in Origin ? Origin?.value : Origin} /* default: ID0 */  />
...
<Member type={`FrooxEngine.Sync\`1[System.Single]`} name="NoHitDistance" id={typeof NoHitDistance === "object" && "id" in NoHitDistance ? NoHitDistance?.id : undefined} value={typeof NoHitDistance === "object" && "value" in NoHitDistance ? NoHitDistance?.value : NoHitDistance} /* default: 0 */  />
<Member type={`FrooxEngine.SyncDelegate\`1[System.Func\`2[FrooxEngine.ICollider,System.Boolean]]`} name="Filter" id={typeof Filter === "object" && "id" in Filter ? Filter?.id : undefined} value={typeof Filter === "object" && "value" in Filter ? Filter?.value : Filter} /* default: FrooxEngine.WorldDelegate */  />
