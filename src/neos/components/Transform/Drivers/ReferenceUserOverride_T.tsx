...
<Member type={`FrooxEngine.SyncRef\`1[${T}]`} name="Default" id={typeof Default === "object" && "id" in Default ? Default?.id : undefined} value={typeof Default === "object" && "value" in Default ? Default?.value : Default} /* default: null */  isRaw={typeof Default === "object" && "isRaw" in Default && Default.isRaw ? true : undefined} />
