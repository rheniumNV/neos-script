...
<Member type={`FrooxEngine.Sync\`1[System.Single]`} name="DistributionOffset" id={typeof DistributionOffset === "object" && "id" in DistributionOffset ? DistributionOffset?.id : undefined} value={typeof DistributionOffset === "object" && "value" in DistributionOffset ? DistributionOffset?.value : DistributionOffset} /* default: 0 */  />
<Member type={`FrooxEngine.Sync\`1[System.Boolean]`} name="AlignToNormal" id={typeof AlignToNormal === "object" && "id" in AlignToNormal ? AlignToNormal?.id : undefined} value={typeof AlignToNormal === "object" && "value" in AlignToNormal ? AlignToNormal?.value : AlignToNormal} /* default: false */  />
