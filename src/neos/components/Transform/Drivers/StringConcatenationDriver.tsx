...
<Member type={`FrooxEngine.SyncFieldList\`1[System.String]`} name="Strings" id={typeof Strings === "object" && "id" in Strings ? Strings?.id : undefined} value={typeof Strings === "object" && "value" in Strings ? Strings?.value : Strings} /* default: FrooxEngine.SyncFieldList`1[System.String] */  />
