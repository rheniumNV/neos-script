...
_rotation, } = props;
      ...
      return (
        <Component type="FrooxEngine.UserInterfacePositioner" id={id} persistentId={persistentId} updateOrder={updateOrder}>
...
<Member type={`FrooxEngine.Sync\`1[System.Boolean]`} name="UseHead" id={typeof UseHead === "object" && "id" in UseHead ? UseHead?.id : undefined} value={typeof UseHead === "object" && "value" in UseHead ? UseHead?.value : UseHead} /* default: false */  />
<Member type={`FrooxEngine.Sync\`1[System.Boolean]`} name="RotateVerticalOnly" id={typeof RotateVerticalOnly === "object" && "id" in RotateVerticalOnly ? RotateVerticalOnly?.id : undefined} value={typeof RotateVerticalOnly === "object" && "value" in RotateVerticalOnly ? RotateVerticalOnly?.value : RotateVerticalOnly} /* default: false */  />
...
<Member type={`FrooxEngine.Sync\`1[System.Single]`} name="ActivationDistance" id={typeof ActivationDistance === "object" && "id" in ActivationDistance ? ActivationDistance?.id : undefined} value={typeof ActivationDistance === "object" && "value" in ActivationDistance ? ActivationDistance?.value : ActivationDistance} /* default: 0 */  />
<Member type={`FrooxEngine.Sync\`1[System.Single]`} name="ActivationAngle" id={typeof ActivationAngle === "object" && "id" in ActivationAngle ? ActivationAngle?.id : undefined} value={typeof ActivationAngle === "object" && "value" in ActivationAngle ? ActivationAngle?.value : ActivationAngle} /* default: 0 */  />
<Member type={`FrooxEngine.Sync\`1[System.Single]`} name="DeactivationDistance" id={typeof DeactivationDistance === "object" && "id" in DeactivationDistance ? DeactivationDistance?.id : undefined} value={typeof DeactivationDistance === "object" && "value" in DeactivationDistance ? DeactivationDistance?.value : DeactivationDistance} /* default: 0 */  />
<Member type={`FrooxEngine.Sync\`1[System.Single]`} name="DeactivationAngle" id={typeof DeactivationAngle === "object" && "id" in DeactivationAngle ? DeactivationAngle?.id : undefined} value={typeof DeactivationAngle === "object" && "value" in DeactivationAngle ? DeactivationAngle?.value : DeactivationAngle} /* default: 0 */  />
