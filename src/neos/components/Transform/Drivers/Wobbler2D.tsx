...
<Member type={`FrooxEngine.Sync\`1[BaseX.float2]`} name="_baseValue" id={typeof _baseValue === "object" && "id" in _baseValue ? _baseValue?.id : undefined} value={typeof _baseValue === "object" && "value" in _baseValue ? _baseValue?.value : _baseValue} /* default: [0; 0] */  isRaw={typeof _baseValue === "object" && "isRaw" in _baseValue && _baseValue.isRaw ? true : undefined} />
...
<Member type={`FrooxEngine.Sync\`1[BaseX.float2]`} name="_magnitude" id={typeof _magnitude === "object" && "id" in _magnitude ? _magnitude?.id : undefined} value={typeof _magnitude === "object" && "value" in _magnitude ? _magnitude?.value : _magnitude} /* default: [0; 0] */  isRaw={typeof _magnitude === "object" && "isRaw" in _magnitude && _magnitude.isRaw ? true : undefined} />
<Member type={`FrooxEngine.Sync\`1[BaseX.float2]`} name="_seed" id={typeof _seed === "object" && "id" in _seed ? _seed?.id : undefined} value={typeof _seed === "object" && "value" in _seed ? _seed?.value : _seed} /* default: [0; 0] */  isRaw={typeof _seed === "object" && "isRaw" in _seed && _seed.isRaw ? true : undefined} />
        </Component>
      );
    };
