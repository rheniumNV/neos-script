...
<Member type={`FrooxEngine.Sync\`1[System.Boolean]`} name="ReparentOnRelease" id={typeof ReparentOnRelease === "object" && "id" in ReparentOnRelease ? ReparentOnRelease?.id : undefined} value={typeof ReparentOnRelease === "object" && "value" in ReparentOnRelease ? ReparentOnRelease?.value : ReparentOnRelease} /* default: false */  isRaw={typeof ReparentOnRelease === "object" && "isRaw" in ReparentOnRelease && ReparentOnRelease.isRaw ? true : undefined} />
<Member type={`FrooxEngine.Sync\`1[System.Boolean]`} name="PreserveUserSpace" id={typeof PreserveUserSpace === "object" && "id" in PreserveUserSpace ? PreserveUserSpace?.id : undefined} value={typeof PreserveUserSpace === "object" && "value" in PreserveUserSpace ? PreserveUserSpace?.value : PreserveUserSpace} /* default: false */  isRaw={typeof PreserveUserSpace === "object" && "isRaw" in PreserveUserSpace && PreserveUserSpace.isRaw ? true : undefined} />
<Member type={`FrooxEngine.Sync\`1[System.Boolean]`} name="DestroyOnRelease" id={typeof DestroyOnRelease === "object" && "id" in DestroyOnRelease ? DestroyOnRelease?.id : undefined} value={typeof DestroyOnRelease === "object" && "value" in DestroyOnRelease ? DestroyOnRelease?.value : DestroyOnRelease} /* default: false */  isRaw={typeof DestroyOnRelease === "object" && "isRaw" in DestroyOnRelease && DestroyOnRelease.isRaw ? true : undefined} />
...
<Member type={`FrooxEngine.Sync\`1[System.Nullable\`1[System.Int32]]`} name="GrabPriorityWhenGrabbed" id={typeof GrabPriorityWhenGrabbed === "object" && "id" in GrabPriorityWhenGrabbed ? GrabPriorityWhenGrabbed?.id : undefined} value={typeof GrabPriorityWhenGrabbed === "object" && "value" in GrabPriorityWhenGrabbed ? GrabPriorityWhenGrabbed?.value : GrabPriorityWhenGrabbed} /* default: <i>null</i> */  isRaw={typeof GrabPriorityWhenGrabbed === "object" && "isRaw" in GrabPriorityWhenGrabbed && GrabPriorityWhenGrabbed.isRaw ? true : undefined} />
<Member type={`FrooxEngine.SyncDelegate\`1[FrooxEngine.GrabCheck]`} name="CustomCanGrabCheck" id={typeof CustomCanGrabCheck === "object" && "id" in CustomCanGrabCheck ? CustomCanGrabCheck?.id : undefined} value={typeof CustomCanGrabCheck === "object" && "value" in CustomCanGrabCheck ? CustomCanGrabCheck?.value : CustomCanGrabCheck} /* default: FrooxEngine.WorldDelegate */  isRaw={typeof CustomCanGrabCheck === "object" && "isRaw" in CustomCanGrabCheck && CustomCanGrabCheck.isRaw ? true : undefined} />
...
<Member type={`FrooxEngine.Sync\`1[System.Boolean]`} name="Receivable" id={typeof Receivable === "object" && "id" in Receivable ? Receivable?.id : undefined} value={typeof Receivable === "object" && "value" in Receivable ? Receivable?.value : Receivable} /* default: false */  isRaw={typeof Receivable === "object" && "isRaw" in Receivable && Receivable.isRaw ? true : undefined} />
...
<Member type={`FrooxEngine.SyncRef\`1[FrooxEngine.Slot]`} name="_lastParent" id={typeof _lastParent === "object" && "id" in _lastParent ? _lastParent?.id : undefined} value={typeof _lastParent === "object" && "value" in _lastParent ? _lastParent?.value : _lastParent} /* default: ID0 */  isRaw={typeof _lastParent === "object" && "isRaw" in _lastParent && _lastParent.isRaw ? true : undefined} />
<Member type={`FrooxEngine.Sync\`1[System.Boolean]`} name="_lastParentIsUserSpace" id={typeof _lastParentIsUserSpace === "object" && "id" in _lastParentIsUserSpace ? _lastParentIsUserSpace?.id : undefined} value={typeof _lastParentIsUserSpace === "object" && "value" in _lastParentIsUserSpace ? _lastParentIsUserSpace?.value : _lastParentIsUserSpace} /* default: false */  isRaw={typeof _lastParentIsUserSpace === "object" && "isRaw" in _lastParentIsUserSpace && _lastParentIsUserSpace.isRaw ? true : undefined} />
