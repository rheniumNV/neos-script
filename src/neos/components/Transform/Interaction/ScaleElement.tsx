...
<Member type={`FrooxEngine.RelayRef\`1[FrooxEngine.ScaleGroup]`} name="Group" id={typeof Group === "object" && "id" in Group ? Group?.id : undefined} value={typeof Group === "object" && "value" in Group ? Group?.value : Group} /* default: ID0 */  />
...
<Member type={`FrooxEngine.FieldDrive\`1[BaseX.float3]`} name="_scaleTarget" id={typeof _scaleTarget === "object" && "id" in _scaleTarget ? _scaleTarget?.id : undefined} value={typeof _scaleTarget === "object" && "value" in _scaleTarget ? _scaleTarget?.value : _scaleTarget} /* default: ID0 */  />
        </Component>
      );
    };
