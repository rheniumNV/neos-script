...
<Member type={`FrooxEngine.Sync\`1[BaseX.float3]`} name="ScalePosition" id={typeof ScalePosition === "object" && "id" in ScalePosition ? ScalePosition?.id : undefined} value={typeof ScalePosition === "object" && "value" in ScalePosition ? ScalePosition?.value : ScalePosition} /* default: [0; 0; 0] */  isRaw={typeof ScalePosition === "object" && "isRaw" in ScalePosition && ScalePosition.isRaw ? true : undefined} />
<Member type={`FrooxEngine.Sync\`1[System.Nullable\`1[BaseX.float3]]`} name="OverrideFarTransitionOffset" id={typeof OverrideFarTransitionOffset === "object" && "id" in OverrideFarTransitionOffset ? OverrideFarTransitionOffset?.id : undefined} value={typeof OverrideFarTransitionOffset === "object" && "value" in OverrideFarTransitionOffset ? OverrideFarTransitionOffset?.value : OverrideFarTransitionOffset} /* default: <i>null</i> */  isRaw={typeof OverrideFarTransitionOffset === "object" && "isRaw" in OverrideFarTransitionOffset && OverrideFarTransitionOffset.isRaw ? true : undefined} />
<Member type={`FrooxEngine.Sync\`1[System.Boolean]`} name="CustomTransition" id={typeof CustomTransition === "object" && "id" in CustomTransition ? CustomTransition?.id : undefined} value={typeof CustomTransition === "object" && "value" in CustomTransition ? CustomTransition?.value : CustomTransition} /* default: false */  isRaw={typeof CustomTransition === "object" && "isRaw" in CustomTransition && CustomTransition.isRaw ? true : undefined} />
<Member type={`FrooxEngine.RawOutput\`1[System.Single]`} name="TransitionLerp" id={typeof TransitionLerp === "object" && "id" in TransitionLerp ? TransitionLerp?.id : undefined} value={typeof TransitionLerp === "object" && "value" in TransitionLerp ? TransitionLerp?.value : TransitionLerp} /* default: FrooxEngine.RawOutput`1[System.Single] */  isRaw={typeof TransitionLerp === "object" && "isRaw" in TransitionLerp && TransitionLerp.isRaw ? true : undefined} />
