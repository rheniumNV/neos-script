...
<Member type={`FrooxEngine.SyncRef\`1[FrooxEngine.Slot]`} name="Anchor0" id={typeof Anchor0 === "object" && "id" in Anchor0 ? Anchor0?.id : undefined} value={typeof Anchor0 === "object" && "value" in Anchor0 ? Anchor0?.value : Anchor0} /* default: ID0 */  isRaw={typeof Anchor0 === "object" && "isRaw" in Anchor0 && Anchor0.isRaw ? true : undefined} />
<Member type={`FrooxEngine.SyncRef\`1[FrooxEngine.Slot]`} name="Anchor1" id={typeof Anchor1 === "object" && "id" in Anchor1 ? Anchor1?.id : undefined} value={typeof Anchor1 === "object" && "value" in Anchor1 ? Anchor1?.value : Anchor1} /* default: ID0 */  isRaw={typeof Anchor1 === "object" && "isRaw" in Anchor1 && Anchor1.isRaw ? true : undefined} />
