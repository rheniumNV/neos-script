...
<Member type={`FrooxEngine.Sync\`1[System.Int32]`} name="DecimalPoints" id={typeof DecimalPoints === "object" && "id" in DecimalPoints ? DecimalPoints?.id : undefined} value={typeof DecimalPoints === "object" && "value" in DecimalPoints ? DecimalPoints?.value : DecimalPoints} /* default: 0 */  isRaw={typeof DecimalPoints === "object" && "isRaw" in DecimalPoints && DecimalPoints.isRaw ? true : undefined} />
...
<Member type={`FrooxEngine.Sync\`1[System.Single]`} name="IncrementValue" id={typeof IncrementValue === "object" && "id" in IncrementValue ? IncrementValue?.id : undefined} value={typeof IncrementValue === "object" && "value" in IncrementValue ? IncrementValue?.value : IncrementValue} /* default: 0 */  isRaw={typeof IncrementValue === "object" && "isRaw" in IncrementValue && IncrementValue.isRaw ? true : undefined} />
