...
<Member type={`FrooxEngine.RawOutput\`1[System.Boolean]`} name="Selected" id={typeof Selected === "object" && "id" in Selected ? Selected?.id : undefined} value={typeof Selected === "object" && "value" in Selected ? Selected?.value : Selected} /* default: FrooxEngine.RawOutput`1[System.Boolean] */  isRaw={typeof Selected === "object" && "isRaw" in Selected && Selected.isRaw ? true : undefined} />
...
<Member type={`FrooxEngine.DriveRef\`1[FrooxEngine.IcoSphereMesh]`} name="_icosphere" id={typeof _icosphere === "object" && "id" in _icosphere ? _icosphere?.id : undefined} value={typeof _icosphere === "object" && "value" in _icosphere ? _icosphere?.value : _icosphere} /* default: ID0 */  isRaw={typeof _icosphere === "object" && "isRaw" in _icosphere && _icosphere.isRaw ? true : undefined} />
...
<Member type={`FrooxEngine.RelayRef\`1[FrooxEngine.NeosRadioGroup]`} name="_group" id={typeof _group === "object" && "id" in _group ? _group?.id : undefined} value={typeof _group === "object" && "value" in _group ? _group?.value : _group} /* default: ID0 */  isRaw={typeof _group === "object" && "isRaw" in _group && _group.isRaw ? true : undefined} />
<Member type={`FrooxEngine.Sync\`1[System.Int32]`} name="_orderNumber" id={typeof _orderNumber === "object" && "id" in _orderNumber ? _orderNumber?.id : undefined} value={typeof _orderNumber === "object" && "value" in _orderNumber ? _orderNumber?.value : _orderNumber} /* default: 0 */  isRaw={typeof _orderNumber === "object" && "isRaw" in _orderNumber && _orderNumber.isRaw ? true : undefined} />
        </Component>
      );
    };
