...
<Member type={`FrooxEngine.SyncRef\`1[FrooxEngine.TextRenderer]`} name="_hintTextRenderer" id={typeof _hintTextRenderer === "object" && "id" in _hintTextRenderer ? _hintTextRenderer?.id : undefined} value={typeof _hintTextRenderer === "object" && "value" in _hintTextRenderer ? _hintTextRenderer?.value : _hintTextRenderer} /* default: ID0 */  />
<Member type={`FrooxEngine.FieldDrive\`1[BaseX.float2]`} name="_hintTextBounds" id={typeof _hintTextBounds === "object" && "id" in _hintTextBounds ? _hintTextBounds?.id : undefined} value={typeof _hintTextBounds === "object" && "value" in _hintTextBounds ? _hintTextBounds?.value : _hintTextBounds} /* default: ID0 */  />
<Member type={`FrooxEngine.FieldDrive\`1[System.Boolean]`} name="_hintTextEnabled" id={typeof _hintTextEnabled === "object" && "id" in _hintTextEnabled ? _hintTextEnabled?.id : undefined} value={typeof _hintTextEnabled === "object" && "value" in _hintTextEnabled ? _hintTextEnabled?.value : _hintTextEnabled} /* default: ID0 */  />
        </Component>
      );
    };
