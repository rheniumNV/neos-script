...
__legacyZWrite?: member<boolean>;
    ...
    export function Image(props: ImageInput){
...
NineSliceSizing,
InteractionTarget,
__legacyZWrite, } = props;
    
      return (
        <Component type="FrooxEngine.UIX.Image" id={id} persistentId={persistentId} updateOrder={updateOrder} version={1}>
