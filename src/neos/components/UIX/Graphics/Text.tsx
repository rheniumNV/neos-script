...
<Member type={`FrooxEngine.Sync\`1[System.String]`} name="Content" id={typeof Content === "object" && "id" in Content ? Content?.id : undefined} value={typeof Content === "object" && "value" in Content ? Content?.value : Content} /* default: <i>null</i> */  isRaw={typeof Content === "object" && "isRaw" in Content && Content.isRaw ? true : undefined} />
...
<Member type={`FrooxEngine.Sync\`1[System.String]`} name="NullContent" id={typeof NullContent === "object" && "id" in NullContent ? NullContent?.id : undefined} value={typeof NullContent === "object" && "value" in NullContent ? NullContent?.value : NullContent} /* default: <i>null</i> */  isRaw={typeof NullContent === "object" && "isRaw" in NullContent && NullContent.isRaw ? true : undefined} />
...
<Member type={`FrooxEngine.Sync\`1[System.Single]`} name="AutoSizeMin" id={typeof AutoSizeMin === "object" && "id" in AutoSizeMin ? AutoSizeMin?.id : undefined} value={typeof AutoSizeMin === "object" && "value" in AutoSizeMin ? AutoSizeMin?.value : AutoSizeMin} /* default: 0 */  isRaw={typeof AutoSizeMin === "object" && "isRaw" in AutoSizeMin && AutoSizeMin.isRaw ? true : undefined} />
<Member type={`FrooxEngine.Sync\`1[System.Single]`} name="AutoSizeMax" id={typeof AutoSizeMax === "object" && "id" in AutoSizeMax ? AutoSizeMax?.id : undefined} value={typeof AutoSizeMax === "object" && "value" in AutoSizeMax ? AutoSizeMax?.value : AutoSizeMax} /* default: 0 */  isRaw={typeof AutoSizeMax === "object" && "isRaw" in AutoSizeMax && AutoSizeMax.isRaw ? true : undefined} />
