...
<Member type={`FrooxEngine.SyncRef\`1[FrooxEngine.UIX.ModalOverlay]`} name="Template" id={typeof Template === "object" && "id" in Template ? Template?.id : undefined} value={typeof Template === "object" && "value" in Template ? Template?.value : Template} /* default: ID0 */  isRaw={typeof Template === "object" && "isRaw" in Template && Template.isRaw ? true : undefined} />
<Member type={`FrooxEngine.SyncDelegate\`1[FrooxEngine.ModalOverlayConstructor]`} name="Constructor" id={typeof Constructor === "object" && "id" in Constructor ? Constructor?.id : undefined} value={typeof Constructor === "object" && "value" in Constructor ? Constructor?.value : Constructor} /* default: FrooxEngine.WorldDelegate */  isRaw={typeof Constructor === "object" && "isRaw" in Constructor && Constructor.isRaw ? true : undefined} />
<Member type={`FrooxEngine.SyncDelegate\`1[System.Action\`1[FrooxEngine.ModalOverlayManager]]`} name="ModalOverlayRequested" id={typeof ModalOverlayRequested === "object" && "id" in ModalOverlayRequested ? ModalOverlayRequested?.id : undefined} value={typeof ModalOverlayRequested === "object" && "value" in ModalOverlayRequested ? ModalOverlayRequested?.value : ModalOverlayRequested} /* default: FrooxEngine.WorldDelegate */  isRaw={typeof ModalOverlayRequested === "object" && "isRaw" in ModalOverlayRequested && ModalOverlayRequested.isRaw ? true : undefined} />
<Member type={`FrooxEngine.SyncDelegate\`1[System.Action\`2[FrooxEngine.ModalOverlayManager,FrooxEngine.UIX.ModalOverlay]]`} name="ModalOverlayGenerated" id={typeof ModalOverlayGenerated === "object" && "id" in ModalOverlayGenerated ? ModalOverlayGenerated?.id : undefined} value={typeof ModalOverlayGenerated === "object" && "value" in ModalOverlayGenerated ? ModalOverlayGenerated?.value : ModalOverlayGenerated} /* default: FrooxEngine.WorldDelegate */  isRaw={typeof ModalOverlayGenerated === "object" && "isRaw" in ModalOverlayGenerated && ModalOverlayGenerated.isRaw ? true : undefined} />
