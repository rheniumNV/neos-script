...
<Member type={`FrooxEngine.Sync\`1[BaseX.float2]`} name="Spacing" id={typeof Spacing === "object" && "id" in Spacing ? Spacing?.id : undefined} value={typeof Spacing === "object" && "value" in Spacing ? Spacing?.value : Spacing} /* default: [0; 0] */  isRaw={typeof Spacing === "object" && "isRaw" in Spacing && Spacing.isRaw ? true : undefined} />
...
<Member type={`FrooxEngine.Sync\`1[System.Boolean]`} name="ExpandWidthToFit" id={typeof ExpandWidthToFit === "object" && "id" in ExpandWidthToFit ? ExpandWidthToFit?.id : undefined} value={typeof ExpandWidthToFit === "object" && "value" in ExpandWidthToFit ? ExpandWidthToFit?.value : ExpandWidthToFit} /* default: false */  isRaw={typeof ExpandWidthToFit === "object" && "isRaw" in ExpandWidthToFit && ExpandWidthToFit.isRaw ? true : undefined} />
<Member type={`FrooxEngine.Sync\`1[System.Boolean]`} name="PreserveAspectOnExpand" id={typeof PreserveAspectOnExpand === "object" && "id" in PreserveAspectOnExpand ? PreserveAspectOnExpand?.id : undefined} value={typeof PreserveAspectOnExpand === "object" && "value" in PreserveAspectOnExpand ? PreserveAspectOnExpand?.value : PreserveAspectOnExpand} /* default: false */  isRaw={typeof PreserveAspectOnExpand === "object" && "isRaw" in PreserveAspectOnExpand && PreserveAspectOnExpand.isRaw ? true : undefined} />
<Member type={`FrooxEngine.Sync\`1[System.Boolean]`} name="AlignLastRowIndividually" id={typeof AlignLastRowIndividually === "object" && "id" in AlignLastRowIndividually ? AlignLastRowIndividually?.id : undefined} value={typeof AlignLastRowIndividually === "object" && "value" in AlignLastRowIndividually ? AlignLastRowIndividually?.value : AlignLastRowIndividually} /* default: false */  isRaw={typeof AlignLastRowIndividually === "object" && "isRaw" in AlignLastRowIndividually && AlignLastRowIndividually.isRaw ? true : undefined} />
        </Component>
      );
    };
