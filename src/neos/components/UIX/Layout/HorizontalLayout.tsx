...
<Member type={`FrooxEngine.Sync\`1[System.Boolean]`} name="ForceExpandWidth" id={typeof ForceExpandWidth === "object" && "id" in ForceExpandWidth ? ForceExpandWidth?.id : undefined} value={typeof ForceExpandWidth === "object" && "value" in ForceExpandWidth ? ForceExpandWidth?.value : ForceExpandWidth} /* default: false */  />
<Member type={`FrooxEngine.Sync\`1[System.Boolean]`} name="ForceExpandHeight" id={typeof ForceExpandHeight === "object" && "id" in ForceExpandHeight ? ForceExpandHeight?.id : undefined} value={typeof ForceExpandHeight === "object" && "value" in ForceExpandHeight ? ForceExpandHeight?.value : ForceExpandHeight} /* default: false */  />
        </Component>
      );
    };
