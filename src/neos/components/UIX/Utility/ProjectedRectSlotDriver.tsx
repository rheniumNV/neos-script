...
<Member type={`FrooxEngine.SyncRef\`1[FrooxEngine.Slot]`} name="_lastTarget" id={typeof _lastTarget === "object" && "id" in _lastTarget ? _lastTarget?.id : undefined} value={typeof _lastTarget === "object" && "value" in _lastTarget ? _lastTarget?.value : _lastTarget} /* default: ID0 */  isRaw={typeof _lastTarget === "object" && "isRaw" in _lastTarget && _lastTarget.isRaw ? true : undefined} />
        </Component>
      );
    };
