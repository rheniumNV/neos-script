...
PresentUsers?: member<any>;
    ...
    export function AssetMetadata(props: AssetMetadataInput){
...
PresentUsers, } = props;
      ...
      return (
        <Component type="FrooxEngine.AssetMetadata" id={id} persistentId={persistentId} updateOrder={updateOrder}>
...
<Member type={`FrooxEngine.SyncList\`1[FrooxEngine.UserRef]`} name="PresentUsers" id={typeof PresentUsers === "object" && "id" in PresentUsers ? PresentUsers?.id : undefined} value={typeof PresentUsers === "object" && "value" in PresentUsers ? PresentUsers?.value : PresentUsers} /* default: FrooxEngine.SyncList`1[FrooxEngine.UserRef] */  />
        </Component>
      );
    };
