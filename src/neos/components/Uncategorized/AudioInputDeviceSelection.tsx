...
<Member type={`FrooxEngine.SyncRef\`1[FrooxEngine.LocalAudioDeviceStream]`} name="_audioStream" id={typeof _audioStream === "object" && "id" in _audioStream ? _audioStream?.id : undefined} value={typeof _audioStream === "object" && "value" in _audioStream ? _audioStream?.value : _audioStream} /* default: ID0 */  />
...
<Member type={`FrooxEngine.SyncRef\`1[FrooxEngine.VolumeMeter]`} name="_deviceVolume" id={typeof _deviceVolume === "object" && "id" in _deviceVolume ? _deviceVolume?.id : undefined} value={typeof _deviceVolume === "object" && "value" in _deviceVolume ? _deviceVolume?.value : _deviceVolume} /* default: ID0 */  />
<Member type={`FrooxEngine.SyncRef\`1[FrooxEngine.UIX.ProgressBar]`} name="_volumeBar" id={typeof _volumeBar === "object" && "id" in _volumeBar ? _volumeBar?.id : undefined} value={typeof _volumeBar === "object" && "value" in _volumeBar ? _volumeBar?.value : _volumeBar} /* default: ID0 */  />
        </Component>
      );
    };
