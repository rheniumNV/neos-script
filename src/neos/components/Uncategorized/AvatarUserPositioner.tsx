...
OnManualEquipOnly, } = props;
      ...
      return (
        <Component type="FrooxEngine.CommonAvatar.AvatarUserPositioner" id={id} persistentId={persistentId} updateOrder={updateOrder}>
...
<Member type={`FrooxEngine.Sync\`1[System.Boolean]`} name="PreserveUp" id={typeof PreserveUp === "object" && "id" in PreserveUp ? PreserveUp?.id : undefined} value={typeof PreserveUp === "object" && "value" in PreserveUp ? PreserveUp?.value : PreserveUp} /* default: false */  />
<Member type={`FrooxEngine.Sync\`1[System.Boolean]`} name="OnManualEquipOnly" id={typeof OnManualEquipOnly === "object" && "id" in OnManualEquipOnly ? OnManualEquipOnly?.id : undefined} value={typeof OnManualEquipOnly === "object" && "value" in OnManualEquipOnly ? OnManualEquipOnly?.value : OnManualEquipOnly} /* default: false */  />
        </Component>
      );
    };
