...
<Member type={`FrooxEngine.Sync\`1[System.Single]`} name="CircleRadius" id={typeof CircleRadius === "object" && "id" in CircleRadius ? CircleRadius?.id : undefined} value={typeof CircleRadius === "object" && "value" in CircleRadius ? CircleRadius?.value : CircleRadius} /* default: 0 */  />
<Member type={`FrooxEngine.Sync\`1[System.Single]`} name="CircleThickness" id={typeof CircleThickness === "object" && "id" in CircleThickness ? CircleThickness?.id : undefined} value={typeof CircleThickness === "object" && "value" in CircleThickness ? CircleThickness?.value : CircleThickness} /* default: 0 */  />
...
<Member type={`FrooxEngine.DriveRef\`1[FrooxEngine.TorusMesh]`} name="_circle" id={typeof _circle === "object" && "id" in _circle ? _circle?.id : undefined} value={typeof _circle === "object" && "value" in _circle ? _circle?.value : _circle} /* default: ID0 */  />
...
<Member type={`FrooxEngine.DriveRef\`1[FrooxEngine.SegmentMesh]`} name="_referenceLine" id={typeof _referenceLine === "object" && "id" in _referenceLine ? _referenceLine?.id : undefined} value={typeof _referenceLine === "object" && "value" in _referenceLine ? _referenceLine?.value : _referenceLine} /* default: ID0 */  />
