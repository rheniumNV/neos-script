import { member, Member, Component } from "../../core";
    ...
    export interface BooleanMemberEditorInput {
...
_button?: member<any>;
    ...
    export function BooleanMemberEditor(props: BooleanMemberEditorInput){
...
_button, } = props;
      ...
      return (
        <Component type="FrooxEngine.BooleanMemberEditor" id={id} persistentId={persistentId} updateOrder={updateOrder}>
