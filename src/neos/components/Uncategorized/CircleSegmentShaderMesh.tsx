...
<Member type={`FrooxEngine.Sync\`1[System.Single]`} name="RadiusStart" id={typeof RadiusStart === "object" && "id" in RadiusStart ? RadiusStart?.id : undefined} value={typeof RadiusStart === "object" && "value" in RadiusStart ? RadiusStart?.value : RadiusStart} /* default: 0 */  isRaw={typeof RadiusStart === "object" && "isRaw" in RadiusStart && RadiusStart.isRaw ? true : undefined} />
...
<Member type={`FrooxEngine.Sync\`1[System.Single]`} name="AngleStart" id={typeof AngleStart === "object" && "id" in AngleStart ? AngleStart?.id : undefined} value={typeof AngleStart === "object" && "value" in AngleStart ? AngleStart?.value : AngleStart} /* default: 0 */  isRaw={typeof AngleStart === "object" && "isRaw" in AngleStart && AngleStart.isRaw ? true : undefined} />
<Member type={`FrooxEngine.Sync\`1[System.Single]`} name="ArcLength" id={typeof ArcLength === "object" && "id" in ArcLength ? ArcLength?.id : undefined} value={typeof ArcLength === "object" && "value" in ArcLength ? ArcLength?.value : ArcLength} /* default: 0 */  isRaw={typeof ArcLength === "object" && "isRaw" in ArcLength && ArcLength.isRaw ? true : undefined} />
...
<Member type={`FrooxEngine.Sync\`1[BaseX.color]`} name="BorderColor" id={typeof BorderColor === "object" && "id" in BorderColor ? BorderColor?.id : undefined} value={typeof BorderColor === "object" && "value" in BorderColor ? BorderColor?.value : BorderColor} /* default: [0; 0; 0; 0] */  isRaw={typeof BorderColor === "object" && "isRaw" in BorderColor && BorderColor.isRaw ? true : undefined} />
<Member type={`FrooxEngine.Sync\`1[System.Single]`} name="BorderSize" id={typeof BorderSize === "object" && "id" in BorderSize ? BorderSize?.id : undefined} value={typeof BorderSize === "object" && "value" in BorderSize ? BorderSize?.value : BorderSize} /* default: 0 */  isRaw={typeof BorderSize === "object" && "isRaw" in BorderSize && BorderSize.isRaw ? true : undefined} />
        </Component>
      );
    };
