...
<Member type={`FrooxEngine.RefDrive\`1[FrooxEngine.Slot]`} name="_parent" id={typeof _parent === "object" && "id" in _parent ? _parent?.id : undefined} value={typeof _parent === "object" && "value" in _parent ? _parent?.value : _parent} /* default: ID0 */  />
...
<Member type={`FrooxEngine.Sync\`1[System.Boolean]`} name="IsScalable" id={typeof IsScalable === "object" && "id" in IsScalable ? IsScalable?.id : undefined} value={typeof IsScalable === "object" && "value" in IsScalable ? IsScalable?.value : IsScalable} /* default: false */  />
        </Component>
      );
    };
