...
<Member type={`FrooxEngine.FieldDrive\`1[BaseX.color]`} name="_colorDrive" id={typeof _colorDrive === "object" && "id" in _colorDrive ? _colorDrive?.id : undefined} value={typeof _colorDrive === "object" && "value" in _colorDrive ? _colorDrive?.value : _colorDrive} /* default: ID0 */  isRaw={typeof _colorDrive === "object" && "isRaw" in _colorDrive && _colorDrive.isRaw ? true : undefined} />
<Member type={`FrooxEngine.FieldDrive\`1[BaseX.color]`} name="_colorDriveNoAlpha" id={typeof _colorDriveNoAlpha === "object" && "id" in _colorDriveNoAlpha ? _colorDriveNoAlpha?.id : undefined} value={typeof _colorDriveNoAlpha === "object" && "value" in _colorDriveNoAlpha ? _colorDriveNoAlpha?.value : _colorDriveNoAlpha} /* default: ID0 */  isRaw={typeof _colorDriveNoAlpha === "object" && "isRaw" in _colorDriveNoAlpha && _colorDriveNoAlpha.isRaw ? true : undefined} />
