...
<Member type={`FrooxEngine.SyncRef\`1[FrooxEngine.UIX.TextField]`} name="_customGenericType" id={typeof _customGenericType === "object" && "id" in _customGenericType ? _customGenericType?.id : undefined} value={typeof _customGenericType === "object" && "value" in _customGenericType ? _customGenericType?.value : _customGenericType} /* default: ID0 */  isRaw={typeof _customGenericType === "object" && "isRaw" in _customGenericType && _customGenericType.isRaw ? true : undefined} />
<Member type={`FrooxEngine.SyncType`} name="_genericType" id={typeof _genericType === "object" && "id" in _genericType ? _genericType?.id : undefined} value={typeof _genericType === "object" && "value" in _genericType ? _genericType?.value : _genericType} /* default: <i>null</i> */  isRaw={typeof _genericType === "object" && "isRaw" in _genericType && _genericType.isRaw ? true : undefined} />
<Member type={`FrooxEngine.FieldDrive\`1[System.String]`} name="_customGenericTypeLabel" id={typeof _customGenericTypeLabel === "object" && "id" in _customGenericTypeLabel ? _customGenericTypeLabel?.id : undefined} value={typeof _customGenericTypeLabel === "object" && "value" in _customGenericTypeLabel ? _customGenericTypeLabel?.value : _customGenericTypeLabel} /* default: ID0 */  isRaw={typeof _customGenericTypeLabel === "object" && "isRaw" in _customGenericTypeLabel && _customGenericTypeLabel.isRaw ? true : undefined} />
<Member type={`FrooxEngine.FieldDrive\`1[BaseX.color]`} name="_customGenericTypeColor" id={typeof _customGenericTypeColor === "object" && "id" in _customGenericTypeColor ? _customGenericTypeColor?.id : undefined} value={typeof _customGenericTypeColor === "object" && "value" in _customGenericTypeColor ? _customGenericTypeColor?.value : _customGenericTypeColor} /* default: ID0 */  isRaw={typeof _customGenericTypeColor === "object" && "isRaw" in _customGenericTypeColor && _customGenericTypeColor.isRaw ? true : undefined} />
        </Component>
      );
    };
