...
<Member type={`FrooxEngine.RelayRef\`1[FrooxEngine.IField\`1[System.Single]]`} name="TargetAngle" id={typeof TargetAngle === "object" && "id" in TargetAngle ? TargetAngle?.id : undefined} value={typeof TargetAngle === "object" && "value" in TargetAngle ? TargetAngle?.value : TargetAngle} /* default: ID0 */  isRaw={typeof TargetAngle === "object" && "isRaw" in TargetAngle && TargetAngle.isRaw ? true : undefined} />
...
<Member type={`FrooxEngine.RelayRef\`1[FrooxEngine.IField\`1[BaseX.float3]]`} name="TargetDirection" id={typeof TargetDirection === "object" && "id" in TargetDirection ? TargetDirection?.id : undefined} value={typeof TargetDirection === "object" && "value" in TargetDirection ? TargetDirection?.value : TargetDirection} /* default: ID0 */  isRaw={typeof TargetDirection === "object" && "isRaw" in TargetDirection && TargetDirection.isRaw ? true : undefined} />
...
<Member type={`FrooxEngine.Sync\`1[System.Single]`} name="FixedAngle" id={typeof FixedAngle === "object" && "id" in FixedAngle ? FixedAngle?.id : undefined} value={typeof FixedAngle === "object" && "value" in FixedAngle ? FixedAngle?.value : FixedAngle} /* default: 0 */  isRaw={typeof FixedAngle === "object" && "isRaw" in FixedAngle && FixedAngle.isRaw ? true : undefined} />
<Member type={`FrooxEngine.Sync\`1[System.Single]`} name="FixedHeight" id={typeof FixedHeight === "object" && "id" in FixedHeight ? FixedHeight?.id : undefined} value={typeof FixedHeight === "object" && "value" in FixedHeight ? FixedHeight?.value : FixedHeight} /* default: 0 */  isRaw={typeof FixedHeight === "object" && "isRaw" in FixedHeight && FixedHeight.isRaw ? true : undefined} />
<Member type={`FrooxEngine.Sync\`1[BaseX.float3]`} name="FixedDirection" id={typeof FixedDirection === "object" && "id" in FixedDirection ? FixedDirection?.id : undefined} value={typeof FixedDirection === "object" && "value" in FixedDirection ? FixedDirection?.value : FixedDirection} /* default: [0; 0; 0] */  isRaw={typeof FixedDirection === "object" && "isRaw" in FixedDirection && FixedDirection.isRaw ? true : undefined} />
<Member type={`FrooxEngine.Sync\`1[System.Single]`} name="LineThickness" id={typeof LineThickness === "object" && "id" in LineThickness ? LineThickness?.id : undefined} value={typeof LineThickness === "object" && "value" in LineThickness ? LineThickness?.value : LineThickness} /* default: 0 */  isRaw={typeof LineThickness === "object" && "isRaw" in LineThickness && LineThickness.isRaw ? true : undefined} />
...
<Member type={`FrooxEngine.Sync\`1[System.Single]`} name="MinAngle" id={typeof MinAngle === "object" && "id" in MinAngle ? MinAngle?.id : undefined} value={typeof MinAngle === "object" && "value" in MinAngle ? MinAngle?.value : MinAngle} /* default: 0 */  isRaw={typeof MinAngle === "object" && "isRaw" in MinAngle && MinAngle.isRaw ? true : undefined} />
<Member type={`FrooxEngine.Sync\`1[System.Single]`} name="MaxAngle" id={typeof MaxAngle === "object" && "id" in MaxAngle ? MaxAngle?.id : undefined} value={typeof MaxAngle === "object" && "value" in MaxAngle ? MaxAngle?.value : MaxAngle} /* default: 0 */  isRaw={typeof MaxAngle === "object" && "isRaw" in MaxAngle && MaxAngle.isRaw ? true : undefined} />
...
<Member type={`FrooxEngine.SyncList\`1[FrooxEngine.ConeGizmo+Handle]`} name="_handles" id={typeof _handles === "object" && "id" in _handles ? _handles?.id : undefined} value={typeof _handles === "object" && "value" in _handles ? _handles?.value : _handles} /* default: FrooxEngine.SyncList`1[FrooxEngine.ConeGizmo+Handle] */  isRaw={typeof _handles === "object" && "isRaw" in _handles && _handles.isRaw ? true : undefined} />
<Member type={`FrooxEngine.DriveRef\`1[FrooxEngine.SegmentMesh]`} name="_heightMesh" id={typeof _heightMesh === "object" && "id" in _heightMesh ? _heightMesh?.id : undefined} value={typeof _heightMesh === "object" && "value" in _heightMesh ? _heightMesh?.value : _heightMesh} /* default: ID0 */  isRaw={typeof _heightMesh === "object" && "isRaw" in _heightMesh && _heightMesh.isRaw ? true : undefined} />
<Member type={`FrooxEngine.DriveRef\`1[FrooxEngine.SegmentMesh]`} name="_coneLineMesh" id={typeof _coneLineMesh === "object" && "id" in _coneLineMesh ? _coneLineMesh?.id : undefined} value={typeof _coneLineMesh === "object" && "value" in _coneLineMesh ? _coneLineMesh?.value : _coneLineMesh} /* default: ID0 */  isRaw={typeof _coneLineMesh === "object" && "isRaw" in _coneLineMesh && _coneLineMesh.isRaw ? true : undefined} />
        </Component>
      );
    };
