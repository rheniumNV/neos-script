import { member, Member, Component } from "../../core";
    ...
    export interface DebugInteractableInput {
...
TouchEnterLock?: member<boolean>;
    ...
    export function DebugInteractable(props: DebugInteractableInput){
      const { id, persistentId, updateOrder, Enabled,
TouchExitLock,
TouchEnterLock, } = props;
    
      return (
        <Component type="FrooxEngine.UIX.DebugInteractable" id={id} persistentId={persistentId} updateOrder={updateOrder}>
