...
<Member type={`FrooxEngine.SyncRef\`1[FrooxEngine.ValueStream\`1[BaseX.float3]]`} name="Stream" id={typeof Stream === "object" && "id" in Stream ? Stream?.id : undefined} value={typeof Stream === "object" && "value" in Stream ? Stream?.value : Stream} /* default: ID0 */  isRaw={typeof Stream === "object" && "isRaw" in Stream && Stream.isRaw ? true : undefined} />
...
<Member type={`FrooxEngine.FieldDrive\`1[BaseX.float3]`} name="sizeDrive" id={typeof sizeDrive === "object" && "id" in sizeDrive ? sizeDrive?.id : undefined} value={typeof sizeDrive === "object" && "value" in sizeDrive ? sizeDrive?.value : sizeDrive} /* default: ID0 */  isRaw={typeof sizeDrive === "object" && "isRaw" in sizeDrive && sizeDrive.isRaw ? true : undefined} />
        </Component>
      );
    };
