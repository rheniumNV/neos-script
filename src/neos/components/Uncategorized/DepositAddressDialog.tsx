import { member, Member, Component } from "../../core";
    ...
    export interface DepositAddressDialogInput {
...
_panel?: member<any>;
    ...
    export function DepositAddressDialog(props: DepositAddressDialogInput){
      const { id, persistentId, updateOrder, Enabled,
_canvas,
_panel, } = props;
    
      return (
        <Component type="FrooxEngine.DepositAddressDialog" id={id} persistentId={persistentId} updateOrder={updateOrder}>
