...
_modalOverlayManager?: member<any>;
    ...
    export function DesktopScreen(props: DesktopScreenInput){
...
_modalOverlayManager, } = props;
      ...
      return (
        <Component type="FrooxEngine.DesktopScreen" id={id} persistentId={persistentId} updateOrder={updateOrder} version={1}>
