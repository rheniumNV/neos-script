...
<Member type={`FrooxEngine.Sync\`1[FrooxEngine.EngineDebugDialog+Mode]`} name="DisplayMode" id={typeof DisplayMode === "object" && "id" in DisplayMode ? DisplayMode?.id : undefined} value={typeof DisplayMode === "object" && "value" in DisplayMode ? DisplayMode?.value : DisplayMode} /* default: GatherJobs */  isRaw={typeof DisplayMode === "object" && "isRaw" in DisplayMode && DisplayMode.isRaw ? true : undefined} />
