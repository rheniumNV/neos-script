...
<Member type={`FrooxEngine.SyncRef\`1[FrooxEngine.UIX.Text]`} name="_exitMessage" id={typeof _exitMessage === "object" && "id" in _exitMessage ? _exitMessage?.id : undefined} value={typeof _exitMessage === "object" && "value" in _exitMessage ? _exitMessage?.value : _exitMessage} /* default: ID0 */  isRaw={typeof _exitMessage === "object" && "isRaw" in _exitMessage && _exitMessage.isRaw ? true : undefined} />
        </Component>
      );
    };
