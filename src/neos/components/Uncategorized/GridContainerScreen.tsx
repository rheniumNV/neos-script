...
<Member type={`FrooxEngine.SyncRef\`1[FrooxEngine.GridContainer]`} name="_gridContainer" id={typeof _gridContainer === "object" && "id" in _gridContainer ? _gridContainer?.id : undefined} value={typeof _gridContainer === "object" && "value" in _gridContainer ? _gridContainer?.value : _gridContainer} /* default: ID0 */  isRaw={typeof _gridContainer === "object" && "isRaw" in _gridContainer && _gridContainer.isRaw ? true : undefined} />
        </Component>
      );
    };
