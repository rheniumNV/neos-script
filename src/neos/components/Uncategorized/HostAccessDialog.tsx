...
<Member type={`FrooxEngine.Sync\`1[System.String]`} name="HostKey" id={typeof HostKey === "object" && "id" in HostKey ? HostKey?.id : undefined} value={typeof HostKey === "object" && "value" in HostKey ? HostKey?.value : HostKey} /* default: <i>null</i> */  isRaw={typeof HostKey === "object" && "isRaw" in HostKey && HostKey.isRaw ? true : undefined} />
...
<Member type={`FrooxEngine.SyncRef\`1[FrooxEngine.UIX.Button]`} name="_allowButton" id={typeof _allowButton === "object" && "id" in _allowButton ? _allowButton?.id : undefined} value={typeof _allowButton === "object" && "value" in _allowButton ? _allowButton?.value : _allowButton} /* default: ID0 */  isRaw={typeof _allowButton === "object" && "isRaw" in _allowButton && _allowButton.isRaw ? true : undefined} />
        </Component>
      );
    };
