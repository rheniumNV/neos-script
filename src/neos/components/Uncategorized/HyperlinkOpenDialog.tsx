...
<Member type={`FrooxEngine.SyncRef\`1[FrooxEngine.UIX.Text]`} name="_hyperlinkText" id={typeof _hyperlinkText === "object" && "id" in _hyperlinkText ? _hyperlinkText?.id : undefined} value={typeof _hyperlinkText === "object" && "value" in _hyperlinkText ? _hyperlinkText?.value : _hyperlinkText} /* default: ID0 */  />
