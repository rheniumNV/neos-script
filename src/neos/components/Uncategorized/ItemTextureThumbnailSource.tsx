...
<Member type={`FrooxEngine.Sync\`1[System.Nullable\`1[BaseX.Rect]]`} name="Crop" id={typeof Crop === "object" && "id" in Crop ? Crop?.id : undefined} value={typeof Crop === "object" && "value" in Crop ? Crop?.value : Crop} /* default: <i>null</i> */  />
        </Component>
      );
    };
