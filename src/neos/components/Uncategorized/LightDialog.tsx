...
<Member type={`FrooxEngine.SyncRef\`1[FrooxEngine.NeosSlider]`} name="_intensitySlider" id={typeof _intensitySlider === "object" && "id" in _intensitySlider ? _intensitySlider?.id : undefined} value={typeof _intensitySlider === "object" && "value" in _intensitySlider ? _intensitySlider?.value : _intensitySlider} /* default: ID0 */  isRaw={typeof _intensitySlider === "object" && "isRaw" in _intensitySlider && _intensitySlider.isRaw ? true : undefined} />
<Member type={`FrooxEngine.SyncRef\`1[FrooxEngine.NeosSlider]`} name="_shadowStrengthSlider" id={typeof _shadowStrengthSlider === "object" && "id" in _shadowStrengthSlider ? _shadowStrengthSlider?.id : undefined} value={typeof _shadowStrengthSlider === "object" && "value" in _shadowStrengthSlider ? _shadowStrengthSlider?.value : _shadowStrengthSlider} /* default: ID0 */  isRaw={typeof _shadowStrengthSlider === "object" && "isRaw" in _shadowStrengthSlider && _shadowStrengthSlider.isRaw ? true : undefined} />
<Member type={`FrooxEngine.SyncRef\`1[FrooxEngine.NeosButton]`} name="_closeButton" id={typeof _closeButton === "object" && "id" in _closeButton ? _closeButton?.id : undefined} value={typeof _closeButton === "object" && "value" in _closeButton ? _closeButton?.value : _closeButton} /* default: ID0 */  isRaw={typeof _closeButton === "object" && "isRaw" in _closeButton && _closeButton.isRaw ? true : undefined} />
