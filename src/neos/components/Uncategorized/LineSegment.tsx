...
<Member type={`FrooxEngine.TransformRelayRef`} name="Anchor0" id={typeof Anchor0 === "object" && "id" in Anchor0 ? Anchor0?.id : undefined} value={typeof Anchor0 === "object" && "value" in Anchor0 ? Anchor0?.value : Anchor0} /* default: ID0 */  isRaw={typeof Anchor0 === "object" && "isRaw" in Anchor0 && Anchor0.isRaw ? true : undefined} />
<Member type={`FrooxEngine.TransformRelayRef`} name="Anchor1" id={typeof Anchor1 === "object" && "id" in Anchor1 ? Anchor1?.id : undefined} value={typeof Anchor1 === "object" && "value" in Anchor1 ? Anchor1?.value : Anchor1} /* default: ID0 */  isRaw={typeof Anchor1 === "object" && "isRaw" in Anchor1 && Anchor1.isRaw ? true : undefined} />
<Member type={`FrooxEngine.DriveRef\`1[FrooxEngine.CylinderMesh]`} name="_cylinder" id={typeof _cylinder === "object" && "id" in _cylinder ? _cylinder?.id : undefined} value={typeof _cylinder === "object" && "value" in _cylinder ? _cylinder?.value : _cylinder} /* default: ID0 */  isRaw={typeof _cylinder === "object" && "isRaw" in _cylinder && _cylinder.isRaw ? true : undefined} />
