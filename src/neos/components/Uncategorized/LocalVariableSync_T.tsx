...
<Member type={`FrooxEngine.Sync\`1[System.String]`} name="Variable" id={typeof Variable === "object" && "id" in Variable ? Variable?.id : undefined} value={typeof Variable === "object" && "value" in Variable ? Variable?.value : Variable} /* default: null */  isRaw={typeof Variable === "object" && "isRaw" in Variable && Variable.isRaw ? true : undefined} />
        </Component>
      );
    };
