...
<Member type={`FrooxEngine.SyncRef`} name="Member" id={typeof Member === "object" && "id" in Member ? Member?.id : undefined} value={typeof Member === "object" && "value" in Member ? Member?.value : Member} /* default: ID0 */  />
        </Component>
      );
    };
