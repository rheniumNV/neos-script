...
<Member type={`FrooxEngine.SyncRef\`1[FrooxEngine.UIX.Checkbox]`} name="_unsafeMode" id={typeof _unsafeMode === "object" && "id" in _unsafeMode ? _unsafeMode?.id : undefined} value={typeof _unsafeMode === "object" && "value" in _unsafeMode ? _unsafeMode?.value : _unsafeMode} /* default: ID0 */  />
<Member type={`FrooxEngine.SyncRef\`1[FrooxEngine.UIX.Checkbox]`} name="_autoPort" id={typeof _autoPort === "object" && "id" in _autoPort ? _autoPort?.id : undefined} value={typeof _autoPort === "object" && "value" in _autoPort ? _autoPort?.value : _autoPort} /* default: ID0 */  />
<Member type={`FrooxEngine.SyncRef\`1[FrooxEngine.UIX.TextField]`} name="_port" id={typeof _port === "object" && "id" in _port ? _port?.id : undefined} value={typeof _port === "object" && "value" in _port ? _port?.value : _port} /* default: ID0 */  />
<Member type={`FrooxEngine.Sync\`1[CloudX.Shared.SessionAccessLevel]`} name="_accessLevel" id={typeof _accessLevel === "object" && "id" in _accessLevel ? _accessLevel?.id : undefined} value={typeof _accessLevel === "object" && "value" in _accessLevel ? _accessLevel?.value : _accessLevel} /* default: Private */  />
