...
<Member type={`FrooxEngine.SyncRef\`1[FrooxEngine.RadiantDashScreen]`} name="Screen" id={typeof Screen === "object" && "id" in Screen ? Screen?.id : undefined} value={typeof Screen === "object" && "value" in Screen ? Screen?.value : Screen} /* default: ID0 */  />
<Member type={`FrooxEngine.RelayRef\`1[FrooxEngine.IField\`1[System.Boolean]]`} name="_switchingEnabled" id={typeof _switchingEnabled === "object" && "id" in _switchingEnabled ? _switchingEnabled?.id : undefined} value={typeof _switchingEnabled === "object" && "value" in _switchingEnabled ? _switchingEnabled?.value : _switchingEnabled} /* default: ID0 */  />
<Member type={`FrooxEngine.RelayRef\`1[FrooxEngine.SyncRef\`1[FrooxEngine.RadiantDashScreen]]`} name="_currentScreen" id={typeof _currentScreen === "object" && "id" in _currentScreen ? _currentScreen?.id : undefined} value={typeof _currentScreen === "object" && "value" in _currentScreen ? _currentScreen?.value : _currentScreen} /* default: ID0 */  />
...
<Member type={`FrooxEngine.SyncRef\`1[FrooxEngine.UIX.Image]`} name="_icon" id={typeof _icon === "object" && "id" in _icon ? _icon?.id : undefined} value={typeof _icon === "object" && "value" in _icon ? _icon?.value : _icon} /* default: ID0 */  />
...
<Member type={`FrooxEngine.SyncRef\`1[FrooxEngine.UIX.RectTransform]`} name="_iconRect" id={typeof _iconRect === "object" && "id" in _iconRect ? _iconRect?.id : undefined} value={typeof _iconRect === "object" && "value" in _iconRect ? _iconRect?.value : _iconRect} /* default: ID0 */  />
        </Component>
      );
    };
