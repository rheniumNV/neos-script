import { member, Member, Component } from "../../core";
    ...
    export interface RadiantDashScreenInput {
...
_modalOverlayManager?: member<any>;
    ...
    export function RadiantDashScreen(props: RadiantDashScreenInput){
...
_screenRoot,
_screenCanvas,
_modalOverlayManager, } = props;
    
      return (
        <Component type="FrooxEngine.RadiantDashScreen" id={id} persistentId={persistentId} updateOrder={updateOrder}>
