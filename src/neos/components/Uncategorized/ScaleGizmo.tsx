...
<Member type={`FrooxEngine.SyncRef\`1[FrooxEngine.IField\`1[BaseX.float3]]`} name="TargetScale" id={typeof TargetScale === "object" && "id" in TargetScale ? TargetScale?.id : undefined} value={typeof TargetScale === "object" && "value" in TargetScale ? TargetScale?.value : TargetScale} /* default: ID0 */  />
<Member type={`FrooxEngine.Sync\`1[System.Single]`} name="HandleLength" id={typeof HandleLength === "object" && "id" in HandleLength ? HandleLength?.id : undefined} value={typeof HandleLength === "object" && "value" in HandleLength ? HandleLength?.value : HandleLength} /* default: 0 */  />
<Member type={`FrooxEngine.SyncRef\`1[FrooxEngine.Slot]`} name="_xSlot" id={typeof _xSlot === "object" && "id" in _xSlot ? _xSlot?.id : undefined} value={typeof _xSlot === "object" && "value" in _xSlot ? _xSlot?.value : _xSlot} /* default: ID0 */  />
<Member type={`FrooxEngine.SyncRef\`1[FrooxEngine.Slot]`} name="_ySlot" id={typeof _ySlot === "object" && "id" in _ySlot ? _ySlot?.id : undefined} value={typeof _ySlot === "object" && "value" in _ySlot ? _ySlot?.value : _ySlot} /* default: ID0 */  />
<Member type={`FrooxEngine.SyncRef\`1[FrooxEngine.Slot]`} name="_zSlot" id={typeof _zSlot === "object" && "id" in _zSlot ? _zSlot?.id : undefined} value={typeof _zSlot === "object" && "value" in _zSlot ? _zSlot?.value : _zSlot} /* default: ID0 */  />
        </Component>
      );
    };
