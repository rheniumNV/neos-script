...
<Member type={`FrooxEngine.SyncRef\`1[FrooxEngine.AssetRef\`1[A]]`} name="Target" id={typeof Target === "object" && "id" in Target ? Target?.id : undefined} value={typeof Target === "object" && "value" in Target ? Target?.value : Target} /* default: null */  isRaw={typeof Target === "object" && "isRaw" in Target && Target.isRaw ? true : undefined} />
<Member type={`FrooxEngine.AssetRef\`1[A]`} name="TargetBefore" id={typeof TargetBefore === "object" && "id" in TargetBefore ? TargetBefore?.id : undefined} value={typeof TargetBefore === "object" && "value" in TargetBefore ? TargetBefore?.value : TargetBefore} /* default: null */  isRaw={typeof TargetBefore === "object" && "isRaw" in TargetBefore && TargetBefore.isRaw ? true : undefined} />
<Member type={`FrooxEngine.AssetRef\`1[A]`} name="TargetAfter" id={typeof TargetAfter === "object" && "id" in TargetAfter ? TargetAfter?.id : undefined} value={typeof TargetAfter === "object" && "value" in TargetAfter ? TargetAfter?.value : TargetAfter} /* default: null */  isRaw={typeof TargetAfter === "object" && "isRaw" in TargetAfter && TargetAfter.isRaw ? true : undefined} />
