...
<Member type={`FrooxEngine.SyncRef\`1[FrooxEngine.PrimitiveMemberEditor]`} name="_textEditor" id={typeof _textEditor === "object" && "id" in _textEditor ? _textEditor?.id : undefined} value={typeof _textEditor === "object" && "value" in _textEditor ? _textEditor?.value : _textEditor} /* default: ID0 */  isRaw={typeof _textEditor === "object" && "isRaw" in _textEditor && _textEditor.isRaw ? true : undefined} />
        </Component>
      );
    };
