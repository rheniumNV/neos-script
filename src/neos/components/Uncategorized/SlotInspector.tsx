...
<Member type={`FrooxEngine.RelayRef\`1[FrooxEngine.SyncRef\`1[FrooxEngine.Slot]]`} name="_selectionReference" id={typeof _selectionReference === "object" && "id" in _selectionReference ? _selectionReference?.id : undefined} value={typeof _selectionReference === "object" && "value" in _selectionReference ? _selectionReference?.value : _selectionReference} /* default: ID0 */  isRaw={typeof _selectionReference === "object" && "isRaw" in _selectionReference && _selectionReference.isRaw ? true : undefined} />
<Member type={`FrooxEngine.SyncRef\`1[FrooxEngine.Slot]`} name="_rootSlot" id={typeof _rootSlot === "object" && "id" in _rootSlot ? _rootSlot?.id : undefined} value={typeof _rootSlot === "object" && "value" in _rootSlot ? _rootSlot?.value : _rootSlot} /* default: ID0 */  isRaw={typeof _rootSlot === "object" && "isRaw" in _rootSlot && _rootSlot.isRaw ? true : undefined} />
...
<Member type={`FrooxEngine.Sync\`1[System.Int32]`} name="_depth" id={typeof _depth === "object" && "id" in _depth ? _depth?.id : undefined} value={typeof _depth === "object" && "value" in _depth ? _depth?.value : _depth} /* default: 0 */  isRaw={typeof _depth === "object" && "isRaw" in _depth && _depth.isRaw ? true : undefined} />
...
<Member type={`FrooxEngine.SyncRef\`1[FrooxEngine.UIX.Text]`} name="_slotNameText" id={typeof _slotNameText === "object" && "id" in _slotNameText ? _slotNameText?.id : undefined} value={typeof _slotNameText === "object" && "value" in _slotNameText ? _slotNameText?.value : _slotNameText} /* default: ID0 */  isRaw={typeof _slotNameText === "object" && "isRaw" in _slotNameText && _slotNameText.isRaw ? true : undefined} />
        </Component>
      );
    };
