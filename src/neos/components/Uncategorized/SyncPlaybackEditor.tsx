...
<Member type={`FrooxEngine.RelayRef\`1[FrooxEngine.SyncPlayback]`} name="_playback" id={typeof _playback === "object" && "id" in _playback ? _playback?.id : undefined} value={typeof _playback === "object" && "value" in _playback ? _playback?.value : _playback} /* default: ID0 */  />
...
<Member type={`FrooxEngine.FieldDrive\`1[System.Uri]`} name="_loopToggleSprite" id={typeof _loopToggleSprite === "object" && "id" in _loopToggleSprite ? _loopToggleSprite?.id : undefined} value={typeof _loopToggleSprite === "object" && "value" in _loopToggleSprite ? _loopToggleSprite?.value : _loopToggleSprite} /* default: ID0 */  />
<Member type={`FrooxEngine.SyncRef\`1[FrooxEngine.FloatTextEditorParser]`} name="_speedField" id={typeof _speedField === "object" && "id" in _speedField ? _speedField?.id : undefined} value={typeof _speedField === "object" && "value" in _speedField ? _speedField?.value : _speedField} /* default: ID0 */  />
