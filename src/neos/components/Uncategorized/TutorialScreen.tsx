...
<Member type={`FrooxEngine.Sync\`1[System.Boolean]`} name="_nextEnabled" id={typeof _nextEnabled === "object" && "id" in _nextEnabled ? _nextEnabled?.id : undefined} value={typeof _nextEnabled === "object" && "value" in _nextEnabled ? _nextEnabled?.value : _nextEnabled} /* default: false */  isRaw={typeof _nextEnabled === "object" && "isRaw" in _nextEnabled && _nextEnabled.isRaw ? true : undefined} />
        </Component>
      );
    };
