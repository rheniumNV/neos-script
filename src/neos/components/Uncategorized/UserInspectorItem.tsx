...
<Member type={`FrooxEngine.SyncRef\`1[FrooxEngine.User]`} name="_user" id={typeof _user === "object" && "id" in _user ? _user?.id : undefined} value={typeof _user === "object" && "value" in _user ? _user?.value : _user} /* default: ID0 */  />
<Member type={`FrooxEngine.SyncRef\`1[FrooxEngine.UIX.Text]`} name="_userNameText" id={typeof _userNameText === "object" && "id" in _userNameText ? _userNameText?.id : undefined} value={typeof _userNameText === "object" && "value" in _userNameText ? _userNameText?.value : _userNameText} /* default: ID0 */  />
