import { member, Member, Component } from "../../core";
    ...
    export interface UserspacePointerInput {
...
_gripPosesGenerated?: member<boolean>;
    ...
    export function UserspacePointer(props: UserspacePointerInput){
...
_gripPosesGenerated, } = props;
      ...
      return (
        <Component type="FrooxEngine.UserspacePointer" id={id} persistentId={persistentId} updateOrder={updateOrder}>
