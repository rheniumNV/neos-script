...
<Member type={`FrooxEngine.RelayRef\`1[FrooxEngine.IField\`1[BaseX.float3]]`} name="TargetVector" id={typeof TargetVector === "object" && "id" in TargetVector ? TargetVector?.id : undefined} value={typeof TargetVector === "object" && "value" in TargetVector ? TargetVector?.value : TargetVector} /* default: ID0 */  isRaw={typeof TargetVector === "object" && "isRaw" in TargetVector && TargetVector.isRaw ? true : undefined} />
...
<Member type={`FrooxEngine.Sync\`1[System.Boolean]`} name="FixMagnitude" id={typeof FixMagnitude === "object" && "id" in FixMagnitude ? FixMagnitude?.id : undefined} value={typeof FixMagnitude === "object" && "value" in FixMagnitude ? FixMagnitude?.value : FixMagnitude} /* default: false */  isRaw={typeof FixMagnitude === "object" && "isRaw" in FixMagnitude && FixMagnitude.isRaw ? true : undefined} />
<Member type={`FrooxEngine.Sync\`1[System.Single]`} name="FixedMagnitude" id={typeof FixedMagnitude === "object" && "id" in FixedMagnitude ? FixedMagnitude?.id : undefined} value={typeof FixedMagnitude === "object" && "value" in FixedMagnitude ? FixedMagnitude?.value : FixedMagnitude} /* default: 0 */  isRaw={typeof FixedMagnitude === "object" && "isRaw" in FixedMagnitude && FixedMagnitude.isRaw ? true : undefined} />
<Member type={`FrooxEngine.Sync\`1[System.Single]`} name="VisualMagnitudeScale" id={typeof VisualMagnitudeScale === "object" && "id" in VisualMagnitudeScale ? VisualMagnitudeScale?.id : undefined} value={typeof VisualMagnitudeScale === "object" && "value" in VisualMagnitudeScale ? VisualMagnitudeScale?.value : VisualMagnitudeScale} /* default: 0 */  isRaw={typeof VisualMagnitudeScale === "object" && "isRaw" in VisualMagnitudeScale && VisualMagnitudeScale.isRaw ? true : undefined} />
<Member type={`FrooxEngine.Sync\`1[System.Single]`} name="VisualThickness" id={typeof VisualThickness === "object" && "id" in VisualThickness ? VisualThickness?.id : undefined} value={typeof VisualThickness === "object" && "value" in VisualThickness ? VisualThickness?.value : VisualThickness} /* default: 0 */  isRaw={typeof VisualThickness === "object" && "isRaw" in VisualThickness && VisualThickness.isRaw ? true : undefined} />
<Member type={`FrooxEngine.FieldDrive\`1[BaseX.floatQ]`} name="_colliderRotation" id={typeof _colliderRotation === "object" && "id" in _colliderRotation ? _colliderRotation?.id : undefined} value={typeof _colliderRotation === "object" && "value" in _colliderRotation ? _colliderRotation?.value : _colliderRotation} /* default: ID0 */  isRaw={typeof _colliderRotation === "object" && "isRaw" in _colliderRotation && _colliderRotation.isRaw ? true : undefined} />
...
<Member type={`FrooxEngine.DriveRef\`1[FrooxEngine.ArrowMesh]`} name="_mesh" id={typeof _mesh === "object" && "id" in _mesh ? _mesh?.id : undefined} value={typeof _mesh === "object" && "value" in _mesh ? _mesh?.value : _mesh} /* default: ID0 */  isRaw={typeof _mesh === "object" && "isRaw" in _mesh && _mesh.isRaw ? true : undefined} />
        </Component>
      );
    };
