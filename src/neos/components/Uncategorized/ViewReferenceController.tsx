...
<Member type={`FrooxEngine.RawOutput\`1[System.Boolean]`} name="ShouldVoiceBeActive" id={typeof ShouldVoiceBeActive === "object" && "id" in ShouldVoiceBeActive ? ShouldVoiceBeActive?.id : undefined} value={typeof ShouldVoiceBeActive === "object" && "value" in ShouldVoiceBeActive ? ShouldVoiceBeActive?.value : ShouldVoiceBeActive} /* default: FrooxEngine.RawOutput`1[System.Boolean] */  isRaw={typeof ShouldVoiceBeActive === "object" && "isRaw" in ShouldVoiceBeActive && ShouldVoiceBeActive.isRaw ? true : undefined} />
<Member type={`FrooxEngine.FieldDrive\`1[BaseX.float3]`} name="_objectSlotScale" id={typeof _objectSlotScale === "object" && "id" in _objectSlotScale ? _objectSlotScale?.id : undefined} value={typeof _objectSlotScale === "object" && "value" in _objectSlotScale ? _objectSlotScale?.value : _objectSlotScale} /* default: ID0 */  isRaw={typeof _objectSlotScale === "object" && "isRaw" in _objectSlotScale && _objectSlotScale.isRaw ? true : undefined} />
<Member type={`FrooxEngine.FieldDrive\`1[System.Boolean]`} name="_objectSlotActive" id={typeof _objectSlotActive === "object" && "id" in _objectSlotActive ? _objectSlotActive?.id : undefined} value={typeof _objectSlotActive === "object" && "value" in _objectSlotActive ? _objectSlotActive?.value : _objectSlotActive} /* default: ID0 */  isRaw={typeof _objectSlotActive === "object" && "isRaw" in _objectSlotActive && _objectSlotActive.isRaw ? true : undefined} />
        </Component>
      );
    };
