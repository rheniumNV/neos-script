...
<Member type={`FrooxEngine.Sync\`1[System.Single]`} name="CubeSize" id={typeof CubeSize === "object" && "id" in CubeSize ? CubeSize?.id : undefined} value={typeof CubeSize === "object" && "value" in CubeSize ? CubeSize?.value : CubeSize} /* default: 0 */  />
...
<Member type={`FrooxEngine.FieldDrive\`1[BaseX.float3]`} name="_cubeSize" id={typeof _cubeSize === "object" && "id" in _cubeSize ? _cubeSize?.id : undefined} value={typeof _cubeSize === "object" && "value" in _cubeSize ? _cubeSize?.value : _cubeSize} /* default: ID0 */  />
