...
<Member type={`FrooxEngine.SyncRef\`1[FrooxEngine.WorldCloseDialog]`} name="_closeDialog" id={typeof _closeDialog === "object" && "id" in _closeDialog ? _closeDialog?.id : undefined} value={typeof _closeDialog === "object" && "value" in _closeDialog ? _closeDialog?.value : _closeDialog} /* default: ID0 */  />
        </Component>
      );
    };
