...
<Member type={`FrooxEngine.Sync\`1[BaseX.float3]`} name="UserSpaceScale" id={typeof UserSpaceScale === "object" && "id" in UserSpaceScale ? UserSpaceScale?.id : undefined} value={typeof UserSpaceScale === "object" && "value" in UserSpaceScale ? UserSpaceScale?.value : UserSpaceScale} /* default: [0; 0; 0] */  />
        </Component>
      );
    };
