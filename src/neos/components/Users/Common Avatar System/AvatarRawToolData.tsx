...
<Member type={`FrooxEngine.RawOutput\`1[System.Boolean]`} name="PressingPrimary" id={typeof PressingPrimary === "object" && "id" in PressingPrimary ? PressingPrimary?.id : undefined} value={typeof PressingPrimary === "object" && "value" in PressingPrimary ? PressingPrimary?.value : PressingPrimary} /* default: FrooxEngine.RawOutput`1[System.Boolean] */  />
<Member type={`FrooxEngine.RawOutput\`1[System.Boolean]`} name="PressingSecondary" id={typeof PressingSecondary === "object" && "id" in PressingSecondary ? PressingSecondary?.id : undefined} value={typeof PressingSecondary === "object" && "value" in PressingSecondary ? PressingSecondary?.value : PressingSecondary} /* default: FrooxEngine.RawOutput`1[System.Boolean] */  />
<Member type={`FrooxEngine.RawOutput\`1[System.Boolean]`} name="PressingGrab" id={typeof PressingGrab === "object" && "id" in PressingGrab ? PressingGrab?.id : undefined} value={typeof PressingGrab === "object" && "value" in PressingGrab ? PressingGrab?.value : PressingGrab} /* default: FrooxEngine.RawOutput`1[System.Boolean] */  />
...
<Member type={`FrooxEngine.SyncRef\`1[FrooxEngine.ValueStream\`1[System.Single]]`} name="_strengthStream" id={typeof _strengthStream === "object" && "id" in _strengthStream ? _strengthStream?.id : undefined} value={typeof _strengthStream === "object" && "value" in _strengthStream ? _strengthStream?.value : _strengthStream} /* default: ID0 */  />
<Member type={`FrooxEngine.SyncRef\`1[FrooxEngine.ValueStream\`1[BaseX.float2]]`} name="_axisStream" id={typeof _axisStream === "object" && "id" in _axisStream ? _axisStream?.id : undefined} value={typeof _axisStream === "object" && "value" in _axisStream ? _axisStream?.value : _axisStream} /* default: ID0 */  />
...
<Member type={`FrooxEngine.SyncRef\`1[FrooxEngine.ValueStream\`1[System.Boolean]]`} name="_grabStream" id={typeof _grabStream === "object" && "id" in _grabStream ? _grabStream?.id : undefined} value={typeof _grabStream === "object" && "value" in _grabStream ? _grabStream?.value : _grabStream} /* default: ID0 */  />
        </Component>
      );
    };
