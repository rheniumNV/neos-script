...
<Member type={`FrooxEngine.Sync\`1[System.Boolean]`} name="SetOnEquip" id={typeof SetOnEquip === "object" && "id" in SetOnEquip ? SetOnEquip?.id : undefined} value={typeof SetOnEquip === "object" && "value" in SetOnEquip ? SetOnEquip?.value : SetOnEquip} /* default: false */  isRaw={typeof SetOnEquip === "object" && "isRaw" in SetOnEquip && SetOnEquip.isRaw ? true : undefined} />
