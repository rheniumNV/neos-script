...
<Member type={`FrooxEngine.Sync\`1[System.Boolean]`} name="IsLive" id={typeof IsLive === "object" && "id" in IsLive ? IsLive?.id : undefined} value={typeof IsLive === "object" && "value" in IsLive ? IsLive?.value : IsLive} /* default: false */  isRaw={typeof IsLive === "object" && "isRaw" in IsLive && IsLive.isRaw ? true : undefined} />
