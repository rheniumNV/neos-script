...
<Member type={`FrooxEngine.AssetRef\`1[FrooxEngine.Material]`} name="MaterialOverride" id={typeof MaterialOverride === "object" && "id" in MaterialOverride ? MaterialOverride?.id : undefined} value={typeof MaterialOverride === "object" && "value" in MaterialOverride ? MaterialOverride?.value : MaterialOverride} /* default: ID0 */  />
...
<Member type={`FrooxEngine.SyncType`} name="_lastSpawned" id={typeof _lastSpawned === "object" && "id" in _lastSpawned ? _lastSpawned?.id : undefined} value={typeof _lastSpawned === "object" && "value" in _lastSpawned ? _lastSpawned?.value : _lastSpawned} /* default: <i>null</i> */  />
        </Component>
      );
    };
