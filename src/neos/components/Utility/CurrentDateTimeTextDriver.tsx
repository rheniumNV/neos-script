...
<Member type={`FrooxEngine.Sync\`1[System.Boolean]`} name="UseUTC" id={typeof UseUTC === "object" && "id" in UseUTC ? UseUTC?.id : undefined} value={typeof UseUTC === "object" && "value" in UseUTC ? UseUTC?.value : UseUTC} /* default: false */  />
        </Component>
      );
    };
