...
<Member type={`FrooxEngine.Sync\`1[System.Boolean]`} name="IgnoreWhenNonPersistentSelf" id={typeof IgnoreWhenNonPersistentSelf === "object" && "id" in IgnoreWhenNonPersistentSelf ? IgnoreWhenNonPersistentSelf?.id : undefined} value={typeof IgnoreWhenNonPersistentSelf === "object" && "value" in IgnoreWhenNonPersistentSelf ? IgnoreWhenNonPersistentSelf?.value : IgnoreWhenNonPersistentSelf} /* default: false */  />
        </Component>
      );
    };
