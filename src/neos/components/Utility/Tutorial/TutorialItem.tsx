...
<Member type={`FrooxEngine.SyncList\`1[FrooxEngine.TutorialItem+HighlightMaterial]`} name="_highlightMaterials" id={typeof _highlightMaterials === "object" && "id" in _highlightMaterials ? _highlightMaterials?.id : undefined} value={typeof _highlightMaterials === "object" && "value" in _highlightMaterials ? _highlightMaterials?.value : _highlightMaterials} /* default: FrooxEngine.SyncList`1[FrooxEngine.TutorialItem+HighlightMaterial] */  />
