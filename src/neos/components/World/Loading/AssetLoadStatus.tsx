...
<Member type={`FrooxEngine.SyncAssetList\`1[FrooxEngine.IAsset]`} name="Assets" id={typeof Assets === "object" && "id" in Assets ? Assets?.id : undefined} value={typeof Assets === "object" && "value" in Assets ? Assets?.value : Assets} /* default: FrooxEngine.SyncAssetList`1[FrooxEngine.IAsset] */  isRaw={typeof Assets === "object" && "isRaw" in Assets && Assets.isRaw ? true : undefined} />
